import { A as ti, S as xf, L as gn, p as hl } from "./index-bee98e0b.js";
import { constants as kr, RpcProvider as Of, Account as fl } from "starknet";
import "./connector-d58f0dd8.js";
var ul = Object.defineProperty, dl = (e, t, i) => t in e ? ul(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, He = (e, t, i) => (dl(e, typeof t != "symbol" ? t + "" : t, i), i), Ma = { exports: {} }, an = typeof Reflect == "object" ? Reflect : null, uc = an && typeof an.apply == "function" ? an.apply : function(e, t, i) {
...
rt.prototype.emit = function(e) {
  ...
  if (typeof c == "function")
    ...
    for (var d = c.length, f = Cf(c, d), i = 0; i < d; ++i)
      uc(f[i], this, t);
  return !0;
};
function Rf(e, t, i, r) {
  var n, s, a;
  if (to(i), s = e._events, s === void 0 ? (s = e._events = /* @__PURE__ */ Object.create(null), e._eventsCount = 0) : (s.newListener !== void 0 && (e.emit(
    "newListener",
    t,
    ...
    c.name = "MaxListenersExceededWarning", c.emitter = e, c.type = t, c.count = a.length, ll(c);
  }
  return e;
}
...
rt.prototype.once = function(e, t) {
  return to(t), this.on(e, Tf(this, e, t)), this;
};
rt.prototype.prependOnceListener = function(e, t) {
  return to(t), this.prependListener(e, Tf(this, e, t)), this;
};
rt.prototype.removeListener = function(e, t) {
  var i, r, n, s, a;
  if (to(t), r = this._events, r === void 0)
    return this;
  if (i = r[e], i === void 0)
    return this;
  if (i === t || i.listener === t)
...
***************************************************************************** */
var ta = function(e, t) {
  return ta = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(i, r) {
    i.__proto__ = r;
  } || function(i, r) {
    for (var n in r)
...
function _l(e, t, i, r) {
  ...
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function")
    ...
    for (var c = e.length - 1; c >= 0; c--)
      (a = e[c]) && (s = (n < 3 ? a(s) : n > 3 ? a(t, i, s) : a(t, i)) || s);
...
function Il(e, t, i, r) {
  ...
  return new (i || (i = Promise))(function(s, a) {
    ...
    function f(g) {
      g.done ? s(g.value) : n(g.value).then(c, d);
    }
...
function Pl() {
  ...
  for (var r = Array(e), n = 0, t = 0; t < i; t++)
    for (var s = arguments[t], a = 0, c = s.length; a < c; a++, n++)
      r[n] = s[a];
  return r;
}
function Hn(e) {
...
function Nl(e, t, i) {
  ...
  function _(x, A) {
    x(A), s.shift(), s.length && c(s[0][0], s[0][1]);
  }
}
function Rl(e) {
  var t, i;
...
function Tl(e) {
  ...
  return t ? t.call(e) : (e = typeof ra == "function" ? ra(e) : e[Symbol.iterator](), i = {}, r("next"), r("throw"), r("return"), i[Symbol.asyncIterator] = function() {
    return this;
  }, i);
  function r(s) {
    i[s] = e[s] && function(a) {
      return new Promise(function(c, d) {
        a = e[s](a), n(c, d, a.done, a.value);
      });
    };
  }
  function n(s, a, c, d) {
...
const zl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  __spreadArrays: Pl,
  __values: ra
}, Symbol.toStringTag, { value: "Module" })), Xn = /* @__PURE__ */ xf(zl);
var lc = {}, Nn = {}, pc;
function Ul() {
  if (pc)
    return Nn;
  pc = 1, Object.defineProperty(Nn, "__esModule", { value: !0 }), Nn.delay = void 0;
  function e(t) {
...
var Pr = {}, gc = {}, Qr = {}, bc;
function Dl() {
  return bc || (bc = 1, Object.defineProperty(Qr, "__esModule", { value: !0 }), Qr.ONE_THOUSAND = Qr.ONE_HUNDRED = void 0, Qr.ONE_HUNDRED = 100, Qr.ONE_THOUSAND = 1e3), Qr;
}
var mc = {}, yc;
function Fl() {
...
function Kl() {
  if (wc)
    return Pr;
  wc = 1, Object.defineProperty(Pr, "__esModule", { value: !0 }), Pr.fromMiliseconds = Pr.toMiliseconds = void 0;
  const e = Uf();
  function t(r) {
...
function $l() {
  if (Ec)
    return en;
  Ec = 1, Object.defineProperty(en, "__esModule", { value: !0 }), en.Watch = void 0;
  class e {
    constructor() {
...
function Vl() {
  if (Ic)
    return Rn;
  Ic = 1, Object.defineProperty(Rn, "__esModule", { value: !0 }), Rn.IWatch = void 0;
  class e {
  }
...
const Ac = te.FIVE_SECONDS, bn = { pulse: "heartbeat_pulse" };
let Gl = class Df extends Wl {
  constructor(t) {
    super(t), this.events = new ri.EventEmitter(), this.interval = Ac, this.interval = t?.interval || Ac;
  }
  static async init(t) {
    const i = new Df(t);
...
const na = "base64:";
function r0(e) {
  return typeof e == "string" ? e : na + o0(e);
}
function n0(e) {
  return typeof e != "string" || !e.startsWith(na) ? e : s0(e.slice(na.length));
}
function s0(e) {
...
function f0(e = {}) {
  const t = {
    ...
    getItems(f, g = {}) {
      return c(f, g, (_) => _.driver.getItems ? _t(
        _.driver.getItems,
        _.items.map((x) => ({
          key: x.relativeKey,
          options: x.options
    ...
    async dispose() {
      await Promise.all(
        Object.values(t.mounts).map((f) => Oc(f))
      );
    },
    async watch(f) {
    ...
    mount(f, g) {
      ...
      return f && (t.mountpoints.push(f), t.mountpoints.sort((_, x) => x.length - _.length)), t.mounts[f] = g, t.watching && Promise.resolve(xc(g, n, f)).then((_) => {
        t.unwatch[f] = _;
      }).catch(console.error), d;
    },
    async unmount(f, g = !0) {
      f = vs(f), !(!f || !t.mounts[f]) && (t.watching && f in t.unwatch && (t.unwatch[f]?.(), delete t.unwatch[f]), g && await Oc(t.mounts[f]), t.mountpoints = t.mountpoints.filter((_) => _ !== f), delete t.mounts[f]);
    },
    getMount(f = "") {
      f = Wt(f) + ":";
      const g = i(f);
...
let To;
function Qn() {
  return To || (To = Ff("keyval-store", "keyval")), To;
}
function Pc(e, t = Qn()) {
...
var v0 = (e = {}) => {
  ...
  return e.dbName && e.storeName && (r = Ff(e.dbName, e.storeName)), { name: y0, options: e, async hasItem(n) {
    return !(typeof await Pc(i(n), r) > "u");
  }, async getItem(n) {
    return await Pc(i(n), r) ?? null;
  }, setItem(n, s) {
    return u0(i(n), s, r);
  }, removeItem(n) {
    return d0(i(n), r);
...
var ko = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, As = { exports: {} };
(function() {
  let e;
  function t() {
  }
  ...
  }), typeof ko < "u" && ko.localStorage ? As.exports = ko.localStorage : typeof window < "u" && window.localStorage ? As.exports = window.localStorage : As.exports = new t();
})();
function S0(e) {
  var t;
...
const M0 = "wc_storage_version", Nc = 1, A0 = async (e, t, i) => {
  ...
  for (; s.length; ) {
    ...
    if (d.includes("wc@") || d.includes("walletconnect") || d.includes("wc_") || d.includes("wallet_connect")) {
      const f = await e.getItem(c);
      await t.setItem(c, f), a.push(c);
    }
  }
  await t.setItem(r, Nc), i(t), x0(e, a);
}, x0 = async (e, t) => {
...
const Wn = F0().console || {}, T0 = {
  mapHttpRequest: ws,
  mapHttpResponse: ws,
  wrapRequestSerializer: Lo,
  wrapResponseSerializer: Lo,
  wrapErrorSerializer: Lo,
  req: ws,
  res: ws,
  err: j0
};
...
function Ci(e) {
  ...
  const c = e.level || "info", d = Object.create(i);
  ...
  d.levels = Ci.levels, d.level = c, d.setMaxListeners = d.getMaxListeners = d.emit = d.addListener = d.on = d.prependListener = d.once = d.prependOnceListener = d.removeListener = d.removeAllListeners = d.listeners = d.listenerCount = d.eventNames = d.write = d.flush = Gn, d.serializers = r, d._serialize = n, d._stdErrSerialize = s, d.child = A, t && (d._logEvent = sa());
  function g() {
  ...
  function A(O, j) {
    ...
    if (n && F) {
      ...
      delete O.serializers, io([O], C, V, this._stdErrSerialize);
    }
    function K(N) {
      this._childLevel = (N._childLevel | 0) + 1, this.error = rn(N, O, "error"), this.fatal = rn(N, O, "fatal"), this.warn = rn(N, O, "warn"), this.info = rn(N, O, "info"), this.debug = rn(N, O, "debug"), this.trace = rn(N, O, "trace"), V && (this.serializers = V, this._serialize = C), t && (this._logEvent = sa(
...
Ci.stdSerializers = T0;
Ci.stdTimeFunctions = Object.assign({}, { nullTime: Kf, epochTime: Bf, unixTime: U0, isoTime: D0 });
function tn(e, t, i, r) {
  const n = Object.getPrototypeOf(t);
  t[i] = t.levelVal > t.levels.values[i] ? Gn : n[i] ? n[i] : Wn[i] || Wn[r] || Gn, L0(e, t, i);
}
function L0(e, t, i) {
  !e.transmit && t[i] === Gn || (t[i] = function(r) {
    return function() {
      const n = e.timestamp(), s = new Array(arguments.length), a = Object.getPrototypeOf && Object.getPrototypeOf(this) === Wn ? Wn : this;
      for (var c = 0; c < s.length; c++)
        s[c] = arguments[c];
      if (e.serialize && !e.asObject && io(s, this._serialize, this.serializers, this._stdErrSerialize), e.asObject ? r.call(a, C0(this, i, s, n)) : r.apply(a, s), e.transmit) {
        const d = e.transmit.level || t.level, f = Ci.levels.values[d], g = Ci.levels.values[i];
        if (g < f)
          return;
        q0(this, {
          ts: n,
...
function C0(e, t, i, r) {
  e._serialize && io(i, e._serialize, e.serializers, e._stdErrSerialize);
  const n = i.slice();
  let s = n[0];
  const a = {};
  r && (a.time = r), a.level = Ci.levels.values[t];
  let c = (e._childLevel | 0) + 1;
  if (c < 1 && (c = 1), s !== null && typeof s == "object") {
    for (; c-- && typeof n[0] == "object"; )
      Object.assign(a, n.shift());
    s = n.length ? Rc(n.shift(), n) : void 0;
  } else
    typeof s == "string" && (s = Rc(n.shift(), n));
  return s !== void 0 && (a.msg = s), a;
}
function io(e, t, i, r) {
  for (const n in e)
    if (r && e[n] instanceof Error)
      e[n] = Ci.stdSerializers.err(e[n]);
...
function q0(e, t, i) {
  const r = t.send, n = t.ts, s = t.methodLevel, a = t.methodValue, c = t.val, d = e._logEvent.bindings;
  io(
    i,
  ...
  }), e._logEvent.level.label = s, e._logEvent.level.value = a, r(s, e._logEvent, c), e._logEvent = sa(d);
}
function sa(e) {
  return {
    ts: 0,
...
const ro = /* @__PURE__ */ gn(sn), K0 = { level: "info" }, es = "custom_context", Aa = 1e3 * 1024;
let B0 = class {
  constructor(e) {
  ...
  constructor(e, t = Aa) {
    this.level = e ?? "error", this.levelValue = sn.levels.values[this.level], this.MAX_LOG_SIZE_IN_BYTES = t, this.logs = new Tc(this.MAX_LOG_SIZE_IN_BYTES);
  }
  ...
  clearLogs() {
    this.logs = new Tc(this.MAX_LOG_SIZE_IN_BYTES);
  }
  getLogArray() {
...
var H0 = Object.defineProperty, W0 = Object.defineProperties, G0 = Object.getOwnPropertyDescriptors, kc = Object.getOwnPropertySymbols, Y0 = Object.prototype.hasOwnProperty, J0 = Object.prototype.propertyIsEnumerable, Lc = (e, t, i) => t in e ? H0(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, Cs = (e, t) => {
  for (var i in t || (t = {}))
    Y0.call(t, i) && Lc(e, i, t[i]);
  if (kc)
    for (var i of kc(t))
      J0.call(t, i) && Lc(e, i, t[i]);
  return e;
}, qs = (e, t) => W0(e, G0(t));
function xa(e) {
...
function ep(e) {
  ...
  return { logger: ro(qs(Cs({}, e.opts), { level: "trace", browser: qs(Cs({}, (i = e.opts) == null ? void 0 : i.browser), { write: (n) => r.write(n) }) })), chunkLoggerController: r };
}
function tp(e) {
  var t;
  const i = new V0((t = e.opts) == null ? void 0 : t.level, e.maxSizeInBytes);
  return { logger: ro(qs(Cs({}, e.opts), { level: "trace" }), i), chunkLoggerController: i };
}
function ip(e) {
...
class bp {
  ...
  randomBytes(t) {
    ...
    for (let r = 0; r < i.length; r += Cc)
      this._crypto.getRandomValues(i.subarray(r, r + Math.min(i.length - r, Cc)));
    return i;
  }
}
so.BrowserRandomSource = bp;
function mp(e) {
...
const vp = {}, wp = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: vp
}, Symbol.toStringTag, { value: "Module" })), ao = /* @__PURE__ */ xf(wp);
Object.defineProperty(oo, "__esModule", { value: !0 });
oo.NodeRandomSource = void 0;
const _p = ni;
class Ep {
  constructor() {
...
oo.NodeRandomSource = Ep;
Object.defineProperty(no, "__esModule", { value: !0 });
no.SystemRandomSource = void 0;
const Sp = so, Ip = oo;
class Mp {
  constructor() {
...
no.SystemRandomSource = Mp;
var Ve = {}, Vf = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  function t(c, d) {
    var f = c >>> 16 & 65535, g = c & 65535, _ = d >>> 16 & 65535, x = d & 65535;
  ...
  e.isInteger = Number.isInteger || a, e.MAX_SAFE_INTEGER = 9007199254740991, e.isSafeInteger = function(c) {
    return e.isInteger(c) && c >= -e.MAX_SAFE_INTEGER && c <= e.MAX_SAFE_INTEGER;
  };
})(Vf);
...
(function(e) {
  ...
  function c(f, g = a, _ = e.defaultRandomSource) {
    if (g.length < 2)
...
(function(e) {
  ...
  var r = (
    ...
    function() {
      ...
      }, c.prototype.update = function(d, f) {
      ...
      }, c.prototype.restoreState = function(d) {
      ...
      }, c.prototype.cleanSavedState = function(d) {
  ...
  function s(c, d, f, g, _, x, A) {
    for (var O = f[0], j = f[1], F = f[2], V = f[3], C = f[4], K = f[5], N = f[6], U = f[7], D = g[0], v = g[1], T = g[2], Y = g[3], Q = g[4], p = g[5], S = g[6], o = g[7], h, l, E, I, w, u, m, b; A >= 128; ) {
      for (var P = 0; P < 16; P++) {
        var B = 8 * P + x;
        c[P] = t.readUint32BE(_, B), d[P] = t.readUint32BE(_, B + 4);
      }
      for (var P = 0; P < 80; P++) {
        var G = O, M = j, $ = F, L = V, k = C, q = K, y = N, R = U, W = D, Z = v, J = T, oe = Y, Ee = Q, ce = p, Re = S, Pe = o;
        if (h = U, l = o, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = (C >>> 14 | Q << 32 - 14) ^ (C >>> 18 | Q << 32 - 18) ^ (Q >>> 41 - 32 | C << 32 - (41 - 32)), l = (Q >>> 14 | C << 32 - 14) ^ (Q >>> 18 | C << 32 - 18) ^ (C >>> 41 - 32 | Q << 32 - (41 - 32)), w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, h = C & K ^ ~C & N, l = Q & p ^ ~Q & S, w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, h = n[P * 2], l = n[P * 2 + 1], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, h = c[P % 16], l = d[P % 16], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, E = m & 65535 | b << 16, I = w & 65535 | u << 16, h = E, l = I, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = (O >>> 28 | D << 32 - 28) ^ (D >>> 34 - 32 | O << 32 - (34 - 32)) ^ (D >>> 39 - 32 | O << 32 - (39 - 32)), l = (D >>> 28 | O << 32 - 28) ^ (O >>> 34 - 32 | D << 32 - (34 - 32)) ^ (O >>> 39 - 32 | D << 32 - (39 - 32)), w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, h = O & j ^ O & F ^ j & F, l = D & v ^ D & T ^ v & T, w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, R = m & 65535 | b << 16, Pe = w & 65535 | u << 16, h = L, l = oe, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = E, l = I, w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, L = m & 65535 | b << 16, oe = w & 65535 | u << 16, j = G, F = M, V = $, C = L, K = k, N = q, U = y, O = R, v = W, T = Z, Y = J, Q = oe, p = Ee, S = ce, o = Re, D = Pe, P % 16 === 15)
          for (var B = 0; B < 16; B++)
            h = c[B], l = d[B], w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = c[(B + 9) % 16], l = d[(B + 9) % 16], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, E = c[(B + 1) % 16], I = d[(B + 1) % 16], h = (E >>> 1 | I << 32 - 1) ^ (E >>> 8 | I << 32 - 8) ^ E >>> 7, l = (I >>> 1 | E << 32 - 1) ^ (I >>> 8 | E << 32 - 8) ^ (I >>> 7 | E << 32 - 7), w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, E = c[(B + 14) % 16], I = d[(B + 14) % 16], h = (E >>> 19 | I << 32 - 19) ^ (I >>> 61 - 32 | E << 32 - (61 - 32)) ^ E >>> 6, l = (I >>> 19 | E << 32 - 19) ^ (E >>> 61 - 32 | I << 32 - (61 - 32)) ^ (I >>> 6 | E << 32 - 6), w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, c[B] = m & 65535 | b << 16, d[B] = w & 65535 | u << 16;
      }
      h = O, l = D, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = f[0], l = g[0], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, f[0] = O = m & 65535 | b << 16, g[0] = D = w & 65535 | u << 16, h = j, l = v, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = f[1], l = g[1], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, f[1] = j = m & 65535 | b << 16, g[1] = v = w & 65535 | u << 16, h = F, l = T, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = f[2], l = g[2], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, f[2] = F = m & 65535 | b << 16, g[2] = T = w & 65535 | u << 16, h = V, l = Y, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = f[3], l = g[3], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, f[3] = V = m & 65535 | b << 16, g[3] = Y = w & 65535 | u << 16, h = C, l = Q, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = f[4], l = g[4], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, f[4] = C = m & 65535 | b << 16, g[4] = Q = w & 65535 | u << 16, h = K, l = p, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = f[5], l = g[5], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, f[5] = K = m & 65535 | b << 16, g[5] = p = w & 65535 | u << 16, h = N, l = S, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = f[6], l = g[6], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, f[6] = N = m & 65535 | b << 16, g[6] = S = w & 65535 | u << 16, h = U, l = o, w = l & 65535, u = l >>> 16, m = h & 65535, b = h >>> 16, h = f[7], l = g[7], w += l & 65535, u += l >>> 16, m += h & 65535, b += h >>> 16, u += w >>> 16, m += u >>> 16, b += m >>> 16, f[7] = U = m & 65535 | b << 16, g[7] = o = w & 65535 | u << 16, x += 128, A -= 128;
    }
    return x;
  }
  function a(c) {
...
(function(e) {
  ...
  function v(L, k, q) {
    let y, R, W = 0, Z = 0, J = 0, oe = 0, Ee = 0, ce = 0, Re = 0, Pe = 0, se = 0, Se = 0, ve = 0, ie = 0, ge = 0, pe = 0, ee = 0, fe = 0, me = 0, re = 0, ue = 0, Ie = 0, ae = 0, Me = 0, Ae = 0, he = 0, We = 0, Ye = 0, xe = 0, $e = 0, Xe = 0, Oe = 0, et = 0, Te = q[0], le = q[1], ke = q[2], Le = q[3], be = q[4], Ne = q[5], ze = q[6], we = q[7], Ue = q[8], De = q[9], _e = q[10], qe = q[11], Ce = q[12], de = q[13], Fe = q[14], Ke = q[15];
    y = k[0], W += y * Te, Z += y * le, J += y * ke, oe += y * Le, Ee += y * be, ce += y * Ne, Re += y * ze, Pe += y * we, se += y * Ue, Se += y * De, ve += y * _e, ie += y * qe, ge += y * Ce, pe += y * de, ee += y * Fe, fe += y * Ke, y = k[1], Z += y * Te, J += y * le, oe += y * ke, Ee += y * Le, ce += y * be, Re += y * Ne, Pe += y * ze, se += y * we, Se += y * Ue, ve += y * De, ie += y * _e, ge += y * qe, pe += y * Ce, ee += y * de, fe += y * Fe, me += y * Ke, y = k[2], J += y * Te, oe += y * le, Ee += y * ke, ce += y * Le, Re += y * be, Pe += y * Ne, se += y * ze, Se += y * we, ve += y * Ue, ie += y * De, ge += y * _e, pe += y * qe, ee += y * Ce, fe += y * de, me += y * Fe, re += y * Ke, y = k[3], oe += y * Te, Ee += y * le, ce += y * ke, Re += y * Le, Pe += y * be, se += y * Ne, Se += y * ze, ve += y * we, ie += y * Ue, ge += y * De, pe += y * _e, ee += y * qe, fe += y * Ce, me += y * de, re += y * Fe, ue += y * Ke, y = k[4], Ee += y * Te, ce += y * le, Re += y * ke, Pe += y * Le, se += y * be, Se += y * Ne, ve += y * ze, ie += y * we, ge += y * Ue, pe += y * De, ee += y * _e, fe += y * qe, me += y * Ce, re += y * de, ue += y * Fe, Ie += y * Ke, y = k[5], ce += y * Te, Re += y * le, Pe += y * ke, se += y * Le, Se += y * be, ve += y * Ne, ie += y * ze, ge += y * we, pe += y * Ue, ee += y * De, fe += y * _e, me += y * qe, re += y * Ce, ue += y * de, Ie += y * Fe, ae += y * Ke, y = k[6], Re += y * Te, Pe += y * le, se += y * ke, Se += y * Le, ve += y * be, ie += y * Ne, ge += y * ze, pe += y * we, ee += y * Ue, fe += y * De, me += y * _e, re += y * qe, ue += y * Ce, Ie += y * de, ae += y * Fe, Me += y * Ke, y = k[7], Pe += y * Te, se += y * le, Se += y * ke, ve += y * Le, ie += y * be, ge += y * Ne, pe += y * ze, ee += y * we, fe += y * Ue, me += y * De, re += y * _e, ue += y * qe, Ie += y * Ce, ae += y * de, Me += y * Fe, Ae += y * Ke, y = k[8], se += y * Te, Se += y * le, ve += y * ke, ie += y * Le, ge += y * be, pe += y * Ne, ee += y * ze, fe += y * we, me += y * Ue, re += y * De, ue += y * _e, Ie += y * qe, ae += y * Ce, Me += y * de, Ae += y * Fe, he += y * Ke, y = k[9], Se += y * Te, ve += y * le, ie += y * ke, ge += y * Le, pe += y * be, ee += y * Ne, fe += y * ze, me += y * we, re += y * Ue, ue += y * De, Ie += y * _e, ae += y * qe, Me += y * Ce, Ae += y * de, he += y * Fe, We += y * Ke, y = k[10], ve += y * Te, ie += y * le, ge += y * ke, pe += y * Le, ee += y * be, fe += y * Ne, me += y * ze, re += y * we, ue += y * Ue, Ie += y * De, ae += y * _e, Me += y * qe, Ae += y * Ce, he += y * de, We += y * Fe, Ye += y * Ke, y = k[11], ie += y * Te, ge += y * le, pe += y * ke, ee += y * Le, fe += y * be, me += y * Ne, re += y * ze, ue += y * we, Ie += y * Ue, ae += y * De, Me += y * _e, Ae += y * qe, he += y * Ce, We += y * de, Ye += y * Fe, xe += y * Ke, y = k[12], ge += y * Te, pe += y * le, ee += y * ke, fe += y * Le, me += y * be, re += y * Ne, ue += y * ze, Ie += y * we, ae += y * Ue, Me += y * De, Ae += y * _e, he += y * qe, We += y * Ce, Ye += y * de, xe += y * Fe, $e += y * Ke, y = k[13], pe += y * Te, ee += y * le, fe += y * ke, me += y * Le, re += y * be, ue += y * Ne, Ie += y * ze, ae += y * we, Me += y * Ue, Ae += y * De, he += y * _e, We += y * qe, Ye += y * Ce, xe += y * de, $e += y * Fe, Xe += y * Ke, y = k[14], ee += y * Te, fe += y * le, me += y * ke, re += y * Le, ue += y * be, Ie += y * Ne, ae += y * ze, Me += y * we, Ae += y * Ue, he += y * De, We += y * _e, Ye += y * qe, xe += y * Ce, $e += y * de, Xe += y * Fe, Oe += y * Ke, y = k[15], fe += y * Te, me += y * le, re += y * ke, ue += y * Le, Ie += y * be, ae += y * Ne, Me += y * ze, Ae += y * we, he += y * Ue, We += y * De, Ye += y * _e, xe += y * qe, $e += y * Ce, Xe += y * de, Oe += y * Fe, et += y * Ke, W += 38 * me, Z += 38 * re, J += 38 * ue, oe += 38 * Ie, Ee += 38 * ae, ce += 38 * Me, Re += 38 * Ae, Pe += 38 * he, se += 38 * We, Se += 38 * Ye, ve += 38 * xe, ie += 38 * $e, ge += 38 * Xe, pe += 38 * Oe, ee += 38 * et, R = 1, y = W + R + 65535, R = Math.floor(y / 65536), W = y - R * 65536, y = Z + R + 65535, R = Math.floor(y / 65536), Z = y - R * 65536, y = J + R + 65535, R = Math.floor(y / 65536), J = y - R * 65536, y = oe + R + 65535, R = Math.floor(y / 65536), oe = y - R * 65536, y = Ee + R + 65535, R = Math.floor(y / 65536), Ee = y - R * 65536, y = ce + R + 65535, R = Math.floor(y / 65536), ce = y - R * 65536, y = Re + R + 65535, R = Math.floor(y / 65536), Re = y - R * 65536, y = Pe + R + 65535, R = Math.floor(y / 65536), Pe = y - R * 65536, y = se + R + 65535, R = Math.floor(y / 65536), se = y - R * 65536, y = Se + R + 65535, R = Math.floor(y / 65536), Se = y - R * 65536, y = ve + R + 65535, R = Math.floor(y / 65536), ve = y - R * 65536, y = ie + R + 65535, R = Math.floor(y / 65536), ie = y - R * 65536, y = ge + R + 65535, R = Math.floor(y / 65536), ge = y - R * 65536, y = pe + R + 65535, R = Math.floor(y / 65536), pe = y - R * 65536, y = ee + R + 65535, R = Math.floor(y / 65536), ee = y - R * 65536, y = fe + R + 65535, R = Math.floor(y / 65536), fe = y - R * 65536, W += R - 1 + 37 * (R - 1), R = 1, y = W + R + 65535, R = Math.floor(y / 65536), W = y - R * 65536, y = Z + R + 65535, R = Math.floor(y / 65536), Z = y - R * 65536, y = J + R + 65535, R = Math.floor(y / 65536), J = y - R * 65536, y = oe + R + 65535, R = Math.floor(y / 65536), oe = y - R * 65536, y = Ee + R + 65535, R = Math.floor(y / 65536), Ee = y - R * 65536, y = ce + R + 65535, R = Math.floor(y / 65536), ce = y - R * 65536, y = Re + R + 65535, R = Math.floor(y / 65536), Re = y - R * 65536, y = Pe + R + 65535, R = Math.floor(y / 65536), Pe = y - R * 65536, y = se + R + 65535, R = Math.floor(y / 65536), se = y - R * 65536, y = Se + R + 65535, R = Math.floor(y / 65536), Se = y - R * 65536, y = ve + R + 65535, R = Math.floor(y / 65536), ve = y - R * 65536, y = ie + R + 65535, R = Math.floor(y / 65536), ie = y - R * 65536, y = ge + R + 65535, R = Math.floor(y / 65536), ge = y - R * 65536, y = pe + R + 65535, R = Math.floor(y / 65536), pe = y - R * 65536, y = ee + R + 65535, R = Math.floor(y / 65536), ee = y - R * 65536, y = fe + R + 65535, R = Math.floor(y / 65536), fe = y - R * 65536, W += R - 1 + 37 * (R - 1), L[0] = W, L[1] = Z, L[2] = J, L[3] = oe, L[4] = Ee, L[5] = ce, L[6] = Re, L[7] = Pe, L[8] = se, L[9] = Se, L[10] = ve, L[11] = ie, L[12] = ge, L[13] = pe, L[14] = ee, L[15] = fe;
  }
  function T(L, k) {
    v(L, k, k);
  }
  ...
  function p(L, k) {
    const q = n(), y = n(), R = n(), W = n(), Z = n(), J = n(), oe = n(), Ee = n(), ce = n();
    D(q, L[1], L[0]), D(ce, k[1], k[0]), v(q, q, ce), U(y, L[0], L[1]), U(ce, k[0], k[1]), v(y, y, ce), v(R, L[3], k[3]), v(R, R, f), v(W, L[2], k[2]), U(W, W, W), D(Z, y, q), D(J, W, R), U(oe, W, R), U(Ee, y, q), v(L[0], Z, J), v(L[1], Ee, oe), v(L[2], oe, J), v(L[3], Z, Ee);
  }
  function S(L, k, q) {
    for (let y = 0; y < 4; y++)
      j(L[y], k[y], q);
  ...
  function h(L, k, q) {
    A(L[0], a), A(L[1], c), A(L[2], c), A(L[3], a);
    for (let y = 255; y >= 0; --y) {
  ...
  function l(L, k) {
    const q = [n(), n(), n(), n()];
    A(q[0], g), A(q[1], _), A(q[2], c), v(q[3], g, _), h(L, q, k);
  }
  function E(L) {
  ...
  function B(L, k) {
    ...
    return A(L[2], c), N(L[1], k), T(R, L[1]), v(W, R, d), D(R, R, L[2]), U(W, L[2], W), T(Z, W), T(J, Z), v(oe, J, Z), v(q, oe, R), v(q, q, W), Q(q, q), v(q, q, R), v(q, q, W), v(q, q, W), v(L[0], q, W), T(y, L[0]), v(y, y, W), C(y, R) && v(L[0], L[0], x), T(y, L[0]), v(y, y, W), C(y, R) ? -1 : (K(L[0]) === k[31] >> 7 && D(L[0], a, L[0]), v(L[3], L[0], L[1]), 0);
  }
  function G(L, k, q) {
    ...
    const J = Z.digest();
    return b(J), h(R, W, J), l(W, q.subarray(32)), p(R, W), o(y, R), !V(q, y);
  }
  e.verify = G;
  function M(L) {
    let k = [n(), n(), n(), n()];
...
const Hp = "EdDSA", Wp = "JWT", Us = ".", co = "base64url", Xf = "utf8", Qf = "utf8", Gp = ":", Yp = "did", Jp = "key", qc = "base58btc", Zp = "z", Xp = "K36", Qp = 32;
function eu(e = 0) {
...
function e1(e, t) {
  ...
  var c = e.length, d = e.charAt(0), f = Math.log(c) / Math.log(256), g = Math.log(256) / Math.log(c);
  function _(O) {
    ...
    if (O[j] !== " ") {
      ...
      for (var C = (O.length - j) * f + 1 >>> 0, K = new Uint8Array(C); O[j]; ) {
        ...
        for (var U = 0, D = C - 1; (N !== 0 || U < V) && D !== -1; D--, U++)
          N += c * K[D] >>> 0, K[D] = N % 256 >>> 0, N = N / 256 >>> 0;
        if (N !== 0)
          throw new Error("Non-zero carry");
        V = U, j++;
      }
...
const ho = ({ name: e, prefix: t, encode: i, decode: r }) => new h1(e, t, i, r), ts = ({ prefix: e, name: t, alphabet: i }) => {
  ...
  for (let g = 0; g < s; ++g) {
    ...
    d = d << i | _, c += i, c >= 8 && (c -= 8, a[f++] = 255 & d >> c);
  }
  if (c >= i || 255 & d << 8 - c)
...
const zc = ru("utf8", "u", (e) => "u" + new TextDecoder("utf8").decode(e), (e) => new TextEncoder().encode(e.substring(1))), Co = ru("ascii", "a", (e) => {
  let t = "a";
...
function Uc(e) {
  return fn(It(St(e, co), Xf));
}
function Ds(e) {
  return It(St(Fr(e), Xf), co);
}
function su(e) {
  const t = St(Xp, qc), i = Zp + It(xs([t, e]), qc);
...
function fa(e) {
  const t = e.split(Us), i = Uc(t[0]), r = Uc(t[1]), n = Z1(t[2]), s = St(t.slice(0, 2).join(Us), Qf);
  return { header: i, payload: r, signature: n, data: s };
}
function Dc(e = Er.randomBytes(Qp)) {
  return Oa.generateKeyPairFromSeed(e);
}
async function eg(e, t, i, r, n = te.fromMiliseconds(Date.now())) {
  const s = { alg: Hp, typ: Wp }, a = su(r.publicKey), c = n + i, d = { iss: a, sub: e, aud: t, iat: n, exp: c }, f = X1({ header: s, payload: d }), g = Oa.sign(r.secretKey, f);
  return Q1({ header: s, payload: d, signature: g });
}
var Fc = globalThis && globalThis.__spreadArray || function(e, t, i) {
...
), og = /alexa|bot|crawl(er|ing)|facebookexternalhit|feedburner|google web preview|nagios|postrank|pingdom|slurp|spider|yahoo!|yandex/, ag = /(nuhk|curl|Googlebot|Yammybot|Openbot|Slurp|MSNBot|Ask\ Jeeves\/Teoma|ia_archiver)/, Kc = 3, cg = [
  ["aol", /AOLShield\/([0-9\._]+)/],
  ["edge", /Edge\/([0-9\._]+)/],
...
function ou(e) {
  return e ? $c(e) : typeof document > "u" && typeof navigator < "u" && navigator.product === "ReactNative" ? new sg() : typeof navigator < "u" ? $c(navigator.userAgent) : ug();
}
function hg(e) {
  return e !== "" && cg.reduce(function(t, i) {
    var r = i[0], n = i[1];
    if (t)
      return t;
    var s = n.exec(e);
...
function $c(e) {
  ...
  n ? n.length < Kc && (n = Fc(Fc([], n, !0), dg(Kc - n.length), !0)) : n = [];
  var s = n.join("."), a = fg(e), c = ag.exec(e);
  return c && c[1] ? new rg(i, s, a, c[1]) : new tg(i, s, a);
}
function fg(e) {
  for (var t = 0, i = Bc.length; t < i; t++) {
    var r = Bc[t], n = r[0], s = r[1], a = s.exec(e);
    if (a)
      return n;
  }
  return null;
...
var cu = Na.getWindowMetadata = void 0;
const Vc = ot;
function Sg() {
  let e, t;
  try {
    e = Vc.getDocumentOrThrow(), t = Vc.getLocationOrThrow();
  } catch {
    return null;
  }
  function i() {
...
cu = Na.getWindowMetadata = Sg;
var Yn = {}, Ig = (e) => encodeURIComponent(e).replace(/[!'()*]/g, (t) => `%${t.charCodeAt(0).toString(16).toUpperCase()}`), hu = "%[a-f0-9]{2}", Hc = new RegExp("(" + hu + ")|([^%]+?)", "gi"), Wc = new RegExp("(" + hu + ")+", "gi");
function ua(e, t) {
  try {
  ...
  return Array.prototype.concat.call([], ua(i), ua(r));
}
function Mg(e) {
  try {
    return decodeURIComponent(e);
  } catch {
    for (var t = e.match(Hc) || [], i = 1; i < t.length; i++)
      e = ua(t, i).join(""), t = e.match(Hc) || [];
    return e;
  }
}
function Ag(e) {
...
(function(e) {
  ...
  e.extract = j, e.parse = V, e.stringify = (C, K) => {
    ...
    const N = (T) => K.skipNull && s(C[T]) || K.skipEmptyString && C[T] === "", U = c(K), D = {};
...
(function(e) {
  (function() {
    ...
    a ? n = ti : s && (n = self);
    var c = !n.JS_SHA3_NO_COMMON_JS && !0 && e.exports, d = !n.JS_SHA3_NO_ARRAY_BUFFER && typeof ArrayBuffer < "u", f = "0123456789abcdef".split(""), g = [31, 7936, 2031616, 520093696], _ = [4, 1024, 262144, 67108864], x = [1, 256, 65536, 16777216], A = [6, 1536, 393216, 100663296], O = [0, 8, 16, 24], j = [
      1,
      0,
      32898,
      0,
    ...
    for (var N = function(M, $, L) {
      ...
      return function(k, q, y, R) {
        return h["cshake" + M].update(k, q, y, R)[L]();
      };
    }, v = function(M, $, L) {
      return function(k, q, y, R) {
        return h["kmac" + M].update(k, q, y, R)[L]();
      };
    }, T = function(M, $, L, k) {
      ...
      return k.create = function(q, y, R) {
        return !y && !R ? h["shake" + M].create(q) : new P(M, $, q).bytepad([y, R], L);
    ...
    ], h = {}, l = [], E = 0; E < o.length; ++E)
      for (var I = o[E], w = I.bits, u = 0; u < w.length; ++u) {
        var m = I.name + "_" + w[u];
        if (l.push(m), h[m] = I.createMethod(w[u], I.padding), I.name !== "sha3") {
          var b = I.name + w[u];
          l.push(b), h[b] = h[m];
        }
      }
    ...
    var G = function(M) {
      var $, L, k, q, y, R, W, Z, J, oe, Ee, ce, Re, Pe, se, Se, ve, ie, ge, pe, ee, fe, me, re, ue, Ie, ae, Me, Ae, he, We, Ye, xe, $e, Xe, Oe, et, Te, le, ke, Le, be, Ne, ze, we, Ue, De, _e, qe, Ce, de, Fe, Ke, je, it, tt, Je, Kt, Bt, $t, Vt, Ht, bt;
      for (k = 0; k < 48; k += 2)
        q = M[0] ^ M[10] ^ M[20] ^ M[30] ^ M[40], y = M[1] ^ M[11] ^ M[21] ^ M[31] ^ M[41], R = M[2] ^ M[12] ^ M[22] ^ M[32] ^ M[42], W = M[3] ^ M[13] ^ M[23] ^ M[33] ^ M[43], Z = M[4] ^ M[14] ^ M[24] ^ M[34] ^ M[44], J = M[5] ^ M[15] ^ M[25] ^ M[35] ^ M[45], oe = M[6] ^ M[16] ^ M[26] ^ M[36] ^ M[46], Ee = M[7] ^ M[17] ^ M[27] ^ M[37] ^ M[47], ce = M[8] ^ M[18] ^ M[28] ^ M[38] ^ M[48], Re = M[9] ^ M[19] ^ M[29] ^ M[39] ^ M[49], $ = ce ^ (R << 1 | W >>> 31), L = Re ^ (W << 1 | R >>> 31), M[0] ^= $, M[1] ^= L, M[10] ^= $, M[11] ^= L, M[20] ^= $, M[21] ^= L, M[30] ^= $, M[31] ^= L, M[40] ^= $, M[41] ^= L, $ = q ^ (Z << 1 | J >>> 31), L = y ^ (J << 1 | Z >>> 31), M[2] ^= $, M[3] ^= L, M[12] ^= $, M[13] ^= L, M[22] ^= $, M[23] ^= L, M[32] ^= $, M[33] ^= L, M[42] ^= $, M[43] ^= L, $ = R ^ (oe << 1 | Ee >>> 31), L = W ^ (Ee << 1 | oe >>> 31), M[4] ^= $, M[5] ^= L, M[14] ^= $, M[15] ^= L, M[24] ^= $, M[25] ^= L, M[34] ^= $, M[35] ^= L, M[44] ^= $, M[45] ^= L, $ = Z ^ (ce << 1 | Re >>> 31), L = J ^ (Re << 1 | ce >>> 31), M[6] ^= $, M[7] ^= L, M[16] ^= $, M[17] ^= L, M[26] ^= $, M[27] ^= L, M[36] ^= $, M[37] ^= L, M[46] ^= $, M[47] ^= L, $ = oe ^ (q << 1 | y >>> 31), L = Ee ^ (y << 1 | q >>> 31), M[8] ^= $, M[9] ^= L, M[18] ^= $, M[19] ^= L, M[28] ^= $, M[29] ^= L, M[38] ^= $, M[39] ^= L, M[48] ^= $, M[49] ^= L, Pe = M[0], se = M[1], Ue = M[11] << 4 | M[10] >>> 28, De = M[10] << 4 | M[11] >>> 28, Me = M[20] << 3 | M[21] >>> 29, Ae = M[21] << 3 | M[20] >>> 29, $t = M[31] << 9 | M[30] >>> 23, Vt = M[30] << 9 | M[31] >>> 23, be = M[40] << 18 | M[41] >>> 14, Ne = M[41] << 18 | M[40] >>> 14, $e = M[2] << 1 | M[3] >>> 31, Xe = M[3] << 1 | M[2] >>> 31, Se = M[13] << 12 | M[12] >>> 20, ve = M[12] << 12 | M[13] >>> 20, _e = M[22] << 10 | M[23] >>> 22, qe = M[23] << 10 | M[22] >>> 22, he = M[33] << 13 | M[32] >>> 19, We = M[32] << 13 | M[33] >>> 19, Ht = M[42] << 2 | M[43] >>> 30, bt = M[43] << 2 | M[42] >>> 30, je = M[5] << 30 | M[4] >>> 2, it = M[4] << 30 | M[5] >>> 2, Oe = M[14] << 6 | M[15] >>> 26, et = M[15] << 6 | M[14] >>> 26, ie = M[25] << 11 | M[24] >>> 21, ge = M[24] << 11 | M[25] >>> 21, Ce = M[34] << 15 | M[35] >>> 17, de = M[35] << 15 | M[34] >>> 17, Ye = M[45] << 29 | M[44] >>> 3, xe = M[44] << 29 | M[45] >>> 3, re = M[6] << 28 | M[7] >>> 4, ue = M[7] << 28 | M[6] >>> 4, tt = M[17] << 23 | M[16] >>> 9, Je = M[16] << 23 | M[17] >>> 9, Te = M[26] << 25 | M[27] >>> 7, le = M[27] << 25 | M[26] >>> 7, pe = M[36] << 21 | M[37] >>> 11, ee = M[37] << 21 | M[36] >>> 11, Fe = M[47] << 24 | M[46] >>> 8, Ke = M[46] << 24 | M[47] >>> 8, ze = M[8] << 27 | M[9] >>> 5, we = M[9] << 27 | M[8] >>> 5, Ie = M[18] << 20 | M[19] >>> 12, ae = M[19] << 20 | M[18] >>> 12, Kt = M[29] << 7 | M[28] >>> 25, Bt = M[28] << 7 | M[29] >>> 25, ke = M[38] << 8 | M[39] >>> 24, Le = M[39] << 8 | M[38] >>> 24, fe = M[48] << 14 | M[49] >>> 18, me = M[49] << 14 | M[48] >>> 18, M[0] = Pe ^ ~Se & ie, M[1] = se ^ ~ve & ge, M[10] = re ^ ~Ie & Me, M[11] = ue ^ ~ae & Ae, M[20] = $e ^ ~Oe & Te, M[21] = Xe ^ ~et & le, M[30] = ze ^ ~Ue & _e, M[31] = we ^ ~De & qe, M[40] = je ^ ~tt & Kt, M[41] = it ^ ~Je & Bt, M[2] = Se ^ ~ie & pe, M[3] = ve ^ ~ge & ee, M[12] = Ie ^ ~Me & he, M[13] = ae ^ ~Ae & We, M[22] = Oe ^ ~Te & ke, M[23] = et ^ ~le & Le, M[32] = Ue ^ ~_e & Ce, M[33] = De ^ ~qe & de, M[42] = tt ^ ~Kt & $t, M[43] = Je ^ ~Bt & Vt, M[4] = ie ^ ~pe & fe, M[5] = ge ^ ~ee & me, M[14] = Me ^ ~he & Ye, M[15] = Ae ^ ~We & xe, M[24] = Te ^ ~ke & be, M[25] = le ^ ~Le & Ne, M[34] = _e ^ ~Ce & Fe, M[35] = qe ^ ~de & Ke, M[44] = Kt ^ ~$t & Ht, M[45] = Bt ^ ~Vt & bt, M[6] = pe ^ ~fe & Pe, M[7] = ee ^ ~me & se, M[16] = he ^ ~Ye & re, M[17] = We ^ ~xe & ue, M[26] = ke ^ ~be & $e, M[27] = Le ^ ~Ne & Xe, M[36] = Ce ^ ~Fe & ze, M[37] = de ^ ~Ke & we, M[46] = $t ^ ~Ht & je, M[47] = Vt ^ ~bt & it, M[8] = fe ^ ~Pe & Se, M[9] = me ^ ~se & ve, M[18] = Ye ^ ~re & Ie, M[19] = xe ^ ~ue & ae, M[28] = be ^ ~$e & Oe, M[29] = Ne ^ ~Xe & et, M[38] = Fe ^ ~ze & Ue, M[39] = Ke ^ ~we & De, M[48] = Ht ^ ~je & tt, M[49] = bt ^ ~it & Je, M[0] ^= j[k], M[1] ^= j[k + 1];
    };
    if (c)
      e.exports = h;
    else
...
class ht {
  ...
  _log(t, i) {
    ...
    Os[r] == null && this.throwArgumentError("invalid log level name", "logLevel", t), !(Jc > Os[r]) && console.log.apply(console, i);
  }
  debug(...t) {
    this._log(ht.levels.DEBUG, t);
  }
  info(...t) {
    this._log(ht.levels.INFO, t);
  }
  warn(...t) {
    this._log(ht.levels.WARNING, t);
  }
  makeError(t, i, r) {
    if (Yc)
      return this.makeError("censored error", i, {});
    i || (i = ht.errors.UNKNOWN_ERROR), r || (r = {});
    const n = [];
    ...
    const c = new Error(t);
    return c.reason = s, c.code = i, Object.keys(r).forEach(function(d) {
      c[d] = r[d];
    }), c;
  }
  throwError(t, i, r) {
  ...
  throwArgumentError(t, i, r) {
    return this.throwError(t, ht.errors.INVALID_ARGUMENT, {
      argument: i,
      value: r
    });
  }
  ...
  checkNormalize(t) {
    Zc && this.throwError("platform missing String.prototype.normalize", ht.errors.UNSUPPORTED_OPERATION, {
      operation: "String.prototype.normalize",
      form: Zc
    });
  }
  checkSafeUint53(t, i) {
    typeof t == "number" && (i == null && (i = "value not safe"), (t < 0 || t >= 9007199254740991) && this.throwError(i, ht.errors.NUMERIC_FAULT, {
      operation: "checkSafeInteger",
      fault: "out-of-safe-range",
      value: t
    }), t % 1 && this.throwError(i, ht.errors.NUMERIC_FAULT, {
      operation: "checkSafeInteger",
      fault: "non-integer",
      value: t
    }));
  ...
  checkArgumentCount(t, i, r) {
    r ? r = ": " + r : r = "", t < i && this.throwError("missing argument" + r, ht.errors.MISSING_ARGUMENT, {
      count: t,
      expectedCount: i
    }), t > i && this.throwError("too many arguments" + r, ht.errors.UNEXPECTED_ARGUMENT, {
      count: t,
      expectedCount: i
    });
  }
  checkNew(t, i) {
    (t === Object || t == null) && this.throwError("missing new", ht.errors.MISSING_NEW, { name: i.name });
  }
  checkAbstract(t, i) {
    t === i ? this.throwError("cannot instantiate abstract class " + JSON.stringify(i.name) + " directly; use a sub-class", ht.errors.UNSUPPORTED_OPERATION, { name: t.name, operation: "new" }) : (t === Object || t == null) && this.throwError("missing new", ht.errors.MISSING_NEW, { name: i.name });
  }
  static globalLogger() {
    return qo || (qo = new ht(Tg)), qo;
  }
  static setCensorship(t, i) {
    if (!t && i && this.globalLogger().throwError("cannot permanently disable censorship", ht.errors.UNSUPPORTED_OPERATION, {
  ...
  static setLogLevel(t) {
    ...
    if (i == null) {
      ht.globalLogger().warn("invalid log level - " + t);
      return;
    }
    Jc = i;
  }
...
ht.errors = Ii;
ht.levels = da;
const Lg = "bytes/5.7.0", pt = new ht(Lg);
function uu(e) {
...
function cn(e) {
  return e.slice || (e.slice = function() {
    ...
    return cn(new Uint8Array(Array.prototype.slice.apply(e, t)));
  }), e;
}
function Cg(e) {
  return qi(e) && !(e.length % 2) || Ra(e);
}
function Qc(e) {
...
function Ra(e) {
  ...
  if (e.constructor === Uint8Array)
    return !0;
  if (typeof e == "string" || !Qc(e.length) || e.length < 0)
    return !1;
...
function mt(e, t) {
  if (t || (t = {}), typeof e == "number") {
    ...
    return i.length === 0 && i.push(0), cn(new Uint8Array(i));
  }
  if (t.allowMissingPrefix && typeof e == "string" && e.substring(0, 2) !== "0x" && (e = "0x" + e), uu(e) && (e = e.toHexString()), qi(e)) {
    let i = e.substring(2);
    ...
    return cn(new Uint8Array(r));
  }
  return Ra(e) ? cn(new Uint8Array(e)) : pt.throwArgumentError("invalid arrayify value", "value", e);
}
function qg(e) {
  const t = e.map((n) => mt(n)), i = t.reduce((n, s) => n + s.length, 0), r = new Uint8Array(i);
  return t.reduce((n, s) => (r.set(s, n), n + s.length), 0), cn(r);
}
function jg(e, t) {
  e = mt(e), e.length > t && pt.throwArgumentError("value out of range", "value", arguments[0]);
  const i = new Uint8Array(t);
  return i.set(e, t - e.length), cn(i);
}
function qi(e, t) {
...
function zg(e) {
  if (typeof e != "string")
    e = Yt(e);
  else if (!qi(e) || e.length % 2)
    return null;
  return (e.length - 2) / 2;
}
function eh(e, t, i) {
  return typeof e != "string" ? e = Yt(e) : (!qi(e) || e.length % 2) && pt.throwArgumentError("invalid hexData", "value", e), t = 2 + 2 * t, i != null ? "0x" + e.substring(t, 2 + 2 * i) : "0x" + e.substring(t);
}
function hn(e, t) {
  for (typeof e != "string" ? e = Yt(e) : qi(e) || pt.throwArgumentError("invalid hex string", "value", e), e.length > 2 * t + 2 && pt.throwArgumentError("value out of range", "value", arguments[1]); e.length < 2 * t + 2; )
    e = "0x0" + e.substring(2);
  return e;
}
function du(e) {
  ...
  if (Cg(e)) {
    let i = mt(e);
    i.length === 64 ? (t.v = 27 + (i[32] >> 7), i[32] &= 127, t.r = Yt(i.slice(0, 32)), t.s = Yt(i.slice(32, 64))) : i.length === 65 ? (t.r = Yt(i.slice(0, 32)), t.s = Yt(i.slice(32, 64)), t.v = i[64]) : pt.throwArgumentError("invalid signature string", "signature", e), t.v < 27 && (t.v === 0 || t.v === 1 ? t.v += 27 : pt.throwArgumentError("signature invalid v byte", "signature", e)), t.recoveryParam = 1 - t.v % 2, t.recoveryParam && (i[32] |= 128), t._vs = Yt(i.slice(32, 64));
  } else {
    ...
    t.r == null || !qi(t.r) ? pt.throwArgumentError("signature missing or invalid r", "signature", e) : t.r = hn(t.r, 32), t.s == null || !qi(t.s) ? pt.throwArgumentError("signature missing or invalid s", "signature", e) : t.s = hn(t.s, 32);
    const i = mt(t.s);
    i[0] >= 128 && pt.throwArgumentError("signature s out of range", "signature", e), t.recoveryParam && (i[0] |= 128);
    const r = Yt(i);
    t._vs && (qi(t._vs) || pt.throwArgumentError("signature invalid _vs", "signature", e), t._vs = hn(t._vs, 32)), t._vs == null ? t._vs = r : t._vs !== r && pt.throwArgumentError("signature _vs mismatch v and s", "signature", e);
  }
...
(function(e) {
  (function(t, i) {
    ...
    function n(o, h) {
      ...
      l.prototype = h.prototype, o.prototype = new l(), o.prototype.constructor = o;
    }
    function s(o, h, l) {
      if (s.isBN(o))
        return o;
      this.negative = 0, this.words = null, this.length = 0, this.red = null, o !== null && ((h === "le" || h === "be") && (l = h, h = 10), this._init(o || 0, h || 10, l || "be"));
    }
    typeof t == "object" ? t.exports = s : i.BN = s, s.BN = s, s.wordSize = 26;
    var a;
    try {
      typeof window < "u" && typeof window.Buffer < "u" ? a = window.Buffer : a = ao.Buffer;
    } catch {
    }
    s.isBN = function(o) {
      ...
      return o.cmp(h) < 0 ? o : h;
    }, s.prototype._init = function(o, h, l) {
      if (typeof o == "number")
        return this._initNumber(o, h, l);
      if (typeof o == "object")
        return this._initArray(o, h, l);
      h === "hex" && (h = 16), r(h === (h | 0) && h >= 2 && h <= 36), o = o.toString().replace(/\s+/g, "");
      var E = 0;
      o[0] === "-" && (E++, this.negative = 1), E < o.length && (h === 16 ? this._parseHex(o, E, l) : (this._parseBase(o, h, E), l === "le" && this._initArray(this.toArray(), h, l)));
    }, s.prototype._initNumber = function(o, h, l) {
      o < 0 && (this.negative = 1, o = -o), o < 67108864 ? (this.words = [o & 67108863], this.length = 1) : o < 4503599627370496 ? (this.words = [
        ...
        o / 67108864 & 67108863,
        1
      ], this.length = 3), l === "le" && this._initArray(this.toArray(), h, l);
    }, s.prototype._initArray = function(o, h, l) {
    ...
    function d(o, h, l) {
      var E = c(o, l);
      return l - 1 >= h && (E |= c(o, l - 1) << 4), E;
    }
    s.prototype._parseHex = function(o, h, l) {
      this.length = Math.ceil((o.length - h) / 6), this.words = new Array(this.length);
      for (var E = 0; E < this.length; E++)
        this.words[E] = 0;
      var I = 0, w = 0, u;
      if (l === "be")
        for (E = o.length - 1; E >= h; E -= 2)
          u = d(o, h, E) << I, this.words[w] |= u & 67108863, I >= 18 ? (I -= 18, w += 1, this.words[w] |= u >>> 26) : I += 8;
      else {
        var m = o.length - h;
        for (E = m % 2 === 0 ? h + 1 : h; E < o.length; E += 2)
          u = d(o, h, E) << I, this.words[w] |= u & 67108863, I >= 18 ? (I -= 18, w += 1, this.words[w] |= u >>> 26) : I += 8;
      }
      this._strip();
    };
    function f(o, h, l, E) {
      for (var I = 0, w = 0, u = Math.min(o.length, l), m = h; m < u; m++) {
        var b = o.charCodeAt(m) - 48;
        I *= E, b >= 49 ? w = b - 49 + 10 : b >= 17 ? w = b - 17 + 10 : w = b, r(b >= 0 && w < E, "Invalid character"), I += w;
      }
      return I;
    }
    s.prototype._parseBase = function(o, h, l) {
      this.words = [0], this.length = 1;
      for (var E = 0, I = 1; I <= 67108863; I *= h)
        E++;
      E--, I = I / h | 0;
      for (var w = o.length - l, u = w % E, m = Math.min(w, w - u) + l, b = 0, P = l; P < m; P += E)
        b = f(o, P, P + E, h), this.imuln(I), this.words[0] + b < 67108864 ? this.words[0] += b : this._iaddn(b);
      if (u !== 0) {
        var B = 1;
        for (b = f(o, P, o.length, h), P = 0; P < u; P++)
          B *= h;
    ...
    s.prototype.toString = function(o, h) {
      ...
      if (o === 16 || o === "hex") {
        ...
        for (I !== 0 && (l = I.toString(16) + l); l.length % h !== 0; )
          l = "0" + l;
      ...
      if (o === (o | 0) && o >= 2 && o <= 36) {
        ...
        for (this.isZero() && (l = "0" + l); l.length % h !== 0; )
          l = "0" + l;
        return this.negative !== 0 && (l = "-" + l), l;
      }
    ...
    function F(o) {
      for (var h = new Array(o.bitLength()), l = 0; l < h.length; l++) {
        var E = l / 26 | 0, I = l % 26;
        h[l] = o.words[E] >>> I & 1;
      }
      return h;
    ...
    s.prototype.zeroBits = function() {
      ...
      var h, l;
      this.length > o.length ? (h = this, l = o) : (h = o, l = this);
      for (var E = 0; E < l.length; E++)
        this.words[E] = h.words[E] ^ l.words[E];
      if (this !== h)
        for (; E < h.length; E++)
      ...
      r(typeof o == "number" && o >= 0);
      var l = o / 26 | 0, E = o % 26;
      return this._expand(l + 1), h ? this.words[l] = this.words[l] | 1 << E : this.words[l] = this.words[l] & ~(1 << E), this._strip();
      ...
      for (var I = 0, w = 0; w < E.length; w++)
        h = (l.words[w] | 0) + (E.words[w] | 0) + I, this.words[w] = h & 67108863, I = h >>> 26;
      for (; I !== 0 && w < l.length; w++)
        h = (l.words[w] | 0) + I, this.words[w] = h & 67108863, I = h >>> 26;
      ...
      for (var w = 0, u = 0; u < I.length; u++)
        h = (E.words[u] | 0) - (I.words[u] | 0) + w, w = h >> 26, this.words[u] = h & 67108863;
      for (; w !== 0 && u < E.length; u++)
        h = (E.words[u] | 0) + w, w = h >> 26, this.words[u] = h & 67108863;
    ...
    function V(o, h, l) {
      l.negative = h.negative ^ o.negative;
      var E = o.length + h.length | 0;
      l.length = E, E = E - 1 | 0;
      var I = o.words[0] | 0, w = h.words[0] | 0, u = I * w, m = u & 67108863, b = u / 67108864 | 0;
      l.words[0] = m;
      for (var P = 1; P < E; P++) {
        for (var B = b >>> 26, G = b & 67108863, M = Math.min(P, h.length - 1), $ = Math.max(0, P - o.length + 1); $ <= M; $++) {
          var L = P - $ | 0;
          I = o.words[L] | 0, w = h.words[$] | 0, u = I * w + G, B += u / 67108864 | 0, G = u & 67108863;
        }
        l.words[P] = G | 0, b = B | 0;
      }
      return b !== 0 ? l.words[P] = b | 0 : l.length--, l._strip();
    }
    var C = function(o, h, l) {
      var E = o.words, I = h.words, w = l.words, u = 0, m, b, P, B = E[0] | 0, G = B & 8191, M = B >>> 13, $ = E[1] | 0, L = $ & 8191, k = $ >>> 13, q = E[2] | 0, y = q & 8191, R = q >>> 13, W = E[3] | 0, Z = W & 8191, J = W >>> 13, oe = E[4] | 0, Ee = oe & 8191, ce = oe >>> 13, Re = E[5] | 0, Pe = Re & 8191, se = Re >>> 13, Se = E[6] | 0, ve = Se & 8191, ie = Se >>> 13, ge = E[7] | 0, pe = ge & 8191, ee = ge >>> 13, fe = E[8] | 0, me = fe & 8191, re = fe >>> 13, ue = E[9] | 0, Ie = ue & 8191, ae = ue >>> 13, Me = I[0] | 0, Ae = Me & 8191, he = Me >>> 13, We = I[1] | 0, Ye = We & 8191, xe = We >>> 13, $e = I[2] | 0, Xe = $e & 8191, Oe = $e >>> 13, et = I[3] | 0, Te = et & 8191, le = et >>> 13, ke = I[4] | 0, Le = ke & 8191, be = ke >>> 13, Ne = I[5] | 0, ze = Ne & 8191, we = Ne >>> 13, Ue = I[6] | 0, De = Ue & 8191, _e = Ue >>> 13, qe = I[7] | 0, Ce = qe & 8191, de = qe >>> 13, Fe = I[8] | 0, Ke = Fe & 8191, je = Fe >>> 13, it = I[9] | 0, tt = it & 8191, Je = it >>> 13;
      l.negative = o.negative ^ h.negative, l.length = 19, m = Math.imul(G, Ae), b = Math.imul(G, he), b = b + Math.imul(M, Ae) | 0, P = Math.imul(M, he);
      var Kt = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Kt >>> 26) | 0, Kt &= 67108863, m = Math.imul(L, Ae), b = Math.imul(L, he), b = b + Math.imul(k, Ae) | 0, P = Math.imul(k, he), m = m + Math.imul(G, Ye) | 0, b = b + Math.imul(G, xe) | 0, b = b + Math.imul(M, Ye) | 0, P = P + Math.imul(M, xe) | 0;
      var Bt = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Bt >>> 26) | 0, Bt &= 67108863, m = Math.imul(y, Ae), b = Math.imul(y, he), b = b + Math.imul(R, Ae) | 0, P = Math.imul(R, he), m = m + Math.imul(L, Ye) | 0, b = b + Math.imul(L, xe) | 0, b = b + Math.imul(k, Ye) | 0, P = P + Math.imul(k, xe) | 0, m = m + Math.imul(G, Xe) | 0, b = b + Math.imul(G, Oe) | 0, b = b + Math.imul(M, Xe) | 0, P = P + Math.imul(M, Oe) | 0;
      var $t = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + ($t >>> 26) | 0, $t &= 67108863, m = Math.imul(Z, Ae), b = Math.imul(Z, he), b = b + Math.imul(J, Ae) | 0, P = Math.imul(J, he), m = m + Math.imul(y, Ye) | 0, b = b + Math.imul(y, xe) | 0, b = b + Math.imul(R, Ye) | 0, P = P + Math.imul(R, xe) | 0, m = m + Math.imul(L, Xe) | 0, b = b + Math.imul(L, Oe) | 0, b = b + Math.imul(k, Xe) | 0, P = P + Math.imul(k, Oe) | 0, m = m + Math.imul(G, Te) | 0, b = b + Math.imul(G, le) | 0, b = b + Math.imul(M, Te) | 0, P = P + Math.imul(M, le) | 0;
      var Vt = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Vt >>> 26) | 0, Vt &= 67108863, m = Math.imul(Ee, Ae), b = Math.imul(Ee, he), b = b + Math.imul(ce, Ae) | 0, P = Math.imul(ce, he), m = m + Math.imul(Z, Ye) | 0, b = b + Math.imul(Z, xe) | 0, b = b + Math.imul(J, Ye) | 0, P = P + Math.imul(J, xe) | 0, m = m + Math.imul(y, Xe) | 0, b = b + Math.imul(y, Oe) | 0, b = b + Math.imul(R, Xe) | 0, P = P + Math.imul(R, Oe) | 0, m = m + Math.imul(L, Te) | 0, b = b + Math.imul(L, le) | 0, b = b + Math.imul(k, Te) | 0, P = P + Math.imul(k, le) | 0, m = m + Math.imul(G, Le) | 0, b = b + Math.imul(G, be) | 0, b = b + Math.imul(M, Le) | 0, P = P + Math.imul(M, be) | 0;
      var Ht = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Ht >>> 26) | 0, Ht &= 67108863, m = Math.imul(Pe, Ae), b = Math.imul(Pe, he), b = b + Math.imul(se, Ae) | 0, P = Math.imul(se, he), m = m + Math.imul(Ee, Ye) | 0, b = b + Math.imul(Ee, xe) | 0, b = b + Math.imul(ce, Ye) | 0, P = P + Math.imul(ce, xe) | 0, m = m + Math.imul(Z, Xe) | 0, b = b + Math.imul(Z, Oe) | 0, b = b + Math.imul(J, Xe) | 0, P = P + Math.imul(J, Oe) | 0, m = m + Math.imul(y, Te) | 0, b = b + Math.imul(y, le) | 0, b = b + Math.imul(R, Te) | 0, P = P + Math.imul(R, le) | 0, m = m + Math.imul(L, Le) | 0, b = b + Math.imul(L, be) | 0, b = b + Math.imul(k, Le) | 0, P = P + Math.imul(k, be) | 0, m = m + Math.imul(G, ze) | 0, b = b + Math.imul(G, we) | 0, b = b + Math.imul(M, ze) | 0, P = P + Math.imul(M, we) | 0;
      var bt = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (bt >>> 26) | 0, bt &= 67108863, m = Math.imul(ve, Ae), b = Math.imul(ve, he), b = b + Math.imul(ie, Ae) | 0, P = Math.imul(ie, he), m = m + Math.imul(Pe, Ye) | 0, b = b + Math.imul(Pe, xe) | 0, b = b + Math.imul(se, Ye) | 0, P = P + Math.imul(se, xe) | 0, m = m + Math.imul(Ee, Xe) | 0, b = b + Math.imul(Ee, Oe) | 0, b = b + Math.imul(ce, Xe) | 0, P = P + Math.imul(ce, Oe) | 0, m = m + Math.imul(Z, Te) | 0, b = b + Math.imul(Z, le) | 0, b = b + Math.imul(J, Te) | 0, P = P + Math.imul(J, le) | 0, m = m + Math.imul(y, Le) | 0, b = b + Math.imul(y, be) | 0, b = b + Math.imul(R, Le) | 0, P = P + Math.imul(R, be) | 0, m = m + Math.imul(L, ze) | 0, b = b + Math.imul(L, we) | 0, b = b + Math.imul(k, ze) | 0, P = P + Math.imul(k, we) | 0, m = m + Math.imul(G, De) | 0, b = b + Math.imul(G, _e) | 0, b = b + Math.imul(M, De) | 0, P = P + Math.imul(M, _e) | 0;
      var Hi = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Hi >>> 26) | 0, Hi &= 67108863, m = Math.imul(pe, Ae), b = Math.imul(pe, he), b = b + Math.imul(ee, Ae) | 0, P = Math.imul(ee, he), m = m + Math.imul(ve, Ye) | 0, b = b + Math.imul(ve, xe) | 0, b = b + Math.imul(ie, Ye) | 0, P = P + Math.imul(ie, xe) | 0, m = m + Math.imul(Pe, Xe) | 0, b = b + Math.imul(Pe, Oe) | 0, b = b + Math.imul(se, Xe) | 0, P = P + Math.imul(se, Oe) | 0, m = m + Math.imul(Ee, Te) | 0, b = b + Math.imul(Ee, le) | 0, b = b + Math.imul(ce, Te) | 0, P = P + Math.imul(ce, le) | 0, m = m + Math.imul(Z, Le) | 0, b = b + Math.imul(Z, be) | 0, b = b + Math.imul(J, Le) | 0, P = P + Math.imul(J, be) | 0, m = m + Math.imul(y, ze) | 0, b = b + Math.imul(y, we) | 0, b = b + Math.imul(R, ze) | 0, P = P + Math.imul(R, we) | 0, m = m + Math.imul(L, De) | 0, b = b + Math.imul(L, _e) | 0, b = b + Math.imul(k, De) | 0, P = P + Math.imul(k, _e) | 0, m = m + Math.imul(G, Ce) | 0, b = b + Math.imul(G, de) | 0, b = b + Math.imul(M, Ce) | 0, P = P + Math.imul(M, de) | 0;
      var Wi = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Wi >>> 26) | 0, Wi &= 67108863, m = Math.imul(me, Ae), b = Math.imul(me, he), b = b + Math.imul(re, Ae) | 0, P = Math.imul(re, he), m = m + Math.imul(pe, Ye) | 0, b = b + Math.imul(pe, xe) | 0, b = b + Math.imul(ee, Ye) | 0, P = P + Math.imul(ee, xe) | 0, m = m + Math.imul(ve, Xe) | 0, b = b + Math.imul(ve, Oe) | 0, b = b + Math.imul(ie, Xe) | 0, P = P + Math.imul(ie, Oe) | 0, m = m + Math.imul(Pe, Te) | 0, b = b + Math.imul(Pe, le) | 0, b = b + Math.imul(se, Te) | 0, P = P + Math.imul(se, le) | 0, m = m + Math.imul(Ee, Le) | 0, b = b + Math.imul(Ee, be) | 0, b = b + Math.imul(ce, Le) | 0, P = P + Math.imul(ce, be) | 0, m = m + Math.imul(Z, ze) | 0, b = b + Math.imul(Z, we) | 0, b = b + Math.imul(J, ze) | 0, P = P + Math.imul(J, we) | 0, m = m + Math.imul(y, De) | 0, b = b + Math.imul(y, _e) | 0, b = b + Math.imul(R, De) | 0, P = P + Math.imul(R, _e) | 0, m = m + Math.imul(L, Ce) | 0, b = b + Math.imul(L, de) | 0, b = b + Math.imul(k, Ce) | 0, P = P + Math.imul(k, de) | 0, m = m + Math.imul(G, Ke) | 0, b = b + Math.imul(G, je) | 0, b = b + Math.imul(M, Ke) | 0, P = P + Math.imul(M, je) | 0;
      var Gi = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Gi >>> 26) | 0, Gi &= 67108863, m = Math.imul(Ie, Ae), b = Math.imul(Ie, he), b = b + Math.imul(ae, Ae) | 0, P = Math.imul(ae, he), m = m + Math.imul(me, Ye) | 0, b = b + Math.imul(me, xe) | 0, b = b + Math.imul(re, Ye) | 0, P = P + Math.imul(re, xe) | 0, m = m + Math.imul(pe, Xe) | 0, b = b + Math.imul(pe, Oe) | 0, b = b + Math.imul(ee, Xe) | 0, P = P + Math.imul(ee, Oe) | 0, m = m + Math.imul(ve, Te) | 0, b = b + Math.imul(ve, le) | 0, b = b + Math.imul(ie, Te) | 0, P = P + Math.imul(ie, le) | 0, m = m + Math.imul(Pe, Le) | 0, b = b + Math.imul(Pe, be) | 0, b = b + Math.imul(se, Le) | 0, P = P + Math.imul(se, be) | 0, m = m + Math.imul(Ee, ze) | 0, b = b + Math.imul(Ee, we) | 0, b = b + Math.imul(ce, ze) | 0, P = P + Math.imul(ce, we) | 0, m = m + Math.imul(Z, De) | 0, b = b + Math.imul(Z, _e) | 0, b = b + Math.imul(J, De) | 0, P = P + Math.imul(J, _e) | 0, m = m + Math.imul(y, Ce) | 0, b = b + Math.imul(y, de) | 0, b = b + Math.imul(R, Ce) | 0, P = P + Math.imul(R, de) | 0, m = m + Math.imul(L, Ke) | 0, b = b + Math.imul(L, je) | 0, b = b + Math.imul(k, Ke) | 0, P = P + Math.imul(k, je) | 0, m = m + Math.imul(G, tt) | 0, b = b + Math.imul(G, Je) | 0, b = b + Math.imul(M, tt) | 0, P = P + Math.imul(M, Je) | 0;
      var Yi = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Yi >>> 26) | 0, Yi &= 67108863, m = Math.imul(Ie, Ye), b = Math.imul(Ie, xe), b = b + Math.imul(ae, Ye) | 0, P = Math.imul(ae, xe), m = m + Math.imul(me, Xe) | 0, b = b + Math.imul(me, Oe) | 0, b = b + Math.imul(re, Xe) | 0, P = P + Math.imul(re, Oe) | 0, m = m + Math.imul(pe, Te) | 0, b = b + Math.imul(pe, le) | 0, b = b + Math.imul(ee, Te) | 0, P = P + Math.imul(ee, le) | 0, m = m + Math.imul(ve, Le) | 0, b = b + Math.imul(ve, be) | 0, b = b + Math.imul(ie, Le) | 0, P = P + Math.imul(ie, be) | 0, m = m + Math.imul(Pe, ze) | 0, b = b + Math.imul(Pe, we) | 0, b = b + Math.imul(se, ze) | 0, P = P + Math.imul(se, we) | 0, m = m + Math.imul(Ee, De) | 0, b = b + Math.imul(Ee, _e) | 0, b = b + Math.imul(ce, De) | 0, P = P + Math.imul(ce, _e) | 0, m = m + Math.imul(Z, Ce) | 0, b = b + Math.imul(Z, de) | 0, b = b + Math.imul(J, Ce) | 0, P = P + Math.imul(J, de) | 0, m = m + Math.imul(y, Ke) | 0, b = b + Math.imul(y, je) | 0, b = b + Math.imul(R, Ke) | 0, P = P + Math.imul(R, je) | 0, m = m + Math.imul(L, tt) | 0, b = b + Math.imul(L, Je) | 0, b = b + Math.imul(k, tt) | 0, P = P + Math.imul(k, Je) | 0;
      var Ji = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Ji >>> 26) | 0, Ji &= 67108863, m = Math.imul(Ie, Xe), b = Math.imul(Ie, Oe), b = b + Math.imul(ae, Xe) | 0, P = Math.imul(ae, Oe), m = m + Math.imul(me, Te) | 0, b = b + Math.imul(me, le) | 0, b = b + Math.imul(re, Te) | 0, P = P + Math.imul(re, le) | 0, m = m + Math.imul(pe, Le) | 0, b = b + Math.imul(pe, be) | 0, b = b + Math.imul(ee, Le) | 0, P = P + Math.imul(ee, be) | 0, m = m + Math.imul(ve, ze) | 0, b = b + Math.imul(ve, we) | 0, b = b + Math.imul(ie, ze) | 0, P = P + Math.imul(ie, we) | 0, m = m + Math.imul(Pe, De) | 0, b = b + Math.imul(Pe, _e) | 0, b = b + Math.imul(se, De) | 0, P = P + Math.imul(se, _e) | 0, m = m + Math.imul(Ee, Ce) | 0, b = b + Math.imul(Ee, de) | 0, b = b + Math.imul(ce, Ce) | 0, P = P + Math.imul(ce, de) | 0, m = m + Math.imul(Z, Ke) | 0, b = b + Math.imul(Z, je) | 0, b = b + Math.imul(J, Ke) | 0, P = P + Math.imul(J, je) | 0, m = m + Math.imul(y, tt) | 0, b = b + Math.imul(y, Je) | 0, b = b + Math.imul(R, tt) | 0, P = P + Math.imul(R, Je) | 0;
      var ai = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (ai >>> 26) | 0, ai &= 67108863, m = Math.imul(Ie, Te), b = Math.imul(Ie, le), b = b + Math.imul(ae, Te) | 0, P = Math.imul(ae, le), m = m + Math.imul(me, Le) | 0, b = b + Math.imul(me, be) | 0, b = b + Math.imul(re, Le) | 0, P = P + Math.imul(re, be) | 0, m = m + Math.imul(pe, ze) | 0, b = b + Math.imul(pe, we) | 0, b = b + Math.imul(ee, ze) | 0, P = P + Math.imul(ee, we) | 0, m = m + Math.imul(ve, De) | 0, b = b + Math.imul(ve, _e) | 0, b = b + Math.imul(ie, De) | 0, P = P + Math.imul(ie, _e) | 0, m = m + Math.imul(Pe, Ce) | 0, b = b + Math.imul(Pe, de) | 0, b = b + Math.imul(se, Ce) | 0, P = P + Math.imul(se, de) | 0, m = m + Math.imul(Ee, Ke) | 0, b = b + Math.imul(Ee, je) | 0, b = b + Math.imul(ce, Ke) | 0, P = P + Math.imul(ce, je) | 0, m = m + Math.imul(Z, tt) | 0, b = b + Math.imul(Z, Je) | 0, b = b + Math.imul(J, tt) | 0, P = P + Math.imul(J, Je) | 0;
      var Zi = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Zi >>> 26) | 0, Zi &= 67108863, m = Math.imul(Ie, Le), b = Math.imul(Ie, be), b = b + Math.imul(ae, Le) | 0, P = Math.imul(ae, be), m = m + Math.imul(me, ze) | 0, b = b + Math.imul(me, we) | 0, b = b + Math.imul(re, ze) | 0, P = P + Math.imul(re, we) | 0, m = m + Math.imul(pe, De) | 0, b = b + Math.imul(pe, _e) | 0, b = b + Math.imul(ee, De) | 0, P = P + Math.imul(ee, _e) | 0, m = m + Math.imul(ve, Ce) | 0, b = b + Math.imul(ve, de) | 0, b = b + Math.imul(ie, Ce) | 0, P = P + Math.imul(ie, de) | 0, m = m + Math.imul(Pe, Ke) | 0, b = b + Math.imul(Pe, je) | 0, b = b + Math.imul(se, Ke) | 0, P = P + Math.imul(se, je) | 0, m = m + Math.imul(Ee, tt) | 0, b = b + Math.imul(Ee, Je) | 0, b = b + Math.imul(ce, tt) | 0, P = P + Math.imul(ce, Je) | 0;
      var Xi = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (Xi >>> 26) | 0, Xi &= 67108863, m = Math.imul(Ie, ze), b = Math.imul(Ie, we), b = b + Math.imul(ae, ze) | 0, P = Math.imul(ae, we), m = m + Math.imul(me, De) | 0, b = b + Math.imul(me, _e) | 0, b = b + Math.imul(re, De) | 0, P = P + Math.imul(re, _e) | 0, m = m + Math.imul(pe, Ce) | 0, b = b + Math.imul(pe, de) | 0, b = b + Math.imul(ee, Ce) | 0, P = P + Math.imul(ee, de) | 0, m = m + Math.imul(ve, Ke) | 0, b = b + Math.imul(ve, je) | 0, b = b + Math.imul(ie, Ke) | 0, P = P + Math.imul(ie, je) | 0, m = m + Math.imul(Pe, tt) | 0, b = b + Math.imul(Pe, Je) | 0, b = b + Math.imul(se, tt) | 0, P = P + Math.imul(se, Je) | 0;
      ...
      u = (P + (b >>> 13) | 0) + (Qi >>> 26) | 0, Qi &= 67108863, m = Math.imul(Ie, Ce), b = Math.imul(Ie, de), b = b + Math.imul(ae, Ce) | 0, P = Math.imul(ae, de), m = m + Math.imul(me, Ke) | 0, b = b + Math.imul(me, je) | 0, b = b + Math.imul(re, Ke) | 0, P = P + Math.imul(re, je) | 0, m = m + Math.imul(pe, tt) | 0, b = b + Math.imul(pe, Je) | 0, b = b + Math.imul(ee, tt) | 0, P = P + Math.imul(ee, Je) | 0;
      var er = (u + m | 0) + ((b & 8191) << 13) | 0;
      u = (P + (b >>> 13) | 0) + (er >>> 26) | 0, er &= 67108863, m = Math.imul(Ie, Ke), b = Math.imul(Ie, je), b = b + Math.imul(ae, Ke) | 0, P = Math.imul(ae, je), m = m + Math.imul(me, tt) | 0, b = b + Math.imul(me, Je) | 0, b = b + Math.imul(re, tt) | 0, P = P + Math.imul(re, Je) | 0;
      ...
      return u = (P + (b >>> 13) | 0) + (xn >>> 26) | 0, xn &= 67108863, w[0] = Kt, w[1] = Bt, w[2] = $t, w[3] = Vt, w[4] = Ht, w[5] = bt, w[6] = Hi, w[7] = Wi, w[8] = Gi, w[9] = Yi, w[10] = Ji, w[11] = ai, w[12] = Zi, w[13] = Xi, w[14] = Lt, w[15] = Qi, w[16] = er, w[17] = An, w[18] = xn, u !== 0 && (w[19] = u, l.length++), l;
    };
    Math.imul || (C = V);
    function K(o, h, l) {
      l.negative = h.negative ^ o.negative, l.length = o.length + h.length;
      for (var E = 0, I = 0, w = 0; w < l.length - 1; w++) {
        var u = I;
        I = 0;
        for (var m = E & 67108863, b = Math.min(w, h.length - 1), P = Math.max(0, w - o.length + 1); P <= b; P++) {
          var B = w - P, G = o.words[B] | 0, M = h.words[P] | 0, $ = G * M, L = $ & 67108863;
    ...
    s.prototype.mulTo = function(o, h) {
      ...
      return this.length === 10 && o.length === 10 ? l = C(this, o, h) : E < 63 ? l = V(this, o, h) : E < 1024 ? l = K(this, o, h) : l = N(this, o, h), l;
    }, s.prototype.mul = function(o) {
      var h = new s(null);
      return h.words = new Array(this.length + o.length), this.mulTo(o, h);
    }, s.prototype.mulf = function(o) {
      var h = new s(null);
      return h.words = new Array(this.length + o.length), N(this, o, h);
      ...
      return l !== 0 && (this.words[E] = l, this.length++), h ? this.ineg() : this;
      ...
      if (h.length === 0)
        return new s(1);
      for (var l = this, E = 0; E < h.length && h[E] === 0; E++, l = l.sqr())
        ;
      if (++E < h.length)
        for (var I = l.sqr(); E < h.length; E++, I = I.sqr())
          h[E] !== 0 && (l = l.mul(I));
      return l;
    }, s.prototype.iushln = function(o) {
      r(typeof o == "number" && o >= 0);
      var h = o % 26, l = (o - h) / 26, E = 67108863 >>> 26 - h << 26 - h, I;
      if (h !== 0) {
        var w = 0;
        for (I = 0; I < this.length; I++) {
          var u = this.words[I] & E, m = (this.words[I] | 0) - u << h;
          this.words[I] = m | w, w = u >>> 26 - h;
        }
    ...
    }, s.prototype.iushrn = function(o, h, l) {
      r(typeof o == "number" && o >= 0);
      var E;
      h ? E = (h - h % 26) / 26 : E = 0;
    ...
    }, s.prototype.ishrn = function(o, h, l) {
      return r(this.negative === 0), this.iushrn(o, h, l);
    ...
    }, s.prototype._ishlnsubmul = function(o, h, l) {
      var E = o.length + l, I;
      this._expand(E);
      var w, u = 0;
      ...
      return b && b._strip(), E._strip(), h !== "div" && l !== 0 && E.iushrn(l), {
        div: b || null,
        mod: E
      };
    }, s.prototype.divmod = function(o, h, l) {
      ...
      var E, I, w;
      return this.negative !== 0 && o.negative === 0 ? (w = this.neg().divmod(o, h), h !== "mod" && (E = w.div.neg()), h !== "div" && (I = w.mod.neg(), l && I.negative !== 0 && I.iadd(o)), {
        div: E,
        mod: I
      }) : this.negative === 0 && o.negative !== 0 ? (w = this.divmod(o.neg(), h), h !== "mod" && (E = w.div.neg()), {
        div: E,
        mod: w.mod
      }) : this.negative & o.negative ? (w = this.neg().divmod(o.neg(), h), h !== "div" && (I = w.mod.neg(), l && I.negative !== 0 && I.isub(o)), {
        div: w.div,
        mod: I
      ...
      if (h.mod.isZero())
        return h.div;
      var l = h.div.negative !== 0 ? h.mod.isub(o) : h.mod, E = o.ushrn(1), I = o.andln(1), w = l.cmp(E);
      return w < 0 || I === 1 && w === 0 ? h.div : h.div.negative !== 0 ? h.div.isubn(1) : h.div.iaddn(1);
      ...
      var h = this, l = o.clone();
      h.negative !== 0 ? h = h.umod(o) : h = h.clone();
      for (var E = new s(1), I = new s(0), w = new s(0), u = new s(1), m = 0; h.isEven() && l.isEven(); )
        h.iushrn(1), l.iushrn(1), ++m;
      for (var b = l.clone(), P = h.clone(); !h.isZero(); ) {
        ...
        h.cmp(l) >= 0 ? (h.isub(l), E.isub(w), I.isub(u)) : (l.isub(h), w.isub(E), u.isub(I));
      }
      return {
        a: w,
        b: u,
      ...
      var h = this, l = o.clone();
      h.negative !== 0 ? h = h.umod(o) : h = h.clone();
      for (var E = new s(1), I = new s(0), w = l.clone(); h.cmpn(1) > 0 && l.cmpn(1) > 0; ) {
        for (var u = 0, m = 1; !(h.words[0] & m) && u < 26; ++u, m <<= 1)
          ;
        if (u > 0)
          for (h.iushrn(u); u-- > 0; )
        ...
        h.cmp(l) >= 0 ? (h.isub(l), E.isub(I)) : (l.isub(h), I.isub(E));
      }
      var B;
      return h.cmpn(1) === 0 ? B = E : B = I, B.cmpn(0) < 0 && B.iadd(o), B;
    }, s.prototype.gcd = function(o) {
      if (this.isZero())
        return o.abs();
      if (o.isZero())
        return this.abs();
      var h = this.clone(), l = o.clone();
      h.negative = 0, l.negative = 0;
      for (var E = 0; h.isEven() && l.isEven(); E++)
        h.iushrn(1), l.iushrn(1);
      do {
        for (; h.isEven(); )
          h.iushrn(1);
        for (; l.isEven(); )
    ...
    D.prototype._tmp = function() {
      ...
      var h = o, l;
      do
        this.split(h, this.tmp), h = this.imulK(h), h = h.iadd(this.tmp), l = h.bitLength();
      while (l > this.n);
      var E = l < this.n ? -1 : h.ucmp(this.p);
      return E === 0 ? (h.words[0] = 0, h.length = 1) : E > 0 ? h.isub(this.p) : h.strip !== void 0 ? h.strip() : h._strip(), h;
    }, D.prototype.split = function(o, h) {
      o.iushrn(this.n, 0, h);
    ...
    n(v, D), v.prototype.split = function(o, h) {
      for (var l = 4194303, E = Math.min(o.length, 9), I = 0; I < E; I++)
        h.words[I] = o.words[I];
      if (h.length = E, o.length <= 9) {
        o.words[0] = 0, o.length = 1;
        return;
      }
      var w = o.words[9];
      for (h.words[h.length++] = w & l, I = 10; I < o.length; I++) {
        var u = o.words[I] | 0;
      ...
      for (var h = 0, l = 0; l < o.length; l++) {
        var E = o.words[l] | 0;
        h += E * 977, o.words[l] = h & 67108863, h = E * 64 + (h / 67108864 | 0);
      }
    ...
    n(Q, D), Q.prototype.imulK = function(o) {
      for (var h = 0, l = 0; l < o.length; l++) {
        var E = (o.words[l] | 0) * 19 + h, I = E & 67108863;
        E >>>= 26, o.words[l] = I, h = E;
      }
    ...
    p.prototype._verify1 = function(o) {
    ...
    }, p.prototype._verify2 = function(o, h) {
      ...
      var w = E[0], u = 0, m = 0, b = h.bitLength() % 26;
      for (b === 0 && (b = 26), I = h.length - 1; I >= 0; I--) {
        for (var P = h.words[I], B = b - 1; B >= 0; B--) {
          var G = P >> B & 1;
    ...
    n(S, p), S.prototype.convertTo = function(o) {
      ...
      return h.red = null, h;
    }, S.prototype.imul = function(o, h) {
      if (o.isZero() || h.isZero())
        return o.words[0] = 0, o.length = 1, o;
      var l = o.imul(h), E = l.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m), I = l.isub(E).iushrn(this.shift), w = I;
      return I.cmp(this.m) >= 0 ? w = I.isub(this.m) : I.cmpn(0) < 0 && (w = I.iadd(this.m)), w._forceRed(this);
    }, S.prototype.mul = function(o, h) {
      if (o.isZero() || h.isZero())
        return new s(0)._forceRed(this);
      var l = o.mul(h), E = l.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m), I = l.isub(E).iushrn(this.shift), w = I;
      return I.cmp(this.m) >= 0 ? w = I.isub(this.m) : I.cmpn(0) < 0 && (w = I.iadd(this.m)), w._forceRed(this);
    }, S.prototype.invm = function(o) {
...
const Kg = "strings/5.7.0", Bg = new ht(Kg);
var Fs;
(function(e) {
...
`;
function pu(e) {
  return typeof e == "string" && (e = zo(e)), Ta(qg([
    zo($g),
    zo(String(e.length)),
    e
  ]));
}
const Vg = "address/5.7.0", Fn = new ht(Vg);
function ih(e) {
  qi(e, 20) || Fn.throwArgumentError("invalid address", "address", e), e = e.toLowerCase();
...
const rh = Math.floor(Wg(Hg));
function Gg(e) {
  e = e.toUpperCase(), e = e.substring(4) + e.substring(0, 2) + "00";
  let t = e.split("").map((r) => ka[r]).join("");
  for (; t.length >= rh; ) {
    let r = t.substring(0, rh);
...
function Yg(e) {
  ...
  if (typeof e != "string" && Fn.throwArgumentError("invalid address", "address", e), e.match(/^(0x)?[0-9a-fA-F]{40}$/))
    e.substring(0, 2) !== "0x" && (e = "0x" + e), t = ih(e), e.match(/([A-F].*[a-f])|([a-f].*[A-F])/) && t !== e && Fn.throwArgumentError("bad address checksum", "address", e);
...
var la = { exports: {} };
typeof Object.create == "function" ? la.exports = function(e, t) {
...
function ib(e, t, i, r) {
  var n = i - t;
  Jg(n % 4 === 0);
  for (var s = new Array(n / 4), a = 0, c = t; a < s.length; a++, c += 4) {
    var d;
    r === "big" ? d = e[c] << 24 | e[c + 1] << 16 | e[c + 2] << 8 | e[c + 3] : d = e[c + 3] << 24 | e[c + 2] << 16 | e[c + 1] << 8 | e[c], s[a] = d >>> 0;
  }
  return s;
}
Qe.join32 = ib;
...
Qe.sum32_4 = cb;
function hb(e, t, i, r, n) {
  return e + t + i + r + n >>> 0;
}
Qe.sum32_5 = hb;
function fb(e, t, i, r) {
  var n = e[t], s = e[t + 1], a = r + s >>> 0, c = (a < r ? 1 : 0) + i + n;
  e[t] = c >>> 0, e[t + 1] = a;
}
Qe.sum64 = fb;
function ub(e, t, i, r) {
...
Qe.sum64_lo = db;
function lb(e, t, i, r, n, s, a, c) {
  var d = 0, f = t;
  f = f + r >>> 0, d += f < t ? 1 : 0, f = f + s >>> 0, d += f < s ? 1 : 0, f = f + c >>> 0, d += f < c ? 1 : 0;
  var g = e + i + n + a + d;
  return g >>> 0;
}
Qe.sum64_4_hi = lb;
function pb(e, t, i, r, n, s, a, c) {
  var d = t + r + s + c;
  return d >>> 0;
}
Qe.sum64_4_lo = pb;
function gb(e, t, i, r, n, s, a, c, d, f) {
  var g = 0, _ = t;
  _ = _ + r >>> 0, g += _ < t ? 1 : 0, _ = _ + s >>> 0, g += _ < s ? 1 : 0, _ = _ + c >>> 0, g += _ < c ? 1 : 0, _ = _ + f >>> 0, g += _ < f ? 1 : 0;
  var x = e + i + n + a + d + g;
  return x >>> 0;
}
Qe.sum64_5_hi = gb;
function bb(e, t, i, r, n, s, a, c, d, f) {
  var g = t + r + s + c + f;
  return g >>> 0;
}
Qe.sum64_5_lo = bb;
...
yn.BlockHash = uo;
uo.prototype.update = function(e, t) {
  if (e = nh.toArray(e, t), this.pending ? this.pending = this.pending.concat(e) : this.pending = e, this.pendingTotal += e.length, this.pending.length >= this._delta8) {
    e = this.pending;
    var i = e.length % this._delta8;
    this.pending = e.slice(e.length - i, e.length), this.pending.length === 0 && (this.pending = null), e = nh.join32(e, 0, e.length - i, this.endian);
    for (var r = 0; r < e.length; r += this._delta32)
      this._update(e, r, r + this._delta32);
  }
  return this;
};
uo.prototype.digest = function(e) {
  return this.update(this._pad()), _b(this.pending === null), this._digest(e);
};
uo.prototype._pad = function() {
...
$i.g1_256 = xb;
var un = Qe, Ob = yn, Pb = $i, Uo = un.rotl32, kn = un.sum32, Nb = un.sum32_5, Rb = Pb.ft_1, Eu = Ob.BlockHash, Tb = [
  1518500249,
  1859775393,
  2400959708,
  3395469782
...
Di.prototype._update = function(e, t) {
  for (var i = this.W, r = 0; r < 16; r++)
    i[r] = e[t + r];
  for (; r < i.length; r++)
    i[r] = Uo(i[r - 3] ^ i[r - 8] ^ i[r - 14] ^ i[r - 16], 1);
  var n = this.h[0], s = this.h[1], a = this.h[2], c = this.h[3], d = this.h[4];
  for (r = 0; r < i.length; r++) {
    var f = ~~(r / 20), g = Nb(Uo(n, 5), Rb(f, s, a, c), d, i[r], Tb[f]);
    d = c, c = a, a = Uo(s, 30), s = n, n = g;
  }
  this.h[0] = kn(this.h[0], n), this.h[1] = kn(this.h[1], s), this.h[2] = kn(this.h[2], a), this.h[3] = kn(this.h[3], c), this.h[4] = kn(this.h[4], d);
};
Di.prototype._digest = function(e) {
  return e === "hex" ? un.toHex32(this.h, "big") : un.split32(this.h, "big");
};
var dn = Qe, Lb = yn, wn = $i, Cb = Gr, wi = dn.sum32, qb = dn.sum32_4, jb = dn.sum32_5, zb = wn.ch32, Ub = wn.maj32, Db = wn.s0_256, Fb = wn.s1_256, Kb = wn.g0_256, Bb = wn.g1_256, Su = Lb.BlockHash, $b = [
  1116352408,
  1899447441,
  3049323471,
  3921009573,
...
Fi.prototype._update = function(e, t) {
  ...
  var n = this.h[0], s = this.h[1], a = this.h[2], c = this.h[3], d = this.h[4], f = this.h[5], g = this.h[6], _ = this.h[7];
  for (Cb(this.k.length === i.length), r = 0; r < i.length; r++) {
    var x = jb(_, Fb(d), zb(d, f, g), this.k[r], i[r]), A = wi(Db(n), Ub(n, s, a));
    _ = g, g = f, f = d, d = wi(c, x), c = a, a = s, s = n, n = wi(x, A);
  }
  this.h[0] = wi(this.h[0], n), this.h[1] = wi(this.h[1], s), this.h[2] = wi(this.h[2], a), this.h[3] = wi(this.h[3], c), this.h[4] = wi(this.h[4], d), this.h[5] = wi(this.h[5], f), this.h[6] = wi(this.h[6], g), this.h[7] = wi(this.h[7], _);
};
...
fr.prototype._digest = function(e) {
  return e === "hex" ? pa.toHex32(this.h.slice(0, 7), "big") : pa.split32(this.h.slice(0, 7), "big");
};
var Jt = Qe, Hb = yn, Wb = Gr, zi = Jt.rotr64_hi, Ui = Jt.rotr64_lo, Au = Jt.shr64_hi, xu = Jt.shr64_lo, gr = Jt.sum64, Do = Jt.sum64_hi, Fo = Jt.sum64_lo, Gb = Jt.sum64_4_hi, Yb = Jt.sum64_4_lo, Jb = Jt.sum64_5_hi, Zb = Jt.sum64_5_lo, Ou = Hb.BlockHash, Xb = [
  1116352408,
  3609767458,
  1899447441,
  602891725,
...
xi.prototype._prepareBlock = function(e, t) {
  for (var i = this.W, r = 0; r < 32; r++)
    i[r] = e[t + r];
  for (; r < i.length; r += 2) {
    var n = hm(i[r - 4], i[r - 3]), s = fm(i[r - 4], i[r - 3]), a = i[r - 14], c = i[r - 13], d = am(i[r - 30], i[r - 29]), f = cm(i[r - 30], i[r - 29]), g = i[r - 32], _ = i[r - 31];
    i[r] = Gb(
      n,
      s,
      a,
...
xi.prototype._update = function(e, t) {
  ...
  var i = this.W, r = this.h[0], n = this.h[1], s = this.h[2], a = this.h[3], c = this.h[4], d = this.h[5], f = this.h[6], g = this.h[7], _ = this.h[8], x = this.h[9], A = this.h[10], O = this.h[11], j = this.h[12], F = this.h[13], V = this.h[14], C = this.h[15];
  Wb(this.k.length === i.length);
  for (var K = 0; K < i.length; K += 2) {
    var N = V, U = C, D = sm(_, x), v = om(_, x), T = Qb(_, x, A, O, j), Y = em(_, x, A, O, j, F), Q = this.k[K], p = this.k[K + 1], S = i[K], o = i[K + 1], h = Jb(
      N,
      U,
      D,
      v,
    ...
    N = rm(r, n), U = nm(r, n), D = tm(r, n, s, a, c), v = im(r, n, s, a, c, d);
    var E = Do(N, U, D, v), I = Fo(N, U, D, v);
    V = j, C = F, j = A, F = O, A = _, O = x, _ = Do(f, g, h, l), x = Fo(g, g, h, l), f = c, g = d, c = s, d = a, s = r, a = n, r = Do(h, l, E, I), n = Fo(h, l, E, I);
  }
  gr(this.h, 0, r, n), gr(this.h, 2, s, a), gr(this.h, 4, c, d), gr(this.h, 6, f, g), gr(this.h, 8, _, x), gr(this.h, 10, A, O), gr(this.h, 12, j, F), gr(this.h, 14, V, C);
};
xi.prototype._digest = function(e) {
  return e === "hex" ? Jt.toHex32(this.h, "big") : Jt.split32(this.h, "big");
};
...
function nm(e, t) {
  var i = Ui(e, t, 28), r = Ui(t, e, 2), n = Ui(t, e, 7), s = i ^ r ^ n;
  return s < 0 && (s += 4294967296), s;
}
function sm(e, t) {
...
function om(e, t) {
  var i = Ui(e, t, 14), r = Ui(e, t, 18), n = Ui(t, e, 9), s = i ^ r ^ n;
  return s < 0 && (s += 4294967296), s;
}
function am(e, t) {
  var i = zi(e, t, 1), r = zi(e, t, 8), n = Au(e, t, 7), s = i ^ r ^ n;
  return s < 0 && (s += 4294967296), s;
}
function cm(e, t) {
  var i = Ui(e, t, 1), r = Ui(e, t, 8), n = xu(e, t, 7), s = i ^ r ^ n;
  return s < 0 && (s += 4294967296), s;
}
function hm(e, t) {
  var i = zi(e, t, 19), r = zi(t, e, 29), n = Au(e, t, 6), s = i ^ r ^ n;
  return s < 0 && (s += 4294967296), s;
}
function fm(e, t) {
  var i = Ui(e, t, 19), r = Ui(t, e, 29), n = xu(e, t, 6), s = i ^ r ^ n;
  return s < 0 && (s += 4294967296), s;
}
var ga = Qe, Nu = Pu;
function ur() {
...
ur.prototype._digest = function(e) {
  return e === "hex" ? ga.toHex32(this.h.slice(0, 12), "big") : ga.split32(this.h.slice(0, 12), "big");
};
vn.sha1 = kb;
vn.sha224 = Vb;
vn.sha256 = Iu;
vn.sha384 = um;
vn.sha512 = Pu;
var Ru = {}, Kr = Qe, dm = yn, _s = Kr.rotl32, sh = Kr.sum32, Ln = Kr.sum32_3, oh = Kr.sum32_4, Tu = dm.BlockHash;
function Ki() {
...
Ki.hmacStrength = 192;
Ki.padLength = 64;
Ki.prototype._update = function(e, t) {
  for (var i = this.h[0], r = this.h[1], n = this.h[2], s = this.h[3], a = this.h[4], c = i, d = r, f = n, g = s, _ = a, x = 0; x < 80; x++) {
    var A = sh(
      _s(
        oh(i, ah(x, r, n, s), e[gm[x] + t], lm(x)),
        mm[x]
      ),
      a
    );
    i = a, a = s, s = _s(n, 10), n = r, r = A, A = sh(
      _s(
        oh(c, ah(79 - x, d, f, g), e[bm[x] + t], pm(x)),
        ym[x]
      ),
      _
    ), c = _, _ = g, g = _s(f, 10), f = d, d = A;
  }
  A = Ln(this.h[1], n, g), this.h[1] = Ln(this.h[2], s, _), this.h[2] = Ln(this.h[3], a, c), this.h[3] = Ln(this.h[4], i, d), this.h[4] = Ln(this.h[0], r, f), this.h[0] = A;
};
...
var Mi = _n(function(e, t) {
  ...
  i.toHex = s, i.encode = function(a, c) {
    return c === "hex" ? s(a) : a;
  };
}), si = _n(function(e, t) {
  var i = t;
...
Sr.prototype._fixedNafMul = function(e, t) {
  ...
  for (var f = this.jpoint(null, null, null), g = this.jpoint(null, null, null), _ = n; _ > 0; _--) {
    for (a = 0; a < s.length; a++)
      c = s[a], c === _ ? g = g.mixedAdd(i.points[a]) : c === -_ && (g = g.mixedAdd(i.points[a].neg()));
    f = f.add(g);
  }
  return f.toP();
};
Sr.prototype._wnafMul = function(e, t) {
  ...
  i = r.wnd;
  for (var n = r.points, s = Ks(t, i, this._bitLength), a = this.jpoint(null, null, null), c = s.length - 1; c >= 0; c--) {
    for (var d = 0; c >= 0 && s[c] === 0; c--)
      d++;
    if (c >= 0 && d++, a = a.dblp(d), c < 0)
      break;
    var f = s[c];
...
Sr.prototype._wnafMulAdd = function(e, t, i, r, n) {
  var s = this._wnafT1, a = this._wnafT2, c = this._wnafT3, d = 0, f, g, _;
  for (f = 0; f < r; f++) {
    _ = t[f];
  ...
  for (f = r - 1; f >= 1; f -= 2) {
    var A = f - 1, O = f;
    if (s[A] !== 1 || s[O] !== 1) {
      c[A] = Ks(i[A], s[A], this._bitLength), c[O] = Ks(i[O], s[O], this._bitLength), d = Math.max(c[A].length, d), d = Math.max(c[O].length, d);
      continue;
    }
    var j = [
      t[A],
    ...
    for (d = Math.max(V[0].length, d), c[A] = new Array(d), c[O] = new Array(d), g = 0; g < d; g++) {
      var C = V[0][g] | 0, K = V[1][g] | 0;
      c[A][g] = F[(C + 1) * 3 + (K + 1)], c[O][g] = 0, a[A] = j;
    }
  }
...
bi.prototype._getEndoBasis = function(e) {
  for (var t = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), i = e, r = this.n.clone(), n = new Be(1), s = new Be(0), a = new Be(0), c = new Be(1), d, f, g, _, x, A, O, j = 0, F, V; i.cmpn(0) !== 0; ) {
    var C = r.div(i);
...
bi.prototype._endoSplit = function(e) {
  var t = this.endo.basis, i = t[0], r = t[1], n = r.b.mul(e).divRound(this.n), s = i.b.neg().mul(e).divRound(this.n), a = n.mul(i.a), c = s.mul(r.a), d = n.mul(i.b), f = s.mul(r.b), g = e.sub(a).sub(c), _ = d.add(f).neg();
  return { k1: g, k2: _ };
};
...
bi.prototype._endoWnafMulAdd = function(e, t, i) {
  for (var r = this._endoWnafT1, n = this._endoWnafT2, s = 0; s < e.length; s++) {
    var a = this._endoSplit(t[s]), c = e[s], d = c._getBeta();
    a.k1.negative && (a.k1.ineg(), c = c.neg(!0)), a.k2.negative && (a.k2.ineg(), d = d.neg(!0)), r[s * 2] = c, r[s * 2 + 1] = d, n[s * 2] = a.k1, n[s * 2 + 1] = a.k2;
  }
...
Rt.prototype.add = function(e) {
  ...
  if (e.isInfinity())
    return this;
  var t = e.z.redSqr(), i = this.z.redSqr(), r = this.x.redMul(t), n = e.x.redMul(i), s = this.y.redMul(t.redMul(e.z)), a = e.y.redMul(i.redMul(this.z)), c = r.redSub(n), d = s.redSub(a);
  if (c.cmpn(0) === 0)
    return d.cmpn(0) !== 0 ? this.curve.jpoint(null, null, null) : this.dbl();
  var f = c.redSqr(), g = f.redMul(c), _ = r.redMul(f), x = d.redSqr().redIAdd(g).redISub(_).redISub(_), A = d.redMul(_.redISub(x)).redISub(s.redMul(g)), O = this.z.redMul(e.z).redMul(c);
...
Rt.prototype.mixedAdd = function(e) {
  ...
  if (e.isInfinity())
    return this;
  var t = this.z.redSqr(), i = this.x, r = e.x.redMul(t), n = this.y, s = e.y.redMul(t).redMul(this.z), a = i.redSub(r), c = n.redSub(s);
  if (a.cmpn(0) === 0)
    return c.cmpn(0) !== 0 ? this.curve.jpoint(null, null, null) : this.dbl();
  var d = a.redSqr(), f = d.redMul(a), g = i.redMul(d), _ = c.redSqr().redIAdd(f).redISub(g).redISub(g), x = c.redMul(g.redISub(_)).redISub(n.redMul(f)), A = this.z.redMul(a);
...
Rt.prototype.dblp = function(e) {
  ...
  var r = this.curve.a, n = this.curve.tinv, s = this.x, a = this.y, c = this.z, d = c.redSqr().redSqr(), f = a.redAdd(a);
  for (t = 0; t < e; t++) {
    ...
    var C = f.redMul(c);
    t + 1 < e && (d = d.redMul(x)), s = j, c = C, f = V;
  }
...
Rt.prototype._zeroDbl = function() {
  ...
  if (this.zOne) {
    ...
    a = a.redIAdd(a);
    var c = r.redAdd(r).redIAdd(r), d = c.redSqr().redISub(a).redISub(a), f = s.redIAdd(s);
    f = f.redIAdd(f), f = f.redIAdd(f), e = d, t = c.redMul(a.redISub(d)).redISub(f), i = this.y.redAdd(this.y);
  } else {
...
Rt.prototype._threeDbl = function() {
  ...
  if (this.zOne) {
    var r = this.x.redSqr(), n = this.y.redSqr(), s = n.redSqr(), a = this.x.redAdd(n).redSqr().redISub(r).redISub(s);
    a = a.redIAdd(a);
    var c = r.redAdd(r).redIAdd(r).redIAdd(this.curve.a), d = c.redSqr().redISub(a).redISub(a);
    e = d;
    var f = s.redIAdd(s);
    f = f.redIAdd(f), f = f.redIAdd(f), t = c.redMul(a.redISub(d)).redISub(f), i = this.y.redAdd(this.y);
  } else {
...
Rt.prototype._dbl = function() {
  var e = this.curve.a, t = this.x, i = this.y, r = this.z, n = r.redSqr().redSqr(), s = t.redSqr(), a = i.redSqr(), c = s.redAdd(s).redIAdd(s).redIAdd(e.redMul(n)), d = t.redAdd(t);
  d = d.redIAdd(d);
  var f = d.redMul(a), g = c.redSqr().redISub(f.redAdd(f)), _ = f.redISub(g), x = a.redSqr();
  x = x.redIAdd(x), x = x.redIAdd(x), x = x.redIAdd(x);
  var A = c.redMul(_).redISub(x), O = i.redAdd(i).redMul(r);
...
Rt.prototype.trpl = function() {
  ...
  var c = a.redSqr(), d = r.redIAdd(r);
  d = d.redIAdd(d), d = d.redIAdd(d), d = d.redIAdd(d);
  var f = n.redIAdd(a).redSqr().redISub(s).redISub(c).redISub(d), g = t.redMul(f);
  g = g.redIAdd(g), g = g.redIAdd(g);
  var _ = this.x.redMul(c).redISub(g);
  _ = _.redIAdd(_), _ = _.redIAdd(_);
  var x = this.y.redMul(f.redMul(d.redISub(f)).redISub(a.redMul(c)));
  x = x.redIAdd(x), x = x.redIAdd(x), x = x.redIAdd(x);
  var A = this.z.redAdd(a).redSqr().redISub(i).redISub(c);
  return this.curve.jpoint(_, x, A);
};
...
var Ps = _n(function(e, t) {
  ...
  var i = t, r = si.assert;
  function n(c) {
    c.type === "short" ? this.curve = new Ps.short(c) : c.type === "edwards" ? this.curve = new Ps.edwards(c) : this.curve = new Ps.mont(c), this.g = this.curve.g, this.n = this.curve.n, this.hash = c.hash, r(this.g.validate(), "Invalid curve"), r(this.g.mul(this.n).isInfinity(), "Invalid curve, G*N != O");
  }
  i.PresetCurve = n;
  function s(c, d) {
...
wr.prototype._hmac = function() {
  return new nr.hmac(this.hash, this.K);
};
...
jt.prototype._importPublic = function(e, t) {
  if (e.x || e.y) {
    this.ec.curve.type === "mont" ? ba(e.x, "Need x coordinate") : (this.ec.curve.type === "short" || this.ec.curve.type === "edwards") && ba(e.x && e.y, "Need both x and y coordinate"), this.pub = this.ec.curve.point(e.x, e.y);
    return;
  }
  this.pub = this.ec.curve.decodePoint(e, t);
};
jt.prototype.derive = function(e) {
  return e.validate() || ba(e.validate(), "public point not validated"), e.mul(this.priv).getX();
};
...
lo.prototype._importDER = function(e, t) {
  ...
  if (c[0] === 0)
    if (c[1] & 128)
      ...
      return !1;
  return this.r = new Be(s), this.s = new Be(c), this.recoveryParam = null, !0;
};
function Bo(e, t) {
  if (t < 128) {
    e.push(t);
...
lo.prototype.toDER = function(e) {
  ...
  for (t[0] & 128 && (t = [0].concat(t)), i[0] & 128 && (i = [0].concat(i)), t = ch(t), i = ch(i); !i[0] && !(i[1] & 128); )
    i = i.slice(1);
  var r = [2];
  Bo(r, t.length), r = r.concat(t), r.push(2), Bo(r, i.length);
  var n = r.concat(i), s = [48];
  return Bo(s, n.length), s = s.concat(n), si.encode(s, e);
};
var Om = (
...
li.prototype.sign = function(e, t, i, r) {
  ...
  for (var n = this.n.byteLength(), s = t.getPrivate().toArray("be", n), a = e.toArray("be", n), c = new Lu({
    hash: this.hash,
    entropy: s,
    nonce: a,
    pers: r.pers,
    ...
    var g = r.k ? r.k(f) : new Be(c.generate(this.n.byteLength()));
      ...
      if (!_.isInfinity()) {
        ...
        if (A.cmpn(0) !== 0) {
          ...
          if (O = O.umod(this.n), O.cmpn(0) !== 0) {
            ...
            return r.canonical && O.cmp(this.nh) > 0 && (O = this.n.sub(O), j ^= 1), new po({ r: A, s: O, recoveryParam: j });
          }
        }
      }
    }
...
li.prototype.verify = function(e, t, i, r) {
  e = this._truncateToN(new Be(e, 16)), i = this.keyFromPublic(i, r), t = new po(t, "hex");
  var n = t.r, s = t.s;
  if (n.cmpn(1) < 0 || n.cmp(this.n) >= 0 || s.cmpn(1) < 0 || s.cmp(this.n) >= 0)
    return !1;
  var a = s.invm(this.n), c = a.mul(e).umod(this.n), d = a.mul(n).umod(this.n), f;
  return this.curve._maxwellTrick ? (f = this.g.jmulAdd(c, i.getPublic(), d), f.isInfinity() ? !1 : f.eqXToP(n)) : (f = this.g.mulAdd(c, i.getPublic(), d), f.isInfinity() ? !1 : f.getX().umod(this.n).cmp(n) === 0);
};
li.prototype.recoverPubKey = function(e, t, i, r) {
  Cu((3 & i) === i, "The recovery param is more than two bits"), t = new po(t, r);
  var n = this.n, s = new Be(e), a = t.r, c = t.s, d = i & 1, f = i >> 1;
  ...
  var g = t.r.invm(n), _ = n.sub(s).mul(g).umod(n), x = c.mul(g).umod(n);
  return this.g.mulAdd(_, a, x);
};
li.prototype.getKeyRecoveryParam = function(e, t, i, r) {
  if (t = new po(t, r), t.recoveryParam !== null)
...
const Tm = "signing-key/5.7.0", ma = new ht(Tm);
let $o = null;
function Li() {
  return $o || ($o = new Rm("secp256k1")), $o;
}
class km {
  constructor(t) {
    Tn(this, "curve", "secp256k1"), Tn(this, "privateKey", Yt(t)), zg(this.privateKey) !== 32 && ma.throwArgumentError("invalid private key", "privateKey", "[[ REDACTED ]]");
    const i = Li().keyFromPrivate(mt(this.privateKey));
    Tn(this, "publicKey", "0x" + i.getPublic(!1, "hex")), Tn(this, "compressedPublicKey", "0x" + i.getPublic(!0, "hex")), Tn(this, "_isSigningKey", !0);
  }
  _addPoint(t) {
    const i = Li().keyFromPublic(mt(this.publicKey)), r = Li().keyFromPublic(mt(t));
    return "0x" + i.pub.add(r.pub).encodeCompressed("hex");
  }
  signDigest(t) {
    const i = Li().keyFromPrivate(mt(this.privateKey)), r = mt(t);
    r.length !== 32 && ma.throwArgumentError("bad digest length", "digest", t);
  ...
  computeSharedSecret(t) {
    const i = Li().keyFromPrivate(mt(this.privateKey)), r = Li().keyFromPublic(mt(qu(t)));
    return hn("0x" + i.derive(r.getPublic()).toString(16), 32);
  }
...
function Lm(e, t) {
  ...
  return "0x" + Li().recoverPubKey(mt(e), r, i.recoveryParam).encode("hex", !1);
}
function qu(e, t) {
  const i = mt(e);
  if (i.length === 32) {
    const r = new km(i);
    return t ? "0x" + Li().keyFromPrivate(i).getPublic(!0, "hex") : r.publicKey;
  } else {
    if (i.length === 33)
      return t ? Yt(i) : "0x" + Li().keyFromPublic(i).getPublic(!1, "hex");
    if (i.length === 65)
      return t ? "0x" + Li().keyFromPublic(i).getPublic(!0, "hex") : Yt(i);
  }
  return ma.throwArgumentError("invalid public or private key", "key", "[REDACTED]");
}
var hh;
(function(e) {
...
var qt = Ve, ya = ni, jm = 20;
function zm(e, t, i) {
  for (var r = 1634760805, n = 857760878, s = 2036477234, a = 1797285236, c = i[3] << 24 | i[2] << 16 | i[1] << 8 | i[0], d = i[7] << 24 | i[6] << 16 | i[5] << 8 | i[4], f = i[11] << 24 | i[10] << 16 | i[9] << 8 | i[8], g = i[15] << 24 | i[14] << 16 | i[13] << 8 | i[12], _ = i[19] << 24 | i[18] << 16 | i[17] << 8 | i[16], x = i[23] << 24 | i[22] << 16 | i[21] << 8 | i[20], A = i[27] << 24 | i[26] << 16 | i[25] << 8 | i[24], O = i[31] << 24 | i[30] << 16 | i[29] << 8 | i[28], j = t[3] << 24 | t[2] << 16 | t[1] << 8 | t[0], F = t[7] << 24 | t[6] << 16 | t[5] << 8 | t[4], V = t[11] << 24 | t[10] << 16 | t[9] << 8 | t[8], C = t[15] << 24 | t[14] << 16 | t[13] << 8 | t[12], K = r, N = n, U = s, D = a, v = c, T = d, Y = f, Q = g, p = _, S = x, o = A, h = O, l = j, E = F, I = V, w = C, u = 0; u < jm; u += 2)
    K = K + v | 0, l ^= K, l = l >>> 32 - 16 | l << 16, p = p + l | 0, v ^= p, v = v >>> 32 - 12 | v << 12, N = N + T | 0, E ^= N, E = E >>> 32 - 16 | E << 16, S = S + E | 0, T ^= S, T = T >>> 32 - 12 | T << 12, U = U + Y | 0, I ^= U, I = I >>> 32 - 16 | I << 16, o = o + I | 0, Y ^= o, Y = Y >>> 32 - 12 | Y << 12, D = D + Q | 0, w ^= D, w = w >>> 32 - 16 | w << 16, h = h + w | 0, Q ^= h, Q = Q >>> 32 - 12 | Q << 12, U = U + Y | 0, I ^= U, I = I >>> 32 - 8 | I << 8, o = o + I | 0, Y ^= o, Y = Y >>> 32 - 7 | Y << 7, D = D + Q | 0, w ^= D, w = w >>> 32 - 8 | w << 8, h = h + w | 0, Q ^= h, Q = Q >>> 32 - 7 | Q << 7, N = N + T | 0, E ^= N, E = E >>> 32 - 8 | E << 8, S = S + E | 0, T ^= S, T = T >>> 32 - 7 | T << 7, K = K + v | 0, l ^= K, l = l >>> 32 - 8 | l << 8, p = p + l | 0, v ^= p, v = v >>> 32 - 7 | v << 7, K = K + T | 0, w ^= K, w = w >>> 32 - 16 | w << 16, o = o + w | 0, T ^= o, T = T >>> 32 - 12 | T << 12, N = N + Y | 0, l ^= N, l = l >>> 32 - 16 | l << 16, h = h + l | 0, Y ^= h, Y = Y >>> 32 - 12 | Y << 12, U = U + Q | 0, E ^= U, E = E >>> 32 - 16 | E << 16, p = p + E | 0, Q ^= p, Q = Q >>> 32 - 12 | Q << 12, D = D + v | 0, I ^= D, I = I >>> 32 - 16 | I << 16, S = S + I | 0, v ^= S, v = v >>> 32 - 12 | v << 12, U = U + Q | 0, E ^= U, E = E >>> 32 - 8 | E << 8, p = p + E | 0, Q ^= p, Q = Q >>> 32 - 7 | Q << 7, D = D + v | 0, I ^= D, I = I >>> 32 - 8 | I << 8, S = S + I | 0, v ^= S, v = v >>> 32 - 7 | v << 7, N = N + Y | 0, l ^= N, l = l >>> 32 - 8 | l << 8, h = h + l | 0, Y ^= h, Y = Y >>> 32 - 7 | Y << 7, K = K + T | 0, w ^= K, w = w >>> 32 - 8 | w << 8, o = o + w | 0, T ^= o, T = T >>> 32 - 7 | T << 7;
  qt.writeUint32LE(K + r | 0, e, 0), qt.writeUint32LE(N + n | 0, e, 4), qt.writeUint32LE(U + s | 0, e, 8), qt.writeUint32LE(D + a | 0, e, 12), qt.writeUint32LE(v + c | 0, e, 16), qt.writeUint32LE(T + d | 0, e, 20), qt.writeUint32LE(Y + f | 0, e, 24), qt.writeUint32LE(Q + g | 0, e, 28), qt.writeUint32LE(p + _ | 0, e, 32), qt.writeUint32LE(S + x | 0, e, 36), qt.writeUint32LE(o + A | 0, e, 40), qt.writeUint32LE(h + O | 0, e, 44), qt.writeUint32LE(l + j | 0, e, 48), qt.writeUint32LE(E + F | 0, e, 52), qt.writeUint32LE(I + V | 0, e, 56), qt.writeUint32LE(w + C | 0, e, 60);
}
function ju(e, t, i, r, n) {
  ...
  for (var c = new Uint8Array(64), d = 0; d < i.length; d += 64) {
    zm(c, s, e);
    for (var f = d; f < d + 64 && f < i.length; f++)
      r[f] = i[f] ^ c[f - d];
    Dm(s, 0, a);
  }
  return ya.wipe(c), n === 0 && ya.wipe(s), r;
}
go.streamXOR = ju;
function Um(e, t, i, r) {
  return r === void 0 && (r = 0), ya.wipe(i), ju(e, t, i, i, r);
}
go.stream = Um;
function Dm(e, t, i) {
  for (var r = 1; i--; )
...
(function(e) {
  ...
  var r = (
    ...
    function() {
      function a(c) {
        ...
        var j = c[14] | c[15] << 8;
        this._r[8] = (O >>> 8 | j << 8) & 8191, this._r[9] = j >>> 5 & 127, this._pad[0] = c[16] | c[17] << 8, this._pad[1] = c[18] | c[19] << 8, this._pad[2] = c[20] | c[21] << 8, this._pad[3] = c[22] | c[23] << 8, this._pad[4] = c[24] | c[25] << 8, this._pad[5] = c[26] | c[27] << 8, this._pad[6] = c[28] | c[29] << 8, this._pad[7] = c[30] | c[31] << 8;
      }
      return a.prototype._blocks = function(c, d, f) {
        for (var g = this._fin ? 0 : 2048, _ = this._h[0], x = this._h[1], A = this._h[2], O = this._h[3], j = this._h[4], F = this._h[5], V = this._h[6], C = this._h[7], K = this._h[8], N = this._h[9], U = this._r[0], D = this._r[1], v = this._r[2], T = this._r[3], Y = this._r[4], Q = this._r[5], p = this._r[6], S = this._r[7], o = this._r[8], h = this._r[9]; f >= 16; ) {
          var l = c[d + 0] | c[d + 1] << 8;
          _ += l & 8191;
          var E = c[d + 2] | c[d + 3] << 8;
          x += (l >>> 13 | E << 3) & 8191;
          ...
          var m = c[d + 10] | c[d + 11] << 8;
          V += (u >>> 14 | m << 2) & 8191;
          var b = c[d + 12] | c[d + 13] << 8;
          C += (m >>> 11 | b << 5) & 8191;
          var P = c[d + 14] | c[d + 15] << 8;
          K += (b >>> 8 | P << 8) & 8191, N += P >>> 5 | g;
          var B = 0, G = B;
          G += _ * U, G += x * (5 * h), G += A * (5 * o), G += O * (5 * S), G += j * (5 * p), B = G >>> 13, G &= 8191, G += F * (5 * Q), G += V * (5 * Y), G += C * (5 * T), G += K * (5 * v), G += N * (5 * D), B += G >>> 13, G &= 8191;
          var M = B;
          M += _ * D, M += x * U, M += A * (5 * h), M += O * (5 * o), M += j * (5 * S), B = M >>> 13, M &= 8191, M += F * (5 * p), M += V * (5 * Q), M += C * (5 * Y), M += K * (5 * T), M += N * (5 * v), B += M >>> 13, M &= 8191;
          var $ = B;
          $ += _ * v, $ += x * D, $ += A * U, $ += O * (5 * h), $ += j * (5 * o), B = $ >>> 13, $ &= 8191, $ += F * (5 * S), $ += V * (5 * p), $ += C * (5 * Q), $ += K * (5 * Y), $ += N * (5 * T), B += $ >>> 13, $ &= 8191;
          var L = B;
          L += _ * T, L += x * v, L += A * D, L += O * U, L += j * (5 * h), B = L >>> 13, L &= 8191, L += F * (5 * o), L += V * (5 * S), L += C * (5 * p), L += K * (5 * Q), L += N * (5 * Y), B += L >>> 13, L &= 8191;
          var k = B;
          k += _ * Y, k += x * T, k += A * v, k += O * D, k += j * U, B = k >>> 13, k &= 8191, k += F * (5 * h), k += V * (5 * o), k += C * (5 * S), k += K * (5 * p), k += N * (5 * Q), B += k >>> 13, k &= 8191;
          var q = B;
          q += _ * Q, q += x * Y, q += A * T, q += O * v, q += j * D, B = q >>> 13, q &= 8191, q += F * U, q += V * (5 * h), q += C * (5 * o), q += K * (5 * S), q += N * (5 * p), B += q >>> 13, q &= 8191;
          var y = B;
          y += _ * p, y += x * Q, y += A * Y, y += O * T, y += j * v, B = y >>> 13, y &= 8191, y += F * D, y += V * U, y += C * (5 * h), y += K * (5 * o), y += N * (5 * S), B += y >>> 13, y &= 8191;
          var R = B;
          R += _ * S, R += x * p, R += A * Q, R += O * Y, R += j * T, B = R >>> 13, R &= 8191, R += F * v, R += V * D, R += C * U, R += K * (5 * h), R += N * (5 * o), B += R >>> 13, R &= 8191;
          var W = B;
          W += _ * o, W += x * S, W += A * p, W += O * Q, W += j * Y, B = W >>> 13, W &= 8191, W += F * T, W += V * v, W += C * D, W += K * U, W += N * (5 * h), B += W >>> 13, W &= 8191;
          var Z = B;
          Z += _ * h, Z += x * o, Z += A * S, Z += O * p, Z += j * Q, B = Z >>> 13, Z &= 8191, Z += F * Y, Z += V * T, Z += C * v, Z += K * D, Z += N * U, B += Z >>> 13, Z &= 8191, B = (B << 2) + B | 0, B = B + G | 0, G = B & 8191, B = B >>> 13, M += B, _ = G, x = M, A = $, O = L, j = k, F = q, V = y, C = R, K = W, N = Z, d += 16, f -= 16;
        }
        this._h[0] = _, this._h[1] = x, this._h[2] = A, this._h[3] = O, this._h[4] = j, this._h[5] = F, this._h[6] = V, this._h[7] = C, this._h[8] = K, this._h[9] = N;
      }, a.prototype.finish = function(c, d) {
        d === void 0 && (d = 0);
        ...
        var d = 0, f = c.length, g;
        if (this._leftover) {
          g = 16 - this._leftover, g > f && (g = f);
          for (var _ = 0; _ < g; _++)
            this._buffer[this._leftover + _] = c[d + _];
          if (f -= g, d += g, this._leftover += g, this._leftover < 16)
            return this;
          this._blocks(this._buffer, 0, 16), this._leftover = 0;
        }
        if (f >= 16 && (g = f - f % 16, this._blocks(c, d, g), d += g, f -= g), f) {
          for (var _ = 0; _ < f; _++)
            this._buffer[this._leftover + _] = c[d + _];
          this._leftover += f;
        }
  ...
  e.oneTimeAuth = n;
  function s(a, c) {
    return a.length !== e.DIGEST_LENGTH || c.length !== e.DIGEST_LENGTH ? !1 : t.equal(a, c);
  }
  e.equal = s;
})(zu);
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  var t = go, i = zu, r = ni, n = Ve, s = Ir;
  e.KEY_LENGTH = 32, e.NONCE_LENGTH = 12, e.TAG_LENGTH = 16;
  var a = new Uint8Array(16), c = (
    /** @class */
    function() {
      function d(f) {
...
var fh = ns, uh = ni, Gm = (
  ...
  function() {
    function e(t, i, r, n) {
      ...
      var s = fh.hmac(this._hash, r, i);
      this._hmac = new fh.HMAC(t, s), this._buffer = new Uint8Array(this._hmac.digestLength), this._bufpos = this._buffer.length;
    }
    return e.prototype._fillBuffer = function() {
      ...
      this._hmac.clean(), uh.wipe(this._buffer), uh.wipe(this._counter), this._bufpos = 0;
    }, e;
  }()
), Ym = Du.HKDF = Gm, ss = {};
(function(e) {
  ...
  function s(c, d, f, g, _) {
    for (; _ >= 64; ) {
      for (var x = d[0], A = d[1], O = d[2], j = d[3], F = d[4], V = d[5], C = d[6], K = d[7], N = 0; N < 16; N++) {
        var U = g + N * 4;
        c[N] = t.readUint32BE(f, U);
      }
      for (var N = 16; N < 64; N++) {
        var D = c[N - 2], v = (D >>> 17 | D << 32 - 17) ^ (D >>> 19 | D << 32 - 19) ^ D >>> 10;
        D = c[N - 15];
        var T = (D >>> 7 | D << 32 - 7) ^ (D >>> 18 | D << 32 - 18) ^ D >>> 3;
        c[N] = (v + c[N - 7] | 0) + (T + c[N - 16] | 0);
      }
      for (var N = 0; N < 64; N++) {
        var v = (((F >>> 6 | F << 26) ^ (F >>> 11 | F << 21) ^ (F >>> 25 | F << 7)) + (F & V ^ ~F & C) | 0) + (K + (n[N] + c[N] | 0) | 0) | 0, T = ((x >>> 2 | x << 32 - 2) ^ (x >>> 13 | x << 32 - 13) ^ (x >>> 22 | x << 32 - 22)) + (x & A ^ x & O ^ A & O) | 0;
...
(function(e) {
  ...
  function x(N, U, D) {
    let v, T, Y = 0, Q = 0, p = 0, S = 0, o = 0, h = 0, l = 0, E = 0, I = 0, w = 0, u = 0, m = 0, b = 0, P = 0, B = 0, G = 0, M = 0, $ = 0, L = 0, k = 0, q = 0, y = 0, R = 0, W = 0, Z = 0, J = 0, oe = 0, Ee = 0, ce = 0, Re = 0, Pe = 0, se = D[0], Se = D[1], ve = D[2], ie = D[3], ge = D[4], pe = D[5], ee = D[6], fe = D[7], me = D[8], re = D[9], ue = D[10], Ie = D[11], ae = D[12], Me = D[13], Ae = D[14], he = D[15];
    v = U[0], Y += v * se, Q += v * Se, p += v * ve, S += v * ie, o += v * ge, h += v * pe, l += v * ee, E += v * fe, I += v * me, w += v * re, u += v * ue, m += v * Ie, b += v * ae, P += v * Me, B += v * Ae, G += v * he, v = U[1], Q += v * se, p += v * Se, S += v * ve, o += v * ie, h += v * ge, l += v * pe, E += v * ee, I += v * fe, w += v * me, u += v * re, m += v * ue, b += v * Ie, P += v * ae, B += v * Me, G += v * Ae, M += v * he, v = U[2], p += v * se, S += v * Se, o += v * ve, h += v * ie, l += v * ge, E += v * pe, I += v * ee, w += v * fe, u += v * me, m += v * re, b += v * ue, P += v * Ie, B += v * ae, G += v * Me, M += v * Ae, $ += v * he, v = U[3], S += v * se, o += v * Se, h += v * ve, l += v * ie, E += v * ge, I += v * pe, w += v * ee, u += v * fe, m += v * me, b += v * re, P += v * ue, B += v * Ie, G += v * ae, M += v * Me, $ += v * Ae, L += v * he, v = U[4], o += v * se, h += v * Se, l += v * ve, E += v * ie, I += v * ge, w += v * pe, u += v * ee, m += v * fe, b += v * me, P += v * re, B += v * ue, G += v * Ie, M += v * ae, $ += v * Me, L += v * Ae, k += v * he, v = U[5], h += v * se, l += v * Se, E += v * ve, I += v * ie, w += v * ge, u += v * pe, m += v * ee, b += v * fe, P += v * me, B += v * re, G += v * ue, M += v * Ie, $ += v * ae, L += v * Me, k += v * Ae, q += v * he, v = U[6], l += v * se, E += v * Se, I += v * ve, w += v * ie, u += v * ge, m += v * pe, b += v * ee, P += v * fe, B += v * me, G += v * re, M += v * ue, $ += v * Ie, L += v * ae, k += v * Me, q += v * Ae, y += v * he, v = U[7], E += v * se, I += v * Se, w += v * ve, u += v * ie, m += v * ge, b += v * pe, P += v * ee, B += v * fe, G += v * me, M += v * re, $ += v * ue, L += v * Ie, k += v * ae, q += v * Me, y += v * Ae, R += v * he, v = U[8], I += v * se, w += v * Se, u += v * ve, m += v * ie, b += v * ge, P += v * pe, B += v * ee, G += v * fe, M += v * me, $ += v * re, L += v * ue, k += v * Ie, q += v * ae, y += v * Me, R += v * Ae, W += v * he, v = U[9], w += v * se, u += v * Se, m += v * ve, b += v * ie, P += v * ge, B += v * pe, G += v * ee, M += v * fe, $ += v * me, L += v * re, k += v * ue, q += v * Ie, y += v * ae, R += v * Me, W += v * Ae, Z += v * he, v = U[10], u += v * se, m += v * Se, b += v * ve, P += v * ie, B += v * ge, G += v * pe, M += v * ee, $ += v * fe, L += v * me, k += v * re, q += v * ue, y += v * Ie, R += v * ae, W += v * Me, Z += v * Ae, J += v * he, v = U[11], m += v * se, b += v * Se, P += v * ve, B += v * ie, G += v * ge, M += v * pe, $ += v * ee, L += v * fe, k += v * me, q += v * re, y += v * ue, R += v * Ie, W += v * ae, Z += v * Me, J += v * Ae, oe += v * he, v = U[12], b += v * se, P += v * Se, B += v * ve, G += v * ie, M += v * ge, $ += v * pe, L += v * ee, k += v * fe, q += v * me, y += v * re, R += v * ue, W += v * Ie, Z += v * ae, J += v * Me, oe += v * Ae, Ee += v * he, v = U[13], P += v * se, B += v * Se, G += v * ve, M += v * ie, $ += v * ge, L += v * pe, k += v * ee, q += v * fe, y += v * me, R += v * re, W += v * ue, Z += v * Ie, J += v * ae, oe += v * Me, Ee += v * Ae, ce += v * he, v = U[14], B += v * se, G += v * Se, M += v * ve, $ += v * ie, L += v * ge, k += v * pe, q += v * ee, y += v * fe, R += v * me, W += v * re, Z += v * ue, J += v * Ie, oe += v * ae, Ee += v * Me, ce += v * Ae, Re += v * he, v = U[15], G += v * se, M += v * Se, $ += v * ve, L += v * ie, k += v * ge, q += v * pe, y += v * ee, R += v * fe, W += v * me, Z += v * re, J += v * ue, oe += v * Ie, Ee += v * ae, ce += v * Me, Re += v * Ae, Pe += v * he, Y += 38 * M, Q += 38 * $, p += 38 * L, S += 38 * k, o += 38 * q, h += 38 * y, l += 38 * R, E += 38 * W, I += 38 * Z, w += 38 * J, u += 38 * oe, m += 38 * Ee, b += 38 * ce, P += 38 * Re, B += 38 * Pe, T = 1, v = Y + T + 65535, T = Math.floor(v / 65536), Y = v - T * 65536, v = Q + T + 65535, T = Math.floor(v / 65536), Q = v - T * 65536, v = p + T + 65535, T = Math.floor(v / 65536), p = v - T * 65536, v = S + T + 65535, T = Math.floor(v / 65536), S = v - T * 65536, v = o + T + 65535, T = Math.floor(v / 65536), o = v - T * 65536, v = h + T + 65535, T = Math.floor(v / 65536), h = v - T * 65536, v = l + T + 65535, T = Math.floor(v / 65536), l = v - T * 65536, v = E + T + 65535, T = Math.floor(v / 65536), E = v - T * 65536, v = I + T + 65535, T = Math.floor(v / 65536), I = v - T * 65536, v = w + T + 65535, T = Math.floor(v / 65536), w = v - T * 65536, v = u + T + 65535, T = Math.floor(v / 65536), u = v - T * 65536, v = m + T + 65535, T = Math.floor(v / 65536), m = v - T * 65536, v = b + T + 65535, T = Math.floor(v / 65536), b = v - T * 65536, v = P + T + 65535, T = Math.floor(v / 65536), P = v - T * 65536, v = B + T + 65535, T = Math.floor(v / 65536), B = v - T * 65536, v = G + T + 65535, T = Math.floor(v / 65536), G = v - T * 65536, Y += T - 1 + 37 * (T - 1), T = 1, v = Y + T + 65535, T = Math.floor(v / 65536), Y = v - T * 65536, v = Q + T + 65535, T = Math.floor(v / 65536), Q = v - T * 65536, v = p + T + 65535, T = Math.floor(v / 65536), p = v - T * 65536, v = S + T + 65535, T = Math.floor(v / 65536), S = v - T * 65536, v = o + T + 65535, T = Math.floor(v / 65536), o = v - T * 65536, v = h + T + 65535, T = Math.floor(v / 65536), h = v - T * 65536, v = l + T + 65535, T = Math.floor(v / 65536), l = v - T * 65536, v = E + T + 65535, T = Math.floor(v / 65536), E = v - T * 65536, v = I + T + 65535, T = Math.floor(v / 65536), I = v - T * 65536, v = w + T + 65535, T = Math.floor(v / 65536), w = v - T * 65536, v = u + T + 65535, T = Math.floor(v / 65536), u = v - T * 65536, v = m + T + 65535, T = Math.floor(v / 65536), m = v - T * 65536, v = b + T + 65535, T = Math.floor(v / 65536), b = v - T * 65536, v = P + T + 65535, T = Math.floor(v / 65536), P = v - T * 65536, v = B + T + 65535, T = Math.floor(v / 65536), B = v - T * 65536, v = G + T + 65535, T = Math.floor(v / 65536), G = v - T * 65536, Y += T - 1 + 37 * (T - 1), N[0] = Y, N[1] = Q, N[2] = p, N[3] = S, N[4] = o, N[5] = h, N[6] = l, N[7] = E, N[8] = I, N[9] = w, N[10] = u, N[11] = m, N[12] = b, N[13] = P, N[14] = B, N[15] = G;
  }
  function A(N, U) {
    x(N, U, U);
  }
  ...
  function j(N, U) {
    ...
    for (let I = 254; I >= 0; --I) {
      const w = D[I >>> 3] >>> (I & 7) & 1;
      c(T, Y, w), c(Q, p, w), g(S, T, Q), _(T, T, Q), g(Q, Y, p), _(Y, Y, p), A(p, S), A(o, T), x(T, Q, T), x(Q, Y, S), g(S, T, Q), _(T, T, Q), A(Y, T), _(Q, p, o), x(T, Q, s), g(T, T, p), x(Q, Q, T), x(T, p, o), x(p, Y, v), A(Y, S), c(T, Y, w), c(Q, p, w);
    }
    for (let I = 0; I < 16; I++)
      v[I + 16] = T[I], v[I + 32] = Q[I], v[I + 48] = Y[I], v[I + 64] = p[I];
    const h = v.subarray(32), l = v.subarray(16);
    O(h, h), x(l, l, h);
...
var Ku = {};
const Jm = "elliptic", Zm = "6.6.1", Xm = "EC cryptography", Qm = "lib/elliptic.js", e2 = [
  "lib"
], t2 = {
  ...
  "curve",
  "Cryptography"
], n2 = "Fedor Indutny <fedor@indutny.com>", s2 = "MIT", o2 = {
  url: "https://github.com/indutny/elliptic/issues"
}, a2 = "https://github.com/indutny/elliptic", c2 = {
  brfs: "^2.0.2",
  coveralls: "^3.1.0",
  eslint: "^7.6.0",
  grunt: "^1.2.1",
...
(function(e) {
  (function(t, i) {
    ...
    s.isBN = function(p) {
      ...
      var h = 0;
      p[0] === "-" && (h++, this.negative = 1), h < p.length && (S === 16 ? this._parseHex(p, h, o) : (this._parseBase(p, S, h), o === "le" && this._initArray(this.toArray(), S, o)));
      ...
      var l, E, I = 0;
      if (o === "be")
        for (h = p.length - 1, l = 0; h >= 0; h -= 3)
          E = p[h] | p[h - 1] << 8 | p[h - 2] << 16, this.words[l] |= E << I & 67108863, this.words[l + 1] = E >>> 26 - I & 67108863, I += 24, I >= 26 && (I -= 26, l++);
      else if (o === "le")
        for (h = 0, l = 0; h < p.length; h += 3)
          E = p[h] | p[h + 1] << 8 | p[h + 2] << 16, this.words[l] |= E << I & 67108863, this.words[l + 1] = E >>> 26 - I & 67108863, I += 24, I >= 26 && (I -= 26, l++);
      return this.strip();
    };
    function c(p, S) {
    ...
    s.prototype._parseHex = function(p, S, o) {
      ...
      var l = 0, E = 0, I;
      if (o === "be")
        for (h = p.length - 1; h >= S; h -= 2)
          I = d(p, S, h) << l, this.words[E] |= I & 67108863, l >= 18 ? (l -= 18, E += 1, this.words[E] |= I >>> 26) : l += 8;
      else {
        var w = p.length - S;
        for (h = w % 2 === 0 ? S + 1 : S; h < p.length; h += 2)
          I = d(p, S, h) << l, this.words[E] |= I & 67108863, l >= 18 ? (l -= 18, E += 1, this.words[E] |= I >>> 26) : l += 8;
      }
      this.strip();
    };
    function f(p, S, o, h) {
      for (var l = 0, E = Math.min(p.length, o), I = S; I < E; I++) {
        ...
        l *= h, w >= 49 ? l += w - 49 + 10 : w >= 17 ? l += w - 17 + 10 : l += w;
      }
      return l;
    }
    s.prototype._parseBase = function(p, S, o) {
      this.words = [0], this.length = 1;
      for (var h = 0, l = 1; l <= 67108863; l *= S)
        h++;
      h--, l = l / S | 0;
      for (var E = p.length - o, I = E % h, w = Math.min(E, E - I) + o, u = 0, m = o; m < w; m += h)
        u = f(p, m, m + h, S), this.imuln(l), this.words[0] + u < 67108864 ? this.words[0] += u : this._iaddn(u);
      if (I !== 0) {
        var b = 1;
    ...
    s.prototype.toString = function(p, S) {
      ...
      if (p === 16 || p === "hex") {
        o = "";
        for (var h = 0, l = 0, E = 0; E < this.length; E++) {
          var I = this.words[E], w = ((I << h | l) & 16777215).toString(16);
          l = I >>> 24 - h & 16777215, h += 2, h >= 26 && (h -= 26, E--), l !== 0 || E !== this.length - 1 ? o = g[6 - w.length] + w + o : o = w + o;
        }
      ...
      var h = this.byteLength(), l = o || Math.max(1, h);
      r(h <= l, "byte array longer than desired length"), r(l > 0, "Requested array length <= 0"), this.strip();
    ...
    s.prototype.zeroBits = function() {
      ...
      for (var h = 0; h < o.length; h++)
        this.words[h] = S.words[h] ^ o.words[h];
      if (this !== S)
        for (; h < S.length; h++)
      ...
      return o > 0 && (this.words[h] = ~this.words[h] & 67108863 >> 26 - o), this.strip();
    }, s.prototype.notn = function(p) {
      return this.clone().inotn(p);
    }, s.prototype.setn = function(p, S) {
      r(typeof p == "number" && p >= 0);
      var o = p / 26 | 0, h = p % 26;
      return this._expand(o + 1), S ? this.words[o] = this.words[o] | 1 << h : this.words[o] = this.words[o] & ~(1 << h), this.strip();
      ...
      var o, h;
      this.length > p.length ? (o = this, h = p) : (o = p, h = this);
      for (var l = 0, E = 0; E < h.length; E++)
        S = (o.words[E] | 0) + (h.words[E] | 0) + l, this.words[E] = S & 67108863, l = S >>> 26;
      ...
      if (o === 0)
        return this.negative = 0, this.length = 1, this.words[0] = 0, this;
      var h, l;
      o > 0 ? (h = this, l = p) : (h = p, l = this);
      for (var E = 0, I = 0; I < l.length; I++)
        S = (h.words[I] | 0) - (l.words[I] | 0) + E, E = S >> 26, this.words[I] = S & 67108863;
      for (; E !== 0 && I < h.length; I++)
        S = (h.words[I] | 0) + E, E = S >> 26, this.words[I] = S & 67108863;
      if (E === 0 && I < h.length && h !== this)
        for (; I < h.length; I++)
          this.words[I] = h.words[I];
      return this.length = Math.max(this.length, I), h !== this && (this.negative = 1), this.strip();
    }, s.prototype.sub = function(p) {
      return this.clone().isub(p);
    };
    function O(p, S, o) {
      o.negative = S.negative ^ p.negative;
      var h = p.length + S.length | 0;
      o.length = h, h = h - 1 | 0;
    ...
    var j = function(p, S, o) {
      var h = p.words, l = S.words, E = o.words, I = 0, w, u, m, b = h[0] | 0, P = b & 8191, B = b >>> 13, G = h[1] | 0, M = G & 8191, $ = G >>> 13, L = h[2] | 0, k = L & 8191, q = L >>> 13, y = h[3] | 0, R = y & 8191, W = y >>> 13, Z = h[4] | 0, J = Z & 8191, oe = Z >>> 13, Ee = h[5] | 0, ce = Ee & 8191, Re = Ee >>> 13, Pe = h[6] | 0, se = Pe & 8191, Se = Pe >>> 13, ve = h[7] | 0, ie = ve & 8191, ge = ve >>> 13, pe = h[8] | 0, ee = pe & 8191, fe = pe >>> 13, me = h[9] | 0, re = me & 8191, ue = me >>> 13, Ie = l[0] | 0, ae = Ie & 8191, Me = Ie >>> 13, Ae = l[1] | 0, he = Ae & 8191, We = Ae >>> 13, Ye = l[2] | 0, xe = Ye & 8191, $e = Ye >>> 13, Xe = l[3] | 0, Oe = Xe & 8191, et = Xe >>> 13, Te = l[4] | 0, le = Te & 8191, ke = Te >>> 13, Le = l[5] | 0, be = Le & 8191, Ne = Le >>> 13, ze = l[6] | 0, we = ze & 8191, Ue = ze >>> 13, De = l[7] | 0, _e = De & 8191, qe = De >>> 13, Ce = l[8] | 0, de = Ce & 8191, Fe = Ce >>> 13, Ke = l[9] | 0, je = Ke & 8191, it = Ke >>> 13;
      ...
      I = (m + (u >>> 13) | 0) + (tt >>> 26) | 0, tt &= 67108863, w = Math.imul(M, ae), u = Math.imul(M, Me), u = u + Math.imul($, ae) | 0, m = Math.imul($, Me), w = w + Math.imul(P, he) | 0, u = u + Math.imul(P, We) | 0, u = u + Math.imul(B, he) | 0, m = m + Math.imul(B, We) | 0;
      var Je = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Je >>> 26) | 0, Je &= 67108863, w = Math.imul(k, ae), u = Math.imul(k, Me), u = u + Math.imul(q, ae) | 0, m = Math.imul(q, Me), w = w + Math.imul(M, he) | 0, u = u + Math.imul(M, We) | 0, u = u + Math.imul($, he) | 0, m = m + Math.imul($, We) | 0, w = w + Math.imul(P, xe) | 0, u = u + Math.imul(P, $e) | 0, u = u + Math.imul(B, xe) | 0, m = m + Math.imul(B, $e) | 0;
      var Kt = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Kt >>> 26) | 0, Kt &= 67108863, w = Math.imul(R, ae), u = Math.imul(R, Me), u = u + Math.imul(W, ae) | 0, m = Math.imul(W, Me), w = w + Math.imul(k, he) | 0, u = u + Math.imul(k, We) | 0, u = u + Math.imul(q, he) | 0, m = m + Math.imul(q, We) | 0, w = w + Math.imul(M, xe) | 0, u = u + Math.imul(M, $e) | 0, u = u + Math.imul($, xe) | 0, m = m + Math.imul($, $e) | 0, w = w + Math.imul(P, Oe) | 0, u = u + Math.imul(P, et) | 0, u = u + Math.imul(B, Oe) | 0, m = m + Math.imul(B, et) | 0;
      var Bt = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Bt >>> 26) | 0, Bt &= 67108863, w = Math.imul(J, ae), u = Math.imul(J, Me), u = u + Math.imul(oe, ae) | 0, m = Math.imul(oe, Me), w = w + Math.imul(R, he) | 0, u = u + Math.imul(R, We) | 0, u = u + Math.imul(W, he) | 0, m = m + Math.imul(W, We) | 0, w = w + Math.imul(k, xe) | 0, u = u + Math.imul(k, $e) | 0, u = u + Math.imul(q, xe) | 0, m = m + Math.imul(q, $e) | 0, w = w + Math.imul(M, Oe) | 0, u = u + Math.imul(M, et) | 0, u = u + Math.imul($, Oe) | 0, m = m + Math.imul($, et) | 0, w = w + Math.imul(P, le) | 0, u = u + Math.imul(P, ke) | 0, u = u + Math.imul(B, le) | 0, m = m + Math.imul(B, ke) | 0;
      var $t = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + ($t >>> 26) | 0, $t &= 67108863, w = Math.imul(ce, ae), u = Math.imul(ce, Me), u = u + Math.imul(Re, ae) | 0, m = Math.imul(Re, Me), w = w + Math.imul(J, he) | 0, u = u + Math.imul(J, We) | 0, u = u + Math.imul(oe, he) | 0, m = m + Math.imul(oe, We) | 0, w = w + Math.imul(R, xe) | 0, u = u + Math.imul(R, $e) | 0, u = u + Math.imul(W, xe) | 0, m = m + Math.imul(W, $e) | 0, w = w + Math.imul(k, Oe) | 0, u = u + Math.imul(k, et) | 0, u = u + Math.imul(q, Oe) | 0, m = m + Math.imul(q, et) | 0, w = w + Math.imul(M, le) | 0, u = u + Math.imul(M, ke) | 0, u = u + Math.imul($, le) | 0, m = m + Math.imul($, ke) | 0, w = w + Math.imul(P, be) | 0, u = u + Math.imul(P, Ne) | 0, u = u + Math.imul(B, be) | 0, m = m + Math.imul(B, Ne) | 0;
      var Vt = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Vt >>> 26) | 0, Vt &= 67108863, w = Math.imul(se, ae), u = Math.imul(se, Me), u = u + Math.imul(Se, ae) | 0, m = Math.imul(Se, Me), w = w + Math.imul(ce, he) | 0, u = u + Math.imul(ce, We) | 0, u = u + Math.imul(Re, he) | 0, m = m + Math.imul(Re, We) | 0, w = w + Math.imul(J, xe) | 0, u = u + Math.imul(J, $e) | 0, u = u + Math.imul(oe, xe) | 0, m = m + Math.imul(oe, $e) | 0, w = w + Math.imul(R, Oe) | 0, u = u + Math.imul(R, et) | 0, u = u + Math.imul(W, Oe) | 0, m = m + Math.imul(W, et) | 0, w = w + Math.imul(k, le) | 0, u = u + Math.imul(k, ke) | 0, u = u + Math.imul(q, le) | 0, m = m + Math.imul(q, ke) | 0, w = w + Math.imul(M, be) | 0, u = u + Math.imul(M, Ne) | 0, u = u + Math.imul($, be) | 0, m = m + Math.imul($, Ne) | 0, w = w + Math.imul(P, we) | 0, u = u + Math.imul(P, Ue) | 0, u = u + Math.imul(B, we) | 0, m = m + Math.imul(B, Ue) | 0;
      var Ht = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Ht >>> 26) | 0, Ht &= 67108863, w = Math.imul(ie, ae), u = Math.imul(ie, Me), u = u + Math.imul(ge, ae) | 0, m = Math.imul(ge, Me), w = w + Math.imul(se, he) | 0, u = u + Math.imul(se, We) | 0, u = u + Math.imul(Se, he) | 0, m = m + Math.imul(Se, We) | 0, w = w + Math.imul(ce, xe) | 0, u = u + Math.imul(ce, $e) | 0, u = u + Math.imul(Re, xe) | 0, m = m + Math.imul(Re, $e) | 0, w = w + Math.imul(J, Oe) | 0, u = u + Math.imul(J, et) | 0, u = u + Math.imul(oe, Oe) | 0, m = m + Math.imul(oe, et) | 0, w = w + Math.imul(R, le) | 0, u = u + Math.imul(R, ke) | 0, u = u + Math.imul(W, le) | 0, m = m + Math.imul(W, ke) | 0, w = w + Math.imul(k, be) | 0, u = u + Math.imul(k, Ne) | 0, u = u + Math.imul(q, be) | 0, m = m + Math.imul(q, Ne) | 0, w = w + Math.imul(M, we) | 0, u = u + Math.imul(M, Ue) | 0, u = u + Math.imul($, we) | 0, m = m + Math.imul($, Ue) | 0, w = w + Math.imul(P, _e) | 0, u = u + Math.imul(P, qe) | 0, u = u + Math.imul(B, _e) | 0, m = m + Math.imul(B, qe) | 0;
      var bt = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (bt >>> 26) | 0, bt &= 67108863, w = Math.imul(ee, ae), u = Math.imul(ee, Me), u = u + Math.imul(fe, ae) | 0, m = Math.imul(fe, Me), w = w + Math.imul(ie, he) | 0, u = u + Math.imul(ie, We) | 0, u = u + Math.imul(ge, he) | 0, m = m + Math.imul(ge, We) | 0, w = w + Math.imul(se, xe) | 0, u = u + Math.imul(se, $e) | 0, u = u + Math.imul(Se, xe) | 0, m = m + Math.imul(Se, $e) | 0, w = w + Math.imul(ce, Oe) | 0, u = u + Math.imul(ce, et) | 0, u = u + Math.imul(Re, Oe) | 0, m = m + Math.imul(Re, et) | 0, w = w + Math.imul(J, le) | 0, u = u + Math.imul(J, ke) | 0, u = u + Math.imul(oe, le) | 0, m = m + Math.imul(oe, ke) | 0, w = w + Math.imul(R, be) | 0, u = u + Math.imul(R, Ne) | 0, u = u + Math.imul(W, be) | 0, m = m + Math.imul(W, Ne) | 0, w = w + Math.imul(k, we) | 0, u = u + Math.imul(k, Ue) | 0, u = u + Math.imul(q, we) | 0, m = m + Math.imul(q, Ue) | 0, w = w + Math.imul(M, _e) | 0, u = u + Math.imul(M, qe) | 0, u = u + Math.imul($, _e) | 0, m = m + Math.imul($, qe) | 0, w = w + Math.imul(P, de) | 0, u = u + Math.imul(P, Fe) | 0, u = u + Math.imul(B, de) | 0, m = m + Math.imul(B, Fe) | 0;
      var Hi = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Hi >>> 26) | 0, Hi &= 67108863, w = Math.imul(re, ae), u = Math.imul(re, Me), u = u + Math.imul(ue, ae) | 0, m = Math.imul(ue, Me), w = w + Math.imul(ee, he) | 0, u = u + Math.imul(ee, We) | 0, u = u + Math.imul(fe, he) | 0, m = m + Math.imul(fe, We) | 0, w = w + Math.imul(ie, xe) | 0, u = u + Math.imul(ie, $e) | 0, u = u + Math.imul(ge, xe) | 0, m = m + Math.imul(ge, $e) | 0, w = w + Math.imul(se, Oe) | 0, u = u + Math.imul(se, et) | 0, u = u + Math.imul(Se, Oe) | 0, m = m + Math.imul(Se, et) | 0, w = w + Math.imul(ce, le) | 0, u = u + Math.imul(ce, ke) | 0, u = u + Math.imul(Re, le) | 0, m = m + Math.imul(Re, ke) | 0, w = w + Math.imul(J, be) | 0, u = u + Math.imul(J, Ne) | 0, u = u + Math.imul(oe, be) | 0, m = m + Math.imul(oe, Ne) | 0, w = w + Math.imul(R, we) | 0, u = u + Math.imul(R, Ue) | 0, u = u + Math.imul(W, we) | 0, m = m + Math.imul(W, Ue) | 0, w = w + Math.imul(k, _e) | 0, u = u + Math.imul(k, qe) | 0, u = u + Math.imul(q, _e) | 0, m = m + Math.imul(q, qe) | 0, w = w + Math.imul(M, de) | 0, u = u + Math.imul(M, Fe) | 0, u = u + Math.imul($, de) | 0, m = m + Math.imul($, Fe) | 0, w = w + Math.imul(P, je) | 0, u = u + Math.imul(P, it) | 0, u = u + Math.imul(B, je) | 0, m = m + Math.imul(B, it) | 0;
      var Wi = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Wi >>> 26) | 0, Wi &= 67108863, w = Math.imul(re, he), u = Math.imul(re, We), u = u + Math.imul(ue, he) | 0, m = Math.imul(ue, We), w = w + Math.imul(ee, xe) | 0, u = u + Math.imul(ee, $e) | 0, u = u + Math.imul(fe, xe) | 0, m = m + Math.imul(fe, $e) | 0, w = w + Math.imul(ie, Oe) | 0, u = u + Math.imul(ie, et) | 0, u = u + Math.imul(ge, Oe) | 0, m = m + Math.imul(ge, et) | 0, w = w + Math.imul(se, le) | 0, u = u + Math.imul(se, ke) | 0, u = u + Math.imul(Se, le) | 0, m = m + Math.imul(Se, ke) | 0, w = w + Math.imul(ce, be) | 0, u = u + Math.imul(ce, Ne) | 0, u = u + Math.imul(Re, be) | 0, m = m + Math.imul(Re, Ne) | 0, w = w + Math.imul(J, we) | 0, u = u + Math.imul(J, Ue) | 0, u = u + Math.imul(oe, we) | 0, m = m + Math.imul(oe, Ue) | 0, w = w + Math.imul(R, _e) | 0, u = u + Math.imul(R, qe) | 0, u = u + Math.imul(W, _e) | 0, m = m + Math.imul(W, qe) | 0, w = w + Math.imul(k, de) | 0, u = u + Math.imul(k, Fe) | 0, u = u + Math.imul(q, de) | 0, m = m + Math.imul(q, Fe) | 0, w = w + Math.imul(M, je) | 0, u = u + Math.imul(M, it) | 0, u = u + Math.imul($, je) | 0, m = m + Math.imul($, it) | 0;
      var Gi = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Gi >>> 26) | 0, Gi &= 67108863, w = Math.imul(re, xe), u = Math.imul(re, $e), u = u + Math.imul(ue, xe) | 0, m = Math.imul(ue, $e), w = w + Math.imul(ee, Oe) | 0, u = u + Math.imul(ee, et) | 0, u = u + Math.imul(fe, Oe) | 0, m = m + Math.imul(fe, et) | 0, w = w + Math.imul(ie, le) | 0, u = u + Math.imul(ie, ke) | 0, u = u + Math.imul(ge, le) | 0, m = m + Math.imul(ge, ke) | 0, w = w + Math.imul(se, be) | 0, u = u + Math.imul(se, Ne) | 0, u = u + Math.imul(Se, be) | 0, m = m + Math.imul(Se, Ne) | 0, w = w + Math.imul(ce, we) | 0, u = u + Math.imul(ce, Ue) | 0, u = u + Math.imul(Re, we) | 0, m = m + Math.imul(Re, Ue) | 0, w = w + Math.imul(J, _e) | 0, u = u + Math.imul(J, qe) | 0, u = u + Math.imul(oe, _e) | 0, m = m + Math.imul(oe, qe) | 0, w = w + Math.imul(R, de) | 0, u = u + Math.imul(R, Fe) | 0, u = u + Math.imul(W, de) | 0, m = m + Math.imul(W, Fe) | 0, w = w + Math.imul(k, je) | 0, u = u + Math.imul(k, it) | 0, u = u + Math.imul(q, je) | 0, m = m + Math.imul(q, it) | 0;
      var Yi = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Yi >>> 26) | 0, Yi &= 67108863, w = Math.imul(re, Oe), u = Math.imul(re, et), u = u + Math.imul(ue, Oe) | 0, m = Math.imul(ue, et), w = w + Math.imul(ee, le) | 0, u = u + Math.imul(ee, ke) | 0, u = u + Math.imul(fe, le) | 0, m = m + Math.imul(fe, ke) | 0, w = w + Math.imul(ie, be) | 0, u = u + Math.imul(ie, Ne) | 0, u = u + Math.imul(ge, be) | 0, m = m + Math.imul(ge, Ne) | 0, w = w + Math.imul(se, we) | 0, u = u + Math.imul(se, Ue) | 0, u = u + Math.imul(Se, we) | 0, m = m + Math.imul(Se, Ue) | 0, w = w + Math.imul(ce, _e) | 0, u = u + Math.imul(ce, qe) | 0, u = u + Math.imul(Re, _e) | 0, m = m + Math.imul(Re, qe) | 0, w = w + Math.imul(J, de) | 0, u = u + Math.imul(J, Fe) | 0, u = u + Math.imul(oe, de) | 0, m = m + Math.imul(oe, Fe) | 0, w = w + Math.imul(R, je) | 0, u = u + Math.imul(R, it) | 0, u = u + Math.imul(W, je) | 0, m = m + Math.imul(W, it) | 0;
      var Ji = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Ji >>> 26) | 0, Ji &= 67108863, w = Math.imul(re, le), u = Math.imul(re, ke), u = u + Math.imul(ue, le) | 0, m = Math.imul(ue, ke), w = w + Math.imul(ee, be) | 0, u = u + Math.imul(ee, Ne) | 0, u = u + Math.imul(fe, be) | 0, m = m + Math.imul(fe, Ne) | 0, w = w + Math.imul(ie, we) | 0, u = u + Math.imul(ie, Ue) | 0, u = u + Math.imul(ge, we) | 0, m = m + Math.imul(ge, Ue) | 0, w = w + Math.imul(se, _e) | 0, u = u + Math.imul(se, qe) | 0, u = u + Math.imul(Se, _e) | 0, m = m + Math.imul(Se, qe) | 0, w = w + Math.imul(ce, de) | 0, u = u + Math.imul(ce, Fe) | 0, u = u + Math.imul(Re, de) | 0, m = m + Math.imul(Re, Fe) | 0, w = w + Math.imul(J, je) | 0, u = u + Math.imul(J, it) | 0, u = u + Math.imul(oe, je) | 0, m = m + Math.imul(oe, it) | 0;
      var ai = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (ai >>> 26) | 0, ai &= 67108863, w = Math.imul(re, be), u = Math.imul(re, Ne), u = u + Math.imul(ue, be) | 0, m = Math.imul(ue, Ne), w = w + Math.imul(ee, we) | 0, u = u + Math.imul(ee, Ue) | 0, u = u + Math.imul(fe, we) | 0, m = m + Math.imul(fe, Ue) | 0, w = w + Math.imul(ie, _e) | 0, u = u + Math.imul(ie, qe) | 0, u = u + Math.imul(ge, _e) | 0, m = m + Math.imul(ge, qe) | 0, w = w + Math.imul(se, de) | 0, u = u + Math.imul(se, Fe) | 0, u = u + Math.imul(Se, de) | 0, m = m + Math.imul(Se, Fe) | 0, w = w + Math.imul(ce, je) | 0, u = u + Math.imul(ce, it) | 0, u = u + Math.imul(Re, je) | 0, m = m + Math.imul(Re, it) | 0;
      var Zi = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Zi >>> 26) | 0, Zi &= 67108863, w = Math.imul(re, we), u = Math.imul(re, Ue), u = u + Math.imul(ue, we) | 0, m = Math.imul(ue, Ue), w = w + Math.imul(ee, _e) | 0, u = u + Math.imul(ee, qe) | 0, u = u + Math.imul(fe, _e) | 0, m = m + Math.imul(fe, qe) | 0, w = w + Math.imul(ie, de) | 0, u = u + Math.imul(ie, Fe) | 0, u = u + Math.imul(ge, de) | 0, m = m + Math.imul(ge, Fe) | 0, w = w + Math.imul(se, je) | 0, u = u + Math.imul(se, it) | 0, u = u + Math.imul(Se, je) | 0, m = m + Math.imul(Se, it) | 0;
      var Xi = (I + w | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (Xi >>> 26) | 0, Xi &= 67108863, w = Math.imul(re, _e), u = Math.imul(re, qe), u = u + Math.imul(ue, _e) | 0, m = Math.imul(ue, qe), w = w + Math.imul(ee, de) | 0, u = u + Math.imul(ee, Fe) | 0, u = u + Math.imul(fe, de) | 0, m = m + Math.imul(fe, Fe) | 0, w = w + Math.imul(ie, je) | 0, u = u + Math.imul(ie, it) | 0, u = u + Math.imul(ge, je) | 0, m = m + Math.imul(ge, it) | 0;
      ...
      I = (m + (u >>> 13) | 0) + (Qi >>> 26) | 0, Qi &= 67108863, w = Math.imul(re, je), u = Math.imul(re, it), u = u + Math.imul(ue, je) | 0, m = Math.imul(ue, it);
      var er = (I + w | 0) + ((u & 8191) << 13) | 0;
      return I = (m + (u >>> 13) | 0) + (er >>> 26) | 0, er &= 67108863, E[0] = tt, E[1] = Je, E[2] = Kt, E[3] = Bt, E[4] = $t, E[5] = Vt, E[6] = Ht, E[7] = bt, E[8] = Hi, E[9] = Wi, E[10] = Gi, E[11] = Yi, E[12] = Ji, E[13] = ai, E[14] = Zi, E[15] = Xi, E[16] = Lt, E[17] = Qi, E[18] = er, I !== 0 && (E[19] = I, o.length++), o;
    };
    Math.imul || (j = O);
    function F(p, S, o) {
      o.negative = S.negative ^ p.negative, o.length = p.length + S.length;
      for (var h = 0, l = 0, E = 0; E < o.length - 1; E++) {
        var I = l;
        l = 0;
        for (var w = h & 67108863, u = Math.min(E, S.length - 1), m = Math.max(0, E - p.length + 1); m <= u; m++) {
      ...
      return h !== 0 ? o.words[E] = h : o.length--, o.strip();
    }
    function V(p, S, o) {
      var h = new C();
      return h.mulp(p, S, o);
    ...
    s.prototype.mulTo = function(p, S) {
      var o, h = this.length + p.length;
      return this.length === 10 && p.length === 10 ? o = j(this, p, S) : h < 63 ? o = O(this, p, S) : h < 1024 ? o = F(this, p, S) : o = V(this, p, S), o;
    };
    function C(p, S) {
      this.x = p, this.y = S;
    }
    C.prototype.makeRBT = function(p) {
      for (var S = new Array(p), o = s.prototype._countBits(p) - 1, h = 0; h < p; h++)
        S[h] = this.revBin(h, o, p);
      return S;
      ...
      for (var h = 0, l = 0; l < S; l++)
        h |= (p & 1) << S - l - 1, p >>= 1;
      return h;
    }, C.prototype.permute = function(p, S, o, h, l, E) {
      for (var I = 0; I < E; I++)
        h[I] = S[p[I]], l[I] = o[p[I]];
    }, C.prototype.transform = function(p, S, o, h, l, E) {
      this.permute(E, p, S, o, h, l);
      for (var I = 1; I < l; I <<= 1)
        for (var w = I << 1, u = Math.cos(2 * Math.PI / w), m = Math.sin(2 * Math.PI / w), b = 0; b < l; b += w)
          for (var P = u, B = m, G = 0; G < I; G++) {
            var M = o[b + G], $ = h[b + G], L = o[b + G + I], k = h[b + G + I], q = P * L - B * k;
            k = P * k + B * L, L = q, o[b + G] = M + L, h[b + G] = $ + k, o[b + G + I] = M - L, h[b + G + I] = $ - k, G !== w && (q = u * P - m * B, B = u * B + m * P, P = q);
          }
    }, C.prototype.guessLen13b = function(p, S) {
      var o = Math.max(S, p) | 1, h = o & 1, l = 0;
      for (o = o / 2 | 0; o; o = o >>> 1)
        l++;
      return 1 << l + 1 + h;
      ...
      if (!(o <= 1))
        for (var h = 0; h < o / 2; h++) {
          var l = p[h];
          p[h] = p[o - h - 1], p[o - h - 1] = l, l = S[h], S[h] = -S[o - h - 1], S[o - h - 1] = -l;
        }
    }, C.prototype.normalize13b = function(p, S) {
      for (var o = 0, h = 0; h < S / 2; h++) {
        var l = Math.round(p[2 * h + 1] / S) * 8192 + Math.round(p[2 * h] / S) + o;
        p[h] = l & 67108863, l < 67108864 ? o = 0 : o = l / 67108864 | 0;
      }
      return p;
    }, C.prototype.convert13b = function(p, S, o, h) {
      ...
      var h = 2 * this.guessLen13b(p.length, S.length), l = this.makeRBT(h), E = this.stub(h), I = new Array(h), w = new Array(h), u = new Array(h), m = new Array(h), b = new Array(h), P = new Array(h), B = o.words;
      B.length = h, this.convert13b(p.words, p.length, I, h), this.convert13b(S.words, S.length, m, h), this.transform(I, E, w, u, h, l), this.transform(m, E, b, P, h, l);
      for (var G = 0; G < h; G++) {
        var M = w[G] * b[G] - u[G] * P[G];
        u[G] = w[G] * P[G] + u[G] * b[G], w[G] = M;
      }
      return this.conjugate(w, u, h), this.transform(w, u, B, E, h, l), this.conjugate(B, E, h), this.normalize13b(B, h), o.negative = p.negative ^ S.negative, o.length = p.length + S.length, o.strip();
      ...
      for (var S = 0, o = 0; o < this.length; o++) {
        var h = (this.words[o] | 0) * p, l = (h & 67108863) + (S & 67108863);
        S >>= 26, S += h / 67108864 | 0, S += l >>> 26, this.words[o] = l & 67108863;
      }
      ...
      if (S.length === 0)
        return new s(1);
      for (var o = this, h = 0; h < S.length && S[h] === 0; h++, o = o.sqr())
        ;
      if (++h < S.length)
        for (var l = o.sqr(); h < S.length; h++, l = l.sqr())
          S[h] !== 0 && (o = o.mul(l));
      return o;
    }, s.prototype.iushln = function(p) {
      r(typeof p == "number" && p >= 0);
      var S = p % 26, o = (p - S) / 26, h = 67108863 >>> 26 - S << 26 - S, l;
      if (S !== 0) {
        var E = 0;
        for (l = 0; l < this.length; l++) {
          var I = this.words[l] & h, w = (this.words[l] | 0) - I << S;
      ...
      if (E !== 0)
        if (this.length > E)
          ...
          this.words[0] = 0, this.length = 1;
      var m = 0;
      for (u = this.length - 1; u >= 0 && (m !== 0 || u >= h); u--) {
      ...
      var o = this.length - p.length, h = this.clone(), l = p, E = l.words[l.length - 1] | 0, I = this._countBits(E);
      o = 26 - I, o !== 0 && (l = l.ushln(o), h.iushln(o), E = l.words[l.length - 1] | 0);
      var w = h.length - l.length, u;
      if (S !== "mod") {
        u = new s(null), u.length = w + 1, u.words = new Array(u.length);
        for (var m = 0; m < u.length; m++)
          u.words[m] = 0;
      }
      var b = h.clone()._ishlnsubmul(l, 1, w);
      b.negative === 0 && (h = b, u && (u.words[w] = 1));
      for (var P = w - 1; P >= 0; P--) {
        var B = (h.words[l.length + P] | 0) * 67108864 + (h.words[l.length + P - 1] | 0);
        for (B = Math.min(B / E | 0, 67108863), h._ishlnsubmul(l, B, P); h.negative !== 0; )
          B--, h.negative = 0, h._ishlnsubmul(l, 1, P), h.isZero() || (h.negative ^= 1);
        u && (u.words[P] = B);
      }
      return u && u.strip(), h.strip(), S !== "div" && o !== 0 && h.iushrn(o), {
        div: u || null,
        mod: h
      };
      ...
      var h, l, E;
      return this.negative !== 0 && p.negative === 0 ? (E = this.neg().divmod(p, S), S !== "mod" && (h = E.div.neg()), S !== "div" && (l = E.mod.neg(), o && l.negative !== 0 && l.iadd(p)), {
        div: h,
        mod: l
      }) : this.negative === 0 && p.negative !== 0 ? (E = this.divmod(p.neg(), S), S !== "mod" && (h = E.div.neg()), {
        div: h,
        mod: E.mod
      ...
      if (S.mod.isZero())
        return S.div;
      var o = S.div.negative !== 0 ? S.mod.isub(p) : S.mod, h = p.ushrn(1), l = p.andln(1), E = o.cmp(h);
      return E < 0 || l === 1 && E === 0 ? S.div : S.div.negative !== 0 ? S.div.isubn(1) : S.div.iaddn(1);
    }, s.prototype.modn = function(p) {
      r(p <= 67108863);
      for (var S = (1 << 26) % p, o = 0, h = this.length - 1; h >= 0; h--)
        o = (S * o + (this.words[h] | 0)) % p;
      return o;
    }, s.prototype.idivn = function(p) {
      r(p <= 67108863);
      for (var S = 0, o = this.length - 1; o >= 0; o--) {
        var h = (this.words[o] | 0) + S * 67108864;
        this.words[o] = h / p | 0, S = h % p;
      }
      return this.strip();
      ...
      for (var h = new s(1), l = new s(0), E = new s(0), I = new s(1), w = 0; S.isEven() && o.isEven(); )
      ...
      for (var u = o.clone(), m = S.clone(); !S.isZero(); ) {
        ...
        if (b > 0)
          for (S.iushrn(b); b-- > 0; )
            (h.isOdd() || l.isOdd()) && (h.iadd(u), l.isub(m)), h.iushrn(1), l.iushrn(1);
        for (var B = 0, G = 1; !(o.words[0] & G) && B < 26; ++B, G <<= 1)
          ;
        if (B > 0)
          for (o.iushrn(B); B-- > 0; )
            (E.isOdd() || I.isOdd()) && (E.iadd(u), I.isub(m)), E.iushrn(1), I.iushrn(1);
        S.cmp(o) >= 0 ? (S.isub(o), h.isub(E), l.isub(I)) : (o.isub(S), E.isub(h), I.isub(l));
      }
      return {
        a: E,
        b: I,
      ...
      var S = this, o = p.clone();
      S.negative !== 0 ? S = S.umod(p) : S = S.clone();
      for (var h = new s(1), l = new s(0), E = o.clone(); S.cmpn(1) > 0 && o.cmpn(1) > 0; ) {
        ...
        S.cmp(o) >= 0 ? (S.isub(o), h.isub(l)) : (o.isub(S), l.isub(h));
      }
      var b;
      return S.cmpn(1) === 0 ? b = h : b = l, b.cmpn(0) < 0 && b.iadd(p), b;
      ...
      for (var h = 0; S.isEven() && o.isEven(); h++)
      ...
      var S = p % 26, o = (p - S) / 26, h = 1 << S;
      if (this.length <= o)
        return this._expand(o + 1), this.words[o] |= h, this;
      for (var l = h, E = o; l !== 0 && E < this.length; E++) {
      ...
      if (this.length < p.length)
        return -1;
      for (var S = 0, o = this.length - 1; o >= 0; o--) {
        var h = this.words[o] | 0, l = p.words[o] | 0;
        if (h !== l) {
          h < l ? S = -1 : h > l && (S = 1);
          break;
        }
    ...
    N.prototype._tmp = function() {
      ...
      while (o > this.n);
      var h = o < this.n ? -1 : S.ucmp(this.p);
      return h === 0 ? (S.words[0] = 0, S.length = 1) : h > 0 ? S.isub(this.p) : S.strip !== void 0 ? S.strip() : S._strip(), S;
    ...
    n(U, N), U.prototype.split = function(p, S) {
      for (var o = 4194303, h = Math.min(p.length, 9), l = 0; l < h; l++)
        S.words[l] = p.words[l];
      if (S.length = h, p.length <= 9) {
      ...
      for (var S = 0, o = 0; o < p.length; o++) {
        var h = p.words[o] | 0;
        S += h * 977, p.words[o] = S & 67108863, S = h * 64 + (S / 67108864 | 0);
      }
    ...
    n(T, N), T.prototype.imulK = function(p) {
      for (var S = 0, o = 0; o < p.length; o++) {
        var h = (p.words[o] | 0) * 19 + S, l = h & 67108863;
        h >>>= 26, p.words[o] = l, S = h;
      }
    ...
    Y.prototype._verify1 = function(p) {
      ...
      for (var h = this.m.subn(1), l = 0; !h.isZero() && h.andln(1) === 0; )
        l++, h.iushrn(1);
      r(!h.isZero());
      ...
      for (u = new s(2 * u * u).toRed(this); this.pow(u, w).cmp(I) !== 0; )
        u.redIAdd(I);
      for (var m = this.pow(u, h), b = this.pow(p, h.addn(1).iushrn(1)), P = this.pow(p, h), B = l; P.cmp(E) !== 0; ) {
      ...
      if (S.cmpn(1) === 0)
        return p.clone();
      var o = 4, h = new Array(1 << o);
      h[0] = new s(1).toRed(this), h[1] = p;
      for (var l = 2; l < h.length; l++)
        h[l] = this.mul(h[l - 1], p);
      var E = h[0], I = 0, w = 0, u = S.bitLength() % 26;
      for (u === 0 && (u = 26), l = S.length - 1; l >= 0; l--) {
        for (var m = S.words[l], b = u - 1; b >= 0; b--) {
          var P = m >> b & 1;
          if (E !== h[0] && (E = this.sqr(E)), P === 0 && I === 0) {
            w = 0;
            continue;
          }
          I <<= 1, I |= P, w++, !(w !== o && (l !== 0 || b !== 0)) && (E = this.mul(E, h[I]), w = 0, I = 0);
        }
        u = 26;
      }
      return E;
    ...
    n(Q, Y), Q.prototype.convertTo = function(p) {
      ...
      var o = p.imul(S), h = o.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m), l = o.isub(h).iushrn(this.shift), E = l;
      return l.cmp(this.m) >= 0 ? E = l.isub(this.m) : l.cmpn(0) < 0 && (E = l.iadd(this.m)), E._forceRed(this);
    }, Q.prototype.mul = function(p, S) {
      if (p.isZero() || S.isZero())
        return new s(0)._forceRed(this);
      var o = p.mul(S), h = o.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m), l = o.isub(h).iushrn(this.shift), E = l;
      return l.cmp(this.m) >= 0 ? E = l.isub(this.m) : l.cmpn(0) < 0 && (E = l.iadd(this.m)), E._forceRed(this);
  ...
  function i(s, a) {
    ...
    if (a === "hex") {
      ...
      for (var d = 0; d < s.length; d += 2)
        c.push(parseInt(s[d] + s[d + 1], 16));
    } else
      for (var d = 0; d < s.length; d++) {
        var f = s.charCodeAt(d), g = f >> 8, _ = f & 255;
        g ? c.push(g, _) : c.push(_);
      }
    return c;
  }
  t.toArray = i;
...
Fa.exports = function(e) {
  return Vo || (Vo = new mr(null)), Vo.generate(e);
};
function mr(e) {
  this.rand = e;
}
...
if (typeof self == "object")
  ...
  try {
    var dh = ao;
    if (typeof dh.randomBytes != "function")
      throw new Error("Not supported");
    mr.prototype._rand = function(e) {
      return dh.randomBytes(e);
    };
  } catch {
  }
var $u = Fa.exports, Ka = {}, Nr = dr, os = oi, $s = os.getNAF, u2 = os.getJSF, Vs = os.assert;
function Mr(e, t) {
...
Mr.prototype._wnafMul = function(e, t) {
  var i = 4, r = e._getNAFPoints(i);
  i = r.wnd;
  for (var n = r.points, s = $s(t, i, this._bitLength), a = this.jpoint(null, null, null), c = s.length - 1; c >= 0; c--) {
    for (var d = 0; c >= 0 && s[c] === 0; c--)
      d++;
    if (c >= 0 && d++, a = a.dblp(d), c < 0)
      break;
...
Mr.prototype._wnafMulAdd = function(e, t, i, r, n) {
  ...
  for (f = r - 1; f >= 1; f -= 2) {
    var A = f - 1, O = f;
    if (s[A] !== 1 || s[O] !== 1) {
      c[A] = $s(i[A], s[A], this._bitLength), c[O] = $s(i[O], s[O], this._bitLength), d = Math.max(c[A].length, d), d = Math.max(c[O].length, d);
      continue;
    }
    var j = [
      t[A],
...
var d2 = oi, lt = dr, Ba = fo, En = bo, l2 = d2.assert;
function yi(e) {
...
yi.prototype._getEndomorphism = function(e) {
  if (!(!this.zeroA || !this.g || !this.n || this.p.modn(3) !== 1)) {
    ...
    if (e.lambda)
      ...
      var n = this._getEndoRoots(this.n);
      this.g.mul(n[0]).x.cmp(this.g.x.redMul(t)) === 0 ? i = n[0] : (i = n[1], l2(this.g.mul(i).x.cmp(this.g.x.redMul(t)) === 0));
    }
    var s;
    return e.basis ? s = e.basis.map(function(a) {
      return {
...
yi.prototype._getEndoBasis = function(e) {
  for (var t = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), i = e, r = this.n.clone(), n = new lt(1), s = new lt(0), a = new lt(0), c = new lt(1), d, f, g, _, x, A, O, j = 0, F, V; i.cmpn(0) !== 0; ) {
    var C = r.div(i);
    F = r.sub(C.mul(i)), V = a.sub(C.mul(n));
    var K = c.sub(C.mul(s));
    if (!g && F.cmp(t) < 0)
...
var on = dr, Vu = fo, mo = bo, g2 = oi;
function Sn(e) {
  mo.call(this, "mont", e), this.a = new on(e.a, 16).toRed(this.red), this.b = new on(e.b, 16).toRed(this.red), this.i4 = new on(4).toRed(this.red).redInvm(), this.two = new on(2).toRed(this.red), this.a24 = this.i4.redMul(this.a.redAdd(this.two));
}
Vu(Sn, mo);
var b2 = Sn;
...
function At(e, t, i) {
  mo.BasePoint.call(this, e, "projective"), t === null && i === null ? (this.x = this.curve.one, this.z = this.curve.zero) : (this.x = new on(t, 16), this.z = new on(i, 16), this.x.red || (this.x = this.x.toRed(this.curve.red)), this.z.red || (this.z = this.z.toRed(this.curve.red)));
}
Vu(At, mo.BasePoint);
Sn.prototype.decodePoint = function(e, t) {
  return this.point(g2.toArray(e, t), 1);
};
...
At.prototype.diffAdd = function(e, t) {
  var i = this.x.redAdd(this.z), r = this.x.redSub(this.z), n = e.x.redAdd(e.z), s = e.x.redSub(e.z), a = s.redMul(i), c = n.redMul(r), d = t.z.redMul(a.redAdd(c).redSqr()), f = t.x.redMul(a.redISub(c).redSqr());
...
var m2 = oi, cr = dr, Hu = fo, yo = bo, y2 = m2.assert;
function Vi(e) {
  this.twisted = (e.a | 0) !== 1, this.mOneA = this.twisted && (e.a | 0) === -1, this.extended = this.mOneA, yo.call(this, "edwards", e), this.a = new cr(e.a, 16).umod(this.red.m), this.a = this.a.toRed(this.red), this.c = new cr(e.c, 16).toRed(this.red), this.c2 = this.c.redSqr(), this.d = new cr(e.d, 16).toRed(this.red), this.dd = this.d.redAdd(this.d), y2(!this.twisted || this.c.fromRed().cmpn(1) === 0), this.oneC = (e.c | 0) === 1;
}
Hu(Vi, yo);
var v2 = Vi;
Vi.prototype._mulA = function(e) {
  return this.mOneA ? e.redNeg() : this.a.redMul(e);
};
Vi.prototype._mulC = function(e) {
  return this.oneC ? e : this.c.redMul(e);
};
Vi.prototype.jpoint = function(e, t, i, r) {
  return this.point(e, t, i, r);
};
Vi.prototype.pointFromX = function(e, t) {
  e = new cr(e, 16), e.red || (e = e.toRed(this.red));
...
Vi.prototype.pointFromY = function(e, t) {
  e = new cr(e, 16), e.red || (e = e.toRed(this.red));
...
function at(e, t, i, r, n) {
  yo.BasePoint.call(this, e, "projective"), t === null && i === null && r === null ? (this.x = this.curve.zero, this.y = this.curve.one, this.z = this.curve.one, this.t = this.curve.zero, this.zOne = !0) : (this.x = new cr(t, 16), this.y = new cr(i, 16), this.z = r ? new cr(r, 16) : this.curve.one, this.t = n && new cr(n, 16), this.x.red || (this.x = this.x.toRed(this.curve.red)), this.y.red || (this.y = this.y.toRed(this.curve.red)), this.z.red || (this.z = this.z.toRed(this.curve.red)), this.t && !this.t.red && (this.t = this.t.toRed(this.curve.red)), this.zOne = this.z === this.curve.one, this.curve.extended && !this.t && (this.t = this.x.redMul(this.y), this.zOne || (this.t = this.t.redMul(this.z.redInvm()))));
}
Hu(at, yo.BasePoint);
Vi.prototype.pointFromJSON = function(e) {
  return at.fromJSON(this, e);
};
Vi.prototype.point = function(e, t, i, r) {
...
at.prototype._extDbl = function() {
  ...
  i = i.redIAdd(i);
  var r = this.curve._mulA(e), n = this.x.redAdd(this.y).redSqr().redISub(e).redISub(t), s = r.redAdd(t), a = s.redSub(i), c = r.redSub(t), d = n.redMul(a), f = s.redMul(c), g = n.redMul(c), _ = a.redMul(s);
  return this.curve.point(d, f, _, g);
};
at.prototype._projDbl = function() {
  var e = this.x.redAdd(this.y).redSqr(), t = this.x.redSqr(), i = this.y.redSqr(), r, n, s, a, c, d;
  if (this.curve.twisted) {
    a = this.curve._mulA(t);
    var f = a.redAdd(i);
    this.zOne ? (r = e.redSub(t).redSub(i).redMul(f.redSub(this.curve.two)), n = f.redMul(a.redSub(i)), s = f.redSqr().redSub(f).redSub(f)) : (c = this.z.redSqr(), d = f.redSub(c).redISub(c), r = e.redSub(t).redISub(i).redMul(d), n = f.redMul(a.redSub(i)), s = f.redMul(d));
  } else
    a = t.redAdd(i), c = this.curve._mulC(this.z).redSqr(), d = a.redSub(c).redSub(c), r = this.curve._mulC(e.redISub(a)).redMul(d), n = this.curve._mulC(a).redMul(t.redISub(i)), s = a.redMul(d);
...
at.prototype._extAdd = function(e) {
  var t = this.y.redSub(this.x).redMul(e.y.redSub(e.x)), i = this.y.redAdd(this.x).redMul(e.y.redAdd(e.x)), r = this.t.redMul(this.curve.dd).redMul(e.t), n = this.z.redMul(e.z.redAdd(e.z)), s = i.redSub(t), a = n.redSub(r), c = n.redAdd(r), d = i.redAdd(t), f = s.redMul(a), g = c.redMul(d), _ = s.redMul(d), x = a.redMul(c);
  return this.curve.point(f, g, x, _);
};
at.prototype._projAdd = function(e) {
  var t = this.z.redMul(e.z), i = t.redSqr(), r = this.x.redMul(e.x), n = this.y.redMul(e.y), s = this.curve.d.redMul(r).redMul(n), a = i.redSub(s), c = i.redAdd(s), d = this.x.redAdd(this.y).redMul(e.x.redAdd(e.y)).redISub(r).redISub(n), f = t.redMul(a).redMul(d), g, _;
  return this.curve.twisted ? (g = t.redMul(c).redMul(n.redSub(this.curve._mulA(r))), _ = a.redMul(c)) : (g = t.redMul(c).redMul(n.redSub(r)), _ = this.curve._mulC(a).redMul(c)), this.curve.point(f, g, _);
};
...
(function(e) {
  var t = e;
  t.base = bo, t.short = p2, t.mont = b2, t.edwards = v2;
})(Ka);
var vo = {}, lh, ph;
function w2() {
  return ph || (ph = 1, lh = {
...
zt.prototype._importPrivate = function(e, t) {
  this.priv = new S2(e, t || 16), this.priv = this.priv.umod(this.ec.curve.n);
};
zt.prototype._importPublic = function(e, t) {
  if (e.x || e.y) {
    this.ec.curve.type === "mont" ? va(e.x, "Need x coordinate") : (this.ec.curve.type === "short" || this.ec.curve.type === "edwards") && va(e.x && e.y, "Need both x and y coordinate"), this.pub = this.ec.curve.point(e.x, e.y);
    return;
  }
  this.pub = this.ec.curve.decodePoint(e, t);
};
zt.prototype.derive = function(e) {
  return e.validate() || va(e.validate(), "public point not validated"), e.mul(this.priv).getX();
};
...
var Hs = dr, $a = oi, A2 = $a.assert;
function wo(e, t) {
  if (e instanceof wo)
    return e;
  this._importDER(e, t) || (A2(e.r && e.s, "Signature without r or s"), this.r = new Hs(e.r, 16), this.s = new Hs(e.s, 16), e.recoveryParam === void 0 ? this.recoveryParam = null : this.recoveryParam = e.recoveryParam);
}
var x2 = wo;
function O2() {
  this.place = 0;
...
wo.prototype._importDER = function(e, t) {
  e = $a.toArray(e, t);
  var i = new O2();
  if (e[i.place++] !== 48)
    return !1;
  ...
  if (c[0] === 0)
    if (c[1] & 128)
      ...
      return !1;
  return this.r = new Hs(s), this.s = new Hs(c), this.recoveryParam = null, !0;
};
function Wo(e, t) {
  if (t < 128) {
    e.push(t);
...
wo.prototype.toDER = function(e) {
  var t = this.r.toArray(), i = this.s.toArray();
  for (t[0] & 128 && (t = [0].concat(t)), i[0] & 128 && (i = [0].concat(i)), t = gh(t), i = gh(i); !i[0] && !(i[1] & 128); )
    i = i.slice(1);
  var r = [2];
  Wo(r, t.length), r = r.concat(t), r.push(2), Wo(r, i.length);
  var n = r.concat(i), s = [48];
  return Wo(s, n.length), s = s.concat(n), $a.encode(s, e);
};
var Ai = dr, Gu = E2, P2 = oi, Go = vo, N2 = $u, Cr = P2.assert, Va = M2, _o = x2;
function pi(e) {
  if (!(this instanceof pi))
    return new pi(e);
  typeof e == "string" && (Cr(
    Object.prototype.hasOwnProperty.call(Go, e),
    "Unknown curve " + e
  ), e = Go[e]), e instanceof Go.PresetCurve && (e = { curve: e }), this.curve = e.curve.curve, this.n = this.curve.n, this.nh = this.n.ushrn(1), this.g = this.curve.g, this.g = e.curve.g, this.g.precompute(e.curve.n.bitLength() + 1), this.hash = e.hash || e.curve.hash;
}
var R2 = pi;
...
pi.prototype.genKeyPair = function(e) {
  ...
  for (var t = new Gu({
    ...
    pers: e.pers,
    persEnc: e.persEnc || "utf8",
    entropy: e.entropy || N2(this.hash.hmacStrength),
    entropyEnc: e.entropy && e.entropyEnc || "utf8",
    nonce: this.n.toArray()
...
pi.prototype.sign = function(e, t, i, r) {
  ...
  var s = this.n.byteLength(), a = t.getPrivate().toArray("be", s), c = e.toArray("be", s);
  Cr(new Ai(c).eq(e), "Can not sign message");
  for (var d = new Gu({
    hash: this.hash,
    entropy: a,
    nonce: c,
      ...
      if (!x.isInfinity()) {
        ...
        if (O.cmpn(0) !== 0) {
          ...
          if (j = j.umod(this.n), j.cmpn(0) !== 0) {
            ...
            return r.canonical && j.cmp(this.nh) > 0 && (j = this.n.sub(j), F ^= 1), new _o({ r: O, s: j, recoveryParam: F });
          }
        }
      }
    }
...
pi.prototype.verify = function(e, t, i, r, n) {
  n || (n = {}), e = this._truncateToN(e, !1, n.msgBitLength), i = this.keyFromPublic(i, r), t = new _o(t, "hex");
  var s = t.r, a = t.s;
  if (s.cmpn(1) < 0 || s.cmp(this.n) >= 0 || a.cmpn(1) < 0 || a.cmp(this.n) >= 0)
    return !1;
  var c = a.invm(this.n), d = c.mul(e).umod(this.n), f = c.mul(s).umod(this.n), g;
...
pi.prototype.recoverPubKey = function(e, t, i, r) {
  Cr((3 & i) === i, "The recovery param is more than two bits"), t = new _o(t, r);
  var n = this.n, s = new Ai(e), a = t.r, c = t.s, d = i & 1, f = i >> 1;
  if (a.cmp(this.curve.p.umod(this.curve.n)) >= 0 && f)
    throw new Error("Unable to find sencond key candinate");
  f ? a = this.curve.pointFromX(a.add(this.curve.n), d) : a = this.curve.pointFromX(a, d);
  var g = t.r.invm(n), _ = n.sub(s).mul(g).umod(n), x = c.mul(g).umod(n);
...
pi.prototype.getKeyRecoveryParam = function(e, t, i, r) {
  if (t = new _o(t, r), t.recoveryParam !== null)
    return t.recoveryParam;
  for (var n = 0; n < 4; n++) {
    var s;
    try {
...
var as = oi, Yu = as.assert, bh = as.parseBytes, In = as.cachedProperty;
function Mt(e, t) {
  this.eddsa = e, this._secret = bh(t.secret), e.isPoint(t.pub) ? this._pub = t.pub : this._pubBytes = bh(t.pub);
}
...
var T2 = Mt, k2 = dr, Eo = oi, mh = Eo.assert, So = Eo.cachedProperty, L2 = Eo.parseBytes;
function Jr(e, t) {
  this.eddsa = e, typeof t != "object" && (t = L2(t)), Array.isArray(t) && (mh(t.length === e.encodingLength * 2, "Signature has invalid size"), t = {
    R: t.slice(0, e.encodingLength),
    S: t.slice(e.encodingLength)
  }), mh(t.R && t.S, "Signature without R or S"), e.isPoint(t.R) && (this._R = t.R), t.S instanceof k2 && (this._S = t.S), this._Rencoded = Array.isArray(t.R) ? t.R : t.Rencoded, this._Sencoded = Array.isArray(t.S) ? t.S : t.Sencoded;
}
So(Jr, "S", function() {
...
So(Jr, "Rencoded", function() {
  return this.eddsa.encodePoint(this.R());
});
So(Jr, "Sencoded", function() {
...
Jr.prototype.toHex = function() {
  return Eo.encode(this.toBytes(), "hex").toUpperCase();
};
var C2 = Jr, q2 = rs, j2 = vo, pn = oi, z2 = pn.assert, Ju = pn.parseBytes, Zu = T2, yh = C2;
function Zt(e) {
  if (z2(e === "ed25519", "only tested with ed25519 so far"), !(this instanceof Zt))
    return new Zt(e);
  e = j2[e].curve, this.curve = e, this.g = e.g, this.g.precompute(e.n.bitLength() + 1), this.pointClass = e.point().constructor, this.encodingLength = Math.ceil(e.n.bitLength() / 8), this.hash = q2.sha512;
}
var U2 = Zt;
Zt.prototype.sign = function(e, t) {
  e = Ju(e);
  ...
  return this.makeSignature({ R: n, S: c, Rencoded: s });
};
Zt.prototype.verify = function(e, t, i) {
...
Zt.prototype.hashInt = function() {
  for (var e = this.hash(), t = 0; t < arguments.length; t++)
    e.update(arguments[t]);
  return pn.intFromLE(e.digest()).umod(this.curve.n);
};
Zt.prototype.keyFromPublic = function(e) {
  return Zu.fromPublic(this, e);
};
Zt.prototype.keyFromSecret = function(e) {
  return Zu.fromSecret(this, e);
};
Zt.prototype.makeSignature = function(e) {
  return e instanceof yh ? e : new yh(this, e);
};
Zt.prototype.encodePoint = function(e) {
  var t = e.getY().toArray("le", this.encodingLength);
  return t[this.encodingLength - 1] |= e.getX().isOdd() ? 128 : 0, t;
};
Zt.prototype.decodePoint = function(e) {
  e = pn.parseBytes(e);
  var t = e.length - 1, i = e.slice(0, t).concat(e[t] & -129), r = (e[t] & 128) !== 0, n = pn.intFromLE(i);
  return this.curve.pointFromY(n, r);
};
Zt.prototype.encodeInt = function(e) {
  return e.toArray("le", this.encodingLength);
};
Zt.prototype.decodeInt = function(e) {
  return pn.intFromLE(e);
};
Zt.prototype.isPoint = function(e) {
  return e instanceof this.pointClass;
};
(function(e) {
  var t = e;
  t.version = f2.version, t.utils = oi, t.rand = $u, t.curve = Ka, t.curves = vo, t.ec = R2, t.eddsa = U2;
})(Ku);
const D2 = { waku: { publish: "waku_publish", batchPublish: "waku_batchPublish", subscribe: "waku_subscribe", batchSubscribe: "waku_batchSubscribe", subscription: "waku_subscription", unsubscribe: "waku_unsubscribe", batchUnsubscribe: "waku_batchUnsubscribe", batchFetchMessages: "waku_batchFetchMessages" }, irn: { publish: "irn_publish", batchPublish: "irn_batchPublish", subscribe: "irn_subscribe", batchSubscribe: "irn_batchSubscribe", subscription: "irn_subscription", unsubscribe: "irn_unsubscribe", batchUnsubscribe: "irn_batchUnsubscribe", batchFetchMessages: "irn_batchFetchMessages" }, iridium: { publish: "iridium_publish", batchPublish: "iridium_batchPublish", subscribe: "iridium_subscribe", batchSubscribe: "iridium_batchSubscribe", subscription: "iridium_subscription", unsubscribe: "iridium_unsubscribe", batchUnsubscribe: "iridium_batchUnsubscribe", batchFetchMessages: "iridium_batchFetchMessages" } }, Ha = ":";
function Rs(e) {
...
function $2(e) {
  const { namespace: t, reference: i } = K2(e);
  return F2({ namespace: t, reference: i });
}
function V2(e) {
  return B2(e, $2);
}
...
var W2 = Object.defineProperty, vh = Object.getOwnPropertySymbols, G2 = Object.prototype.hasOwnProperty, Y2 = Object.prototype.propertyIsEnumerable, wh = (e, t, i) => t in e ? W2(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, _h = (e, t) => {
  for (var i in t || (t = {}))
    G2.call(t, i) && wh(e, i, t[i]);
  if (vh)
    for (var i of vh(t))
      Y2.call(t, i) && wh(e, i, t[i]);
  return e;
};
...
function X2() {
  return Ar() && typeof global < "u" && typeof (global == null ? void 0 : global.Platform) < "u" && (global == null ? void 0 : global.Platform.OS) === "android";
}
function Q2() {
  return Ar() && typeof global < "u" && typeof (global == null ? void 0 : global.Platform) < "u" && (global == null ? void 0 : global.Platform.OS) === "ios";
}
function cs() {
  return !Ws() && !!Pa() && !!is();
}
function hs() {
  return Ar() ? ii.reactNative : Ws() ? ii.node : cs() ? ii.browser : ii.unknown;
}
function Eh() {
  var e;
  try {
    return Ar() && typeof global < "u" && typeof (global == null ? void 0 : global.Application) < "u" ? (e = global.Application) == null ? void 0 : e.applicationId : void 0;
  } catch {
    return;
  }
}
function e6(e, t) {
  let i = Yn.parse(e);
  return i = _h(_h({}, i), t), e = Yn.stringify(i), e;
}
function ed() {
  return cu() || { name: "", description: "", url: "", icons: [""] };
}
function t6() {
  if (hs() === ii.reactNative && typeof global < "u" && typeof (global == null ? void 0 : global.Platform) < "u") {
...
function r6({ protocol: e, version: t, relayUrl: i, sdkVersion: r, auth: n, projectId: s, useOnCloseEvent: a, bundleId: c, packageName: d }) {
  const f = i.split("?"), g = td(e, t, r), _ = { auth: n, ua: g, projectId: s, useOnCloseEvent: a || void 0, packageName: d || void 0, bundleId: c || void 0 }, x = e6(f[1] || "", _);
  return f[0] + "?" + x;
}
function jr(e, t) {
...
function Lr(e = te.FIVE_MINUTES, t) {
  ...
  let r, n, s, a;
  return { resolve: (c) => {
    s && r && (clearTimeout(s), r(c), a = Promise.resolve(c));
  }, reject: (c) => {
...
async function a6({ id: e, topic: t, wcDeepLink: i }) {
  var r;
  try {
    if (!i)
      return;
    ...
    if (typeof s != "string")
      return;
    const a = c6(s, e, t), c = hs();
    if (c === ii.browser) {
      if (!((r = is()) != null && r.hasFocus())) {
        console.warn("Document does not have focus, skipping deeplink.");
        return;
      }
      a.startsWith("https://") || a.startsWith("http://") ? window.open(a, "_blank", "noreferrer noopener") : window.open(a, f6() ? "_blank" : "_self", "noreferrer noopener");
    } else
      c === ii.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(a);
  } catch (n) {
    console.error(n);
  }
}
...
async function h6(e, t) {
  let i = "";
  try {
    if (cs() && (i = localStorage.getItem(t), i))
      return i;
    i = await e.getItem(t);
  } catch (r) {
    console.error(r);
...
const l6 = "https://rpc.walletconnect.org/v1";
async function p6(e, t, i, r, n, s) {
  switch (i.t) {
    case "eip191":
      return g6(e, t, i.s);
    case "eip1271":
      return await b6(e, t, i.s, r, n, s);
    default:
...
var y6 = Object.defineProperty, v6 = Object.defineProperties, w6 = Object.getOwnPropertyDescriptors, Mh = Object.getOwnPropertySymbols, _6 = Object.prototype.hasOwnProperty, E6 = Object.prototype.propertyIsEnumerable, Ah = (e, t, i) => t in e ? y6(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, S6 = (e, t) => {
  for (var i in t || (t = {}))
    _6.call(t, i) && Ah(e, i, t[i]);
  if (Mh)
    for (var i of Mh(t))
      E6.call(t, i) && Ah(e, i, t[i]);
  return e;
}, I6 = (e, t) => v6(e, w6(t));
const M6 = "did:pkh:", Ya = (e) => e?.split(":"), A6 = (e) => {
  const t = e && Ya(e);
  if (t)
    return e.includes(M6) ? t[3] : t[1];
}, wa = (e) => {
  const t = e && Ya(e);
  if (t)
    return t[2] + ":" + t[3];
...
async function xh(e) {
  ...
  return await p6(a, s, r, wa(n.iss), i);
}
const ad = (e, t) => {
  ...
  const s = `URI: ${e.aud || e.uri}`, a = `Version: ${e.version}`, c = `Chain ID: ${A6(t)}`, d = `Nonce: ${e.nonce}`, f = `Issued At: ${e.iat}`, g = e.exp ? `Expiration Time: ${e.exp}` : void 0, _ = e.nbf ? `Not Before: ${e.nbf}` : void 0, x = e.requestId ? `Request ID: ${e.requestId}` : void 0, A = e.resources ? `Resources:${e.resources.map((j) => `
- ${j}`).join("")}` : void 0, O = Ts(e.resources);
  if (O) {
    const j = Jn(O);
    n = C6(n, j);
  }
  return [i, r, "", n, "", s, a, c, d, f, g, _, x, A].filter((j) => j != null).join(`
`);
};
function x6(e) {
...
function P6(e, t, i, r = {}) {
  return i?.sort((n, s) => n.localeCompare(s)), { att: { [e]: N6(t, i, r) } };
}
function N6(e, t, i = {}) {
...
function cd(e) {
  return Br(e), `urn:recap:${x6(e).replace(/=/g, "")}`;
}
function Jn(e) {
  const t = O6(e.replace("urn:recap:", ""));
  return Br(t), t;
}
function R6(e, t, i) {
  const r = P6(e, t, i);
...
function L6(e, t) {
  ...
  return i.forEach((n) => {
    var s, a;
    Object.keys(((s = e.att) == null ? void 0 : s[n]) || {}).concat(Object.keys(((a = t.att) == null ? void 0 : a[n]) || {})).sort((c, d) => c.localeCompare(d)).forEach((c) => {
      var d, f;
      r.att[n] = I6(S6({}, r.att[n]), { [c]: ((d = e.att[n]) == null ? void 0 : d[c]) || ((f = t.att[n]) == null ? void 0 : f[c]) });
    });
  }), r;
}
function C6(e = "", t) {
  ...
  Object.keys(t.att).forEach((c) => {
    const d = Object.keys(t.att[c]).map((_) => ({ ability: _.split("/")[0], action: _.split("/")[1] }));
    d.sort((_, x) => _.action.localeCompare(x.action));
    const f = {};
    d.forEach((_) => {
      f[_.ability] || (f[_.ability] = []), f[_.ability].push(_.action);
    });
    const g = Object.keys(f).map((_) => (n++, `(${n}) '${_}': '${f[_].join("', '")}' for '${c}'.`));
...
function Ts(e) {
  ...
  return T6(t) ? t : void 0;
}
const hd = "base10", Dt = "base16", vr = "base64pad", Cn = "base64url", fs = "utf8", fd = 0, hr = 1, us = 2, q6 = 0, Nh = 1, Bn = 12, Ja = 32;
function j6() {
...
function Zn(e) {
  const { encoded: t, encoding: i = vr } = e, r = St(t, i), n = r.slice(q6, Nh), s = Nh;
  if ($r(n) === hr) {
  ...
  const a = s + Bn, c = r.slice(s, a), d = r.slice(a);
  return { type: n, sealed: d, iv: c };
}
function B6(e, t) {
...
function H6(e) {
  return Buffer.from(V6(e), "base64");
}
function W6(e, t) {
  const [i, r, n] = e.split("."), s = H6(n);
  if (s.length !== 64)
    throw new Error("Invalid signature length");
  const a = s.slice(0, 32).toString("hex"), c = s.slice(32, 64).toString("hex"), d = `${i}.${r}`, f = new ss.SHA256().update(Buffer.from(d)).digest(), g = $6(t), _ = Buffer.from(f).toString("hex");
  if (!g.verify(_, { r: a, s: c }))
    throw new Error("Invalid signature");
  return fa(e).payload;
}
const G6 = "irn";
function Ys(e) {
  return e?.relay || { protocol: G6 };
}
function Kn(e) {
  const t = D2[e];
  if (typeof t > "u")
...
var Y6 = Object.defineProperty, J6 = Object.defineProperties, Z6 = Object.getOwnPropertyDescriptors, kh = Object.getOwnPropertySymbols, X6 = Object.prototype.hasOwnProperty, Q6 = Object.prototype.propertyIsEnumerable, Lh = (e, t, i) => t in e ? Y6(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, Ch = (e, t) => {
  for (var i in t || (t = {}))
    X6.call(t, i) && Lh(e, i, t[i]);
  if (kh)
    for (var i of kh(t))
      Q6.call(t, i) && Lh(e, i, t[i]);
  return e;
}, ey = (e, t) => J6(e, Z6(t));
function ty(e, t = "-") {
  const i = {}, r = "relay" + t;
...
function qh(e) {
  ...
  const t = e.indexOf(":"), i = e.indexOf("?") !== -1 ? e.indexOf("?") : void 0, r = e.substring(0, t), n = e.substring(t + 1, i).split("@"), s = typeof i < "u" ? e.substring(i) : "", a = Yn.parse(s), c = typeof a.methods == "string" ? a.methods.split(",") : void 0;
  return { protocol: r, topic: iy(n[0]), version: parseInt(n[1], 10), symKey: a.symKey, relay: ty(a), methods: c, expiryTimestamp: a.expiryTimestamp ? parseInt(a.expiryTimestamp, 10) : void 0 };
}
function iy(e) {
...
function jh(e) {
  return `${e.protocol}:${e.topic}@${e.version}?` + Yn.stringify(Ch(ey(Ch({ symKey: e.symKey }, ry(e.relay)), { expiryTimestamp: e.expiryTimestamp }), e.methods ? { methods: e.methods.join(",") } : {}));
}
function Es(e, t, i) {
...
function zh(e, t) {
  ...
  for (const [r, n] of Object.entries(i))
    n.methods ? n.methods = o6(n.methods, e) : n.methods = e, n.events = ["chainChanged", "accountsChanged"];
  return i;
}
...
function ne(e, t) {
  const { message: i, code: r } = hy[e];
  return { message: t ? `${i} ${t}` : i, code: r };
}
function nt(e, t) {
  const { message: i, code: r } = cy[e];
  return { message: t ? `${i} ${t}` : i, code: r };
}
function Io(e, t) {
...
function fy(e, t) {
  ...
  return jr(n, r) ? (r.forEach((a) => {
    const { accounts: c, methods: d, events: f } = e.namespaces[a], g = Mn(c), _ = i[a];
...
function Uh(e) {
  let t = !0;
  return Io(e) ? e.length && (t = e.every((i) => gt(i, !1))) : t = !1, t;
}
function by(e, t, i) {
  let r = null;
  return Io(t) && t.length ? t.forEach((n) => {
...
function my(e, t, i) {
  ...
  return Object.entries(e).forEach(([n, s]) => {
    if (r)
      return;
    const a = by(n, Wa(n, s), `${t} ${i}`);
    a && (r = a);
  }), r;
}
function yy(e, t) {
  let i = null;
  return Io(e) ? e.forEach((r) => {
    i || uy(r) || (i = nt("UNSUPPORTED_ACCOUNTS", `${t}, account ${r} should be a string and conform to "namespace:chainId:address" format`));
...
function vy(e, t) {
  ...
  return Object.values(e).forEach((r) => {
    if (i)
      return;
    const n = yy(r?.accounts, `${t} namespace`);
    n && (i = n);
  }), i;
}
function wy(e, t) {
  let i = null;
  return Uh(e?.methods) ? Uh(e?.events) || (i = nt("UNSUPPORTED_EVENTS", `${t}, events should be an array of strings or empty array for no events`)) : i = nt("UNSUPPORTED_METHODS", `${t}, methods should be an array of strings or empty array for no methods`), i;
}
function pd(e, t) {
  let i = null;
  return Object.values(e).forEach((r) => {
...
function Ey(e, t) {
  let i = !1;
  return t && !e ? i = !0 : e && Io(e) && e.length && e.forEach((r) => {
    i = gd(r);
  }), i;
}
function Sy(e) {
...
function Dh(e, t) {
  return !(!Zs(t) || !ny(e).includes(t));
}
function Oy(e, t, i) {
  return gt(i, !1) ? sy(e, t).includes(i) : !1;
}
function Py(e, t, i) {
  return gt(i, !1) ? oy(e, t).includes(i) : !1;
}
function Fh(e, t, i) {
  let r = null;
  const n = Ny(e), s = Ry(t), a = Object.keys(n), c = Object.keys(s), d = Kh(Object.keys(e)), f = Kh(Object.keys(t)), g = d.filter((_) => !f.includes(_));
  return g.length && (r = ne("NON_CONFORMING_NAMESPACES", `${i} namespaces keys don't satisfy requiredNamespaces.
      Required: ${g.toString()}
      Received: ${Object.keys(t).toString()}`)), jr(a, c) || (r = ne("NON_CONFORMING_NAMESPACES", `${i} namespaces chains don't satisfy required namespaces.
      Required: ${a.toString()}
      Approved: ${c.toString()}`)), Object.keys(t).forEach((_) => {
    if (!_.includes(":") || r)
      return;
...
async function Ly() {
  return Ar() && typeof global < "u" && global != null && global.NetInfo ? (await (global == null ? void 0 : global.NetInfo.fetch()))?.isConnected : !0;
}
function Cy() {
  return !0;
}
...
function jy(e) {
  !Ar() && cs() && (window.addEventListener("online", () => e(!0)), window.addEventListener("offline", () => e(!1)));
}
function zy(e) {
  Ar() && typeof global < "u" && global != null && global.NetInfo && global?.NetInfo.addEventListener((t) => e(t?.isConnected));
}
const Jo = {};
class qn {
  static get(t) {
...
const Uy = "PARSE_ERROR", Dy = "INVALID_REQUEST", Fy = "METHOD_NOT_FOUND", Ky = "INVALID_PARAMS", bd = "INTERNAL_ERROR", Xa = "SERVER_ERROR", By = [-32700, -32600, -32601, -32602, -32603], $n = {
  [Uy]: { code: -32700, message: "Parse error" },
  [Dy]: { code: -32600, message: "Invalid Request" },
  [Fy]: { code: -32601, message: "Method not found" },
  [Ky]: { code: -32602, message: "Invalid params" },
...
function Wy() {
  if (Vh)
    return ir;
  Vh = 1, Object.defineProperty(ir, "__esModule", { value: !0 }), ir.isBrowserCryptoAvailable = ir.getSubtleCrypto = ir.getBrowerCrypto = void 0;
  function e() {
    return (ti === null || ti === void 0 ? void 0 : ti.crypto) || (ti === null || ti === void 0 ? void 0 : ti.msCrypto) || {};
  }
  ir.getBrowerCrypto = e;
  function t() {
    const r = e();
    return r.subtle || r.webkitSubtle;
  }
  ir.getSubtleCrypto = t;
  function i() {
    return !!e() && !!t();
  }
  return ir.isBrowserCryptoAvailable = i, ir;
}
var rr = {}, Hh;
function Gy() {
  if (Hh)
    return rr;
  Hh = 1, Object.defineProperty(rr, "__esModule", { value: !0 }), rr.isBrowser = rr.isNode = rr.isReactNative = void 0;
  function e() {
  ...
  return rr.isBrowser = i, rr;
}
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  const t = Xn;
  t.__exportStar(Wy(), e), t.__exportStar(Gy(), e);
})(yd);
function or(e = 3) {
...
function Yy(e, t) {
  return typeof e > "u" ? $h(bd) : (typeof e == "string" && (e = Object.assign(Object.assign({}, $h(Xa)), { message: e })), typeof t < "u" && (e.data = t), $y(e.code) && (e = Vy(e.code)), e);
}
class vd {
}
...
class _d extends Xy {
  ...
  onPayload(t) {
    this.events.emit("payload", t), xo(t) ? this.events.emit(`${t.id}`, t) : this.events.emit("message", { type: t.method, data: t.params });
  }
  onClose(t) {
...
const r3 = () => typeof WebSocket < "u" ? WebSocket : typeof global < "u" && typeof global.WebSocket < "u" ? global.WebSocket : typeof window < "u" && typeof window.WebSocket < "u" ? window.WebSocket : typeof self < "u" && typeof self.WebSocket < "u" ? self.WebSocket : require("ws"), n3 = () => typeof WebSocket < "u" || typeof global < "u" && typeof global.WebSocket < "u" || typeof window < "u" && typeof window.WebSocket < "u" || typeof self < "u" && typeof self.WebSocket < "u", Gh = (e) => e.split("?")[0], Yh = 10, s3 = r3();
class o3 {
  constructor(t) {
    if (this.url = t, this.events = new ri.EventEmitter(), this.registering = !1, !Wh(t))
  ...
  register(t = this.url) {
    ...
    return this.url = t, this.registering = !0, new Promise((i, r) => {
      const n = yd.isReactNative() ? void 0 : { rejectUnauthorized: !i3(t) }, s = new s3(t, [], n);
      n3() ? s.onerror = (a) => {
        const c = a;
  ...
  onError(t, i) {
    const r = this.parseError(i), n = r.message || r.toString(), s = Ao(t, n);
  ...
  resetMaxListeners() {
    this.events.getMaxListeners() > Yh && this.events.setMaxListeners(Yh);
  }
  emitError(t) {
    const i = this.parseError(new Error(t?.message || `WebSocket connection failed for host: ${Gh(this.url)}`));
...
Xs.exports;
(function(e, t) {
  var i = 200, r = "__lodash_hash_undefined__", n = 1, s = 2, a = 9007199254740991, c = "[object Arguments]", d = "[object Array]", f = "[object AsyncFunction]", g = "[object Boolean]", _ = "[object Date]", x = "[object Error]", A = "[object Function]", O = "[object GeneratorFunction]", j = "[object Map]", F = "[object Number]", V = "[object Null]", C = "[object Object]", K = "[object Promise]", N = "[object Proxy]", U = "[object RegExp]", D = "[object Set]", v = "[object String]", T = "[object Symbol]", Y = "[object Undefined]", Q = "[object WeakMap]", p = "[object ArrayBuffer]", S = "[object DataView]", o = "[object Float32Array]", h = "[object Float64Array]", l = "[object Int8Array]", E = "[object Int16Array]", I = "[object Int32Array]", w = "[object Uint8Array]", u = "[object Uint8ClampedArray]", m = "[object Uint16Array]", b = "[object Uint32Array]", P = /[\\^$.*+?()[\]{}|]/g, B = /^\[object .+?Constructor\]$/, G = /^(?:0|[1-9]\d*)$/, M = {};
  M[o] = M[h] = M[l] = M[E] = M[I] = M[w] = M[u] = M[m] = M[b] = !0, M[c] = M[d] = M[p] = M[g] = M[S] = M[_] = M[x] = M[A] = M[j] = M[F] = M[C] = M[U] = M[D] = M[v] = M[Q] = !1;
  ...
  function oe(z, H) {
    for (var X = -1, ye = z == null ? 0 : z.length, ct = 0, Ge = []; ++X < ye; ) {
      var ut = z[X];
      H(ut, X, z) && (Ge[ct++] = ut);
    }
    return Ge;
  ...
  function Ee(z, H) {
    for (var X = -1, ye = H.length, ct = z.length; ++X < ye; )
      z[ct + X] = H[X];
    return z;
  }
  function ce(z, H) {
  ...
  function ve(z) {
    ...
    return z.forEach(function(ye, ct) {
      X[++H] = [ct, ye];
    }), X;
  }
  function ie(z, H) {
  ...
  ), Ae = R ? k.Buffer : void 0, he = k.Symbol, We = k.Uint8Array, Ye = fe.propertyIsEnumerable, xe = pe.splice, $e = he ? he.toStringTag : void 0, Xe = Object.getOwnPropertySymbols, Oe = Ae ? Ae.isBuffer : void 0, et = ie(Object.keys, Object), Te = Xr(k, "DataView"), le = Xr(k, "Map"), ke = Xr(k, "Promise"), Le = Xr(k, "Set"), be = Xr(k, "WeakMap"), Ne = Xr(Object, "create"), ze = xr(Te), we = xr(le), Ue = xr(ke), De = xr(Le), _e = xr(be), qe = he ? he.prototype : void 0, Ce = qe ? qe.valueOf : void 0;
  function de(z) {
  ...
  bt.prototype.clear = Hi, bt.prototype.delete = Wi, bt.prototype.get = Gi, bt.prototype.has = Yi, bt.prototype.set = Ji;
  function ai(z) {
    var H = -1, X = z == null ? 0 : z.length;
  ...
  ai.prototype.add = ai.prototype.push = Zi, ai.prototype.has = Xi;
  function Lt(z) {
  ...
  Lt.prototype.clear = Qi, Lt.prototype.delete = er, Lt.prototype.get = An, Lt.prototype.has = xn, Lt.prototype.set = Fd;
  function Kd(z, H) {
    var X = gs(z), ye = !X && rl(z), ct = !X && !ye && Ro(z), Ge = !X && !ye && !ct && hc(z), ut = X || ye || ct || Ge, vt = ut ? Re(z.length, String) : [], Pt = vt.length;
    for (var ft in z)
      (H || ue.call(z, ft)) && !(ut && // Safari 9 has enumerable `arguments.length` in strict mode.
      (ft == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
      ct && (ft == "offset" || ft == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
  ...
  function ic(z, H, X, ye, ct) {
    return z === H ? !0 : z == null || H == null || !Pn(z) && !Pn(H) ? z !== z && H !== H : $d(z, H, X, ye, ic, ct);
  }
  function $d(z, H, X, ye, ct, Ge) {
    var ut = gs(z), vt = gs(H), Pt = ut ? d : lr(z), ft = vt ? d : lr(H);
    Pt = Pt == c ? C : Pt, ft = ft == c ? C : ft;
    var Qt = Pt == C, vi = ft == C, Ct = Pt == ft;
    if (Ct && Ro(z)) {
      if (!Ro(H))
        return !1;
      ut = !0, Qt = !1;
    ...
    if (Ct && !Qt)
      return Ge || (Ge = new Lt()), ut || hc(z) ? rc(z, H, X, ye, ct, Ge) : Gd(z, H, Pt, X, ye, ct, Ge);
    if (!(X & n)) {
      var ci = Qt && ue.call(z, "__wrapped__"), hi = vi && ue.call(H, "__wrapped__");
      if (ci || hi) {
        var pr = ci ? z.value() : z, tr = hi ? H.value() : H;
        return Ge || (Ge = new Lt()), ct(pr, tr, X, ye, Ge);
      }
    }
    return Ct ? (Ge || (Ge = new Lt()), Yd(z, H, X, ye, ct, Ge)) : !1;
  }
  function Vd(z) {
    if (!cc(z) || el(z))
      return !1;
  ...
  function Hd(z) {
    return Pn(z) && ac(z.length) && !!M[On(z)];
  }
  function Wd(z) {
    if (!tl(z))
      return et(z);
  ...
  function rc(z, H, X, ye, ct, Ge) {
    ...
    if (ft && Ge.get(H))
      return ft == H;
    var Qt = -1, vi = !0, Ct = X & s ? new ai() : void 0;
    for (Ge.set(z, H), Ge.set(H, z); ++Qt < vt; ) {
      var ci = z[Qt], hi = H[Qt];
      if (ye)
        var pr = ut ? ye(hi, ci, Qt, H, z, Ge) : ye(ci, hi, Qt, z, H, Ge);
      if (pr !== void 0) {
        if (pr)
          continue;
        vi = !1;
      ...
      if (Ct) {
        if (!ce(H, function(tr, Or) {
          if (!se(Ct, Or) && (ci === tr || ct(ci, tr, X, ye, Ge)))
            return Ct.push(Or);
        })) {
          vi = !1;
          break;
        }
      } else if (!(ci === hi || ct(ci, hi, X, ye, Ge))) {
        vi = !1;
        break;
      }
    }
    ...
    switch (X) {
      ...
      case D:
        ...
        if (ft)
          return ft == H;
        ye |= s, ut.set(z, H);
        var Qt = rc(vt(z), vt(H), ye, ct, Ge, ut);
        return ut.delete(z), Qt;
      case T:
        if (Ce)
  ...
  function Yd(z, H, X, ye, ct, Ge) {
    var ut = X & n, vt = nc(z), Pt = vt.length, ft = nc(H), Qt = ft.length;
    if (Pt != Qt && !ut)
      return !1;
    for (var vi = Pt; vi--; ) {
      var Ct = vt[vi];
    ...
    for (var pr = ut; ++vi < Pt; ) {
      ...
      var tr = z[Ct], Or = H[Ct];
      if (ye)
        var fc = ut ? ye(Or, tr, Ct, H, z, Ge) : ye(tr, Or, Ct, z, H, Ge);
      if (!(fc === void 0 ? tr === Or || ct(tr, Or, X, ye, Ge) : fc)) {
        hi = !1;
        break;
      }
      pr || (pr = Ct == "constructor");
    }
    if (hi && !pr) {
      var bs = z.constructor, ms = H.constructor;
      bs != ms && "constructor" in z && "constructor" in H && !(typeof bs == "function" && bs instanceof bs && typeof ms == "function" && ms instanceof ms) && (hi = !1);
    }
    return Ge.delete(z), Ge.delete(H), hi;
  }
  function nc(z) {
    return Bd(z, ol, Zd);
  }
  ...
  function Jd(z) {
    ...
    var ct = ae.call(z);
    return ye && (H ? z[$e] = X : delete z[$e]), ct;
  }
  ...
  (Te && lr(new Te(new ArrayBuffer(1))) != S || le && lr(new le()) != j || ke && lr(ke.resolve()) != K || Le && lr(new Le()) != D || be && lr(new be()) != Q) && (lr = function(z) {
  ...
  function nl(z) {
    return z != null && ac(z.length) && !oc(z);
  }
  var Ro = Oe || cl;
  function sl(z, H) {
    return ic(z, H);
...
var a3 = Xs.exports;
const c3 = /* @__PURE__ */ gn(a3), Ed = "wc", Sd = 2, Qs = "core", Bi = `${Ed}@2:${Qs}:`, h3 = { name: Qs, logger: "error" }, f3 = { database: ":memory:" }, u3 = "crypto", Jh = "client_ed25519_seed", d3 = te.ONE_DAY, l3 = "keychain", p3 = "0.3", g3 = "messages", b3 = "0.3", Zh = te.SIX_HOURS, m3 = "publisher", Id = "irn", y3 = "error", Md = "wss://relay.walletconnect.org", v3 = "relayer", Et = { message: "relayer_message", message_ack: "relayer_message_ack", connect: "relayer_connect", disconnect: "relayer_disconnect", error: "relayer_error", connection_stalled: "relayer_connection_stalled", transport_closed: "relayer_transport_closed", publish: "relayer_publish" }, w3 = "_subscription", fi = { payload: "payload", connect: "connect", disconnect: "disconnect", error: "error" }, _3 = 0.1, Ea = "2.17.3", st = { link_mode: "link_mode", relay: "relay" }, E3 = "0.3", S3 = "WALLETCONNECT_CLIENT_ID", Xh = "WALLETCONNECT_LINK_MODE_APPS", ei = { created: "subscription_created", deleted: "subscription_deleted", expired: "subscription_expired", disabled: "subscription_disabled", sync: "subscription_sync", resubscribed: "subscription_resubscribed" }, I3 = "subscription", M3 = "0.3", A3 = te.FIVE_SECONDS * 1e3, x3 = "pairing", O3 = "0.3", jn = { wc_pairingDelete: { req: { ttl: te.ONE_DAY, prompt: !1, tag: 1e3 }, res: { ttl: te.ONE_DAY, prompt: !1, tag: 1001 } }, wc_pairingPing: { req: { ttl: te.THIRTY_SECONDS, prompt: !1, tag: 1002 }, res: { ttl: te.THIRTY_SECONDS, prompt: !1, tag: 1003 } }, unregistered_method: { req: { ttl: te.ONE_DAY, prompt: !1, tag: 0 }, res: { ttl: te.ONE_DAY, prompt: !1, tag: 0 } } }, qr = { create: "pairing_create", expire: "pairing_expire", delete: "pairing_delete", ping: "pairing_ping" }, _i = { created: "history_created", updated: "history_updated", deleted: "history_deleted", sync: "history_sync" }, P3 = "history", N3 = "0.3", R3 = "expirer", ui = { created: "expirer_created", deleted: "expirer_deleted", expired: "expirer_expired", sync: "expirer_sync" }, T3 = "0.3", k3 = "verify-api", L3 = "https://verify.walletconnect.com", Ad = "https://verify.walletconnect.org", Vn = Ad, C3 = `${Vn}/v3`, q3 = [L3, Ad], j3 = "echo", z3 = "https://echo.walletconnect.com", Ni = { pairing_started: "pairing_started", pairing_uri_validation_success: "pairing_uri_validation_success", pairing_uri_not_expired: "pairing_uri_not_expired", store_new_pairing: "store_new_pairing", subscribing_pairing_topic: "subscribing_pairing_topic", subscribe_pairing_topic_success: "subscribe_pairing_topic_success", existing_pairing: "existing_pairing", pairing_not_expired: "pairing_not_expired", emit_inactive_pairing: "emit_inactive_pairing", emit_session_proposal: "emit_session_proposal", subscribing_to_pairing_topic: "subscribing_to_pairing_topic" }, sr = { no_wss_connection: "no_wss_connection", no_internet_connection: "no_internet_connection", malformed_pairing_uri: "malformed_pairing_uri", active_pairing_already_exists: "active_pairing_already_exists", subscribe_pairing_topic_failure: "subscribe_pairing_topic_failure", pairing_expired: "pairing_expired", proposal_expired: "proposal_expired", proposal_listener_not_found: "proposal_listener_not_found" }, Ei = { session_approve_started: "session_approve_started", proposal_not_expired: "proposal_not_expired", session_namespaces_validation_success: "session_namespaces_validation_success", create_session_topic: "create_session_topic", subscribing_session_topic: "subscribing_session_topic", subscribe_session_topic_success: "subscribe_session_topic_success", publishing_session_approve: "publishing_session_approve", session_approve_publish_success: "session_approve_publish_success", store_session: "store_session", publishing_session_settle: "publishing_session_settle", session_settle_publish_success: "session_settle_publish_success" }, Rr = { no_internet_connection: "no_internet_connection", no_wss_connection: "no_wss_connection", proposal_expired: "proposal_expired", subscribe_session_topic_failure: "subscribe_session_topic_failure", session_approve_publish_failure: "session_approve_publish_failure", session_settle_publish_failure: "session_settle_publish_failure", session_approve_namespace_validation_failure: "session_approve_namespace_validation_failure", proposal_not_found: "proposal_not_found" }, Tr = { authenticated_session_approve_started: "authenticated_session_approve_started", authenticated_session_not_expired: "authenticated_session_not_expired", chains_caip2_compliant: "chains_caip2_compliant", chains_evm_compliant: "chains_evm_compliant", create_authenticated_session_topic: "create_authenticated_session_topic", cacaos_verified: "cacaos_verified", store_authenticated_session: "store_authenticated_session", subscribing_authenticated_session_topic: "subscribing_authenticated_session_topic", subscribe_authenticated_session_topic_success: "subscribe_authenticated_session_topic_success", publishing_authenticated_session_approve: "publishing_authenticated_session_approve", authenticated_session_approve_publish_success: "authenticated_session_approve_publish_success" }, zn = { no_internet_connection: "no_internet_connection", no_wss_connection: "no_wss_connection", missing_session_authenticate_request: "missing_session_authenticate_request", session_authenticate_request_expired: "session_authenticate_request_expired", chains_caip2_compliant_failure: "chains_caip2_compliant_failure", chains_evm_compliant_failure: "chains_evm_compliant_failure", invalid_cacao: "invalid_cacao", subscribe_authenticated_session_topic_failure: "subscribe_authenticated_session_topic_failure", authenticated_session_approve_publish_failure: "authenticated_session_approve_publish_failure", authenticated_session_pending_request_not_found: "authenticated_session_pending_request_not_found" }, U3 = 0.1, D3 = "event-client", F3 = 86400, K3 = "https://pulse.walletconnect.org/batch";
function B3(e, t) {
  if (e.length >= 255)
    throw new TypeError("Alphabet too long");
  for (var i = new Uint8Array(256), r = 0; r < i.length; r++)
...
const xd = (e) => {
  ...
  if (ArrayBuffer.isView(e))
    return new Uint8Array(e.buffer, e.byteOffset, e.byteLength);
  throw new Error("Unknown type, must be binary type");
}, H3 = (e) => new TextEncoder().encode(e), W3 = (e) => new TextDecoder().decode(e);
class G3 {
  constructor(t, i, r) {
    this.name = t, this.prefix = i, this.baseEncode = r;
  }
...
class Z3 {
  constructor(t, i, r, n) {
    this.name = t, this.prefix = i, this.baseEncode = r, this.baseDecode = n, this.encoder = new G3(t, i, r), this.decoder = new Y3(t, i, n);
  }
  encode(t) {
    return this.encoder.encode(t);
  }
...
const Oo = ({ name: e, prefix: t, encode: i, decode: r }) => new Z3(e, t, i, r), ds = ({ prefix: e, name: t, alphabet: i }) => {
  const { encode: r, decode: n } = V3(i, t);
  return Oo({ prefix: e, name: t, encode: r, decode: (s) => xd(n(s)) });
}, X3 = (e, t, i, r) => {
  const n = {};
  for (let g = 0; g < t.length; ++g)
    n[t[g]] = g;
  ...
  if (a && (s += t[n & c << i - a]), r)
    for (; s.length * i & 7; )
      s += "=";
  return s;
}, kt = ({ name: e, prefix: t, bitsPerChar: i, alphabet: r }) => Oo({ prefix: t, name: e, encode(n) {
  return Q3(n, r, i);
}, decode(n) {
  return X3(n, r, i, e);
} }), e5 = Oo({ prefix: "\0", name: "identity", encode: (e) => W3(e), decode: (e) => H3(e) });
var t5 = Object.freeze({ __proto__: null, identity: e5 });
const i5 = kt({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 });
var r5 = Object.freeze({ __proto__: null, base2: i5 });
const n5 = kt({ prefix: "7", name: "base8", alphabet: "01234567", bitsPerChar: 3 });
var s5 = Object.freeze({ __proto__: null, base8: n5 });
const o5 = ds({ prefix: "9", name: "base10", alphabet: "0123456789" });
var a5 = Object.freeze({ __proto__: null, base10: o5 });
const c5 = kt({ prefix: "f", name: "base16", alphabet: "0123456789abcdef", bitsPerChar: 4 }), h5 = kt({ prefix: "F", name: "base16upper", alphabet: "0123456789ABCDEF", bitsPerChar: 4 });
var f5 = Object.freeze({ __proto__: null, base16: c5, base16upper: h5 });
const u5 = kt({ prefix: "b", name: "base32", alphabet: "abcdefghijklmnopqrstuvwxyz234567", bitsPerChar: 5 }), d5 = kt({ prefix: "B", name: "base32upper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567", bitsPerChar: 5 }), l5 = kt({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 }), p5 = kt({ prefix: "C", name: "base32padupper", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567=", bitsPerChar: 5 }), g5 = kt({ prefix: "v", name: "base32hex", alphabet: "0123456789abcdefghijklmnopqrstuv", bitsPerChar: 5 }), b5 = kt({ prefix: "V", name: "base32hexupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV", bitsPerChar: 5 }), m5 = kt({ prefix: "t", name: "base32hexpad", alphabet: "0123456789abcdefghijklmnopqrstuv=", bitsPerChar: 5 }), y5 = kt({ prefix: "T", name: "base32hexpadupper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUV=", bitsPerChar: 5 }), v5 = kt({ prefix: "h", name: "base32z", alphabet: "ybndrfg8ejkmcpqxot1uwisza345h769", bitsPerChar: 5 });
var w5 = Object.freeze({ __proto__: null, base32: u5, base32upper: d5, base32pad: l5, base32padupper: p5, base32hex: g5, base32hexupper: b5, base32hexpad: m5, base32hexpadupper: y5, base32z: v5 });
const _5 = ds({ prefix: "k", name: "base36", alphabet: "0123456789abcdefghijklmnopqrstuvwxyz" }), E5 = ds({ prefix: "K", name: "base36upper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ" });
var S5 = Object.freeze({ __proto__: null, base36: _5, base36upper: E5 });
const I5 = ds({ name: "base58btc", prefix: "z", alphabet: "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz" }), M5 = ds({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
var A5 = Object.freeze({ __proto__: null, base58btc: I5, base58flickr: M5 });
const x5 = kt({ prefix: "m", name: "base64", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", bitsPerChar: 6 }), O5 = kt({ prefix: "M", name: "base64pad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", bitsPerChar: 6 }), P5 = kt({ prefix: "u", name: "base64url", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bitsPerChar: 6 }), N5 = kt({ prefix: "U", name: "base64urlpad", alphabet: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=", bitsPerChar: 6 });
var R5 = Object.freeze({ __proto__: null, base64: x5, base64pad: O5, base64url: P5, base64urlpad: N5 });
const Pd = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂"), T5 = Pd.reduce((e, t, i) => (e[i] = t, e), []), k5 = Pd.reduce((e, t, i) => (e[t.codePointAt(0)] = i, e), []);
function L5(e) {
  return e.reduce((t, i) => (t += T5[i], t), "");
}
function C5(e) {
  const t = [];
  for (const i of e) {
    const r = k5[i.codePointAt(0)];
    if (r === void 0)
      throw new Error(`Non-base256emoji character: ${i}`);
    t.push(r);
  }
...
const q5 = Oo({ prefix: "🚀", name: "base256emoji", encode: L5, decode: C5 });
var j5 = Object.freeze({ __proto__: null, base256emoji: q5 }), z5 = Nd, Qh = 128, U5 = 127, D5 = ~U5, F5 = Math.pow(2, 31);
function Nd(e, t, i) {
  t = t || [], i = i || 0;
  for (var r = i; e >= F5; )
    t[i++] = e & 255 | Qh, e /= 128;
...
var K5 = Sa, B5 = 128, ef = 127;
function Sa(e, r) {
  var i = 0, r = r || 0, n = 0, s = r, a, c = e.length;
  do {
    if (s >= c)
...
var $5 = Math.pow(2, 7), V5 = Math.pow(2, 14), H5 = Math.pow(2, 21), W5 = Math.pow(2, 28), G5 = Math.pow(2, 35), Y5 = Math.pow(2, 42), J5 = Math.pow(2, 49), Z5 = Math.pow(2, 56), X5 = Math.pow(2, 63), Q5 = function(e) {
  return e < $5 ? 1 : e < V5 ? 2 : e < H5 ? 3 : e < W5 ? 4 : e < G5 ? 5 : e < Y5 ? 6 : e < J5 ? 7 : e < Z5 ? 8 : e < X5 ? 9 : 10;
}, ev = { encode: z5, decode: K5, encodingLength: Q5 }, Rd = ev;
const tf = (e, t, i = 0) => (Rd.encode(e, t, i), t), rf = (e) => Rd.encodingLength(e), Ia = (e, t) => {
  ...
  return tf(e, s, 0), tf(i, s, r), s.set(t, n), new tv(e, i, t, s);
};
class tv {
  constructor(t, i, r, n) {
...
const Td = ({ name: e, code: t, encode: i }) => new iv(e, t, i);
class iv {
  constructor(t, i, r) {
...
const kd = (e) => async (t) => new Uint8Array(await crypto.subtle.digest(e, t)), rv = Td({ name: "sha2-256", code: 18, encode: kd("SHA-256") }), nv = Td({ name: "sha2-512", code: 19, encode: kd("SHA-512") });
var sv = Object.freeze({ __proto__: null, sha256: rv, sha512: nv });
const Ld = 0, ov = "identity", Cd = xd, av = (e) => Ia(Ld, Cd(e)), cv = { code: Ld, name: ov, encode: Cd, digest: av };
var hv = Object.freeze({ __proto__: null, identity: cv });
new TextEncoder(), new TextDecoder();
const nf = { ...t5, ...r5, ...s5, ...a5, ...f5, ...w5, ...S5, ...A5, ...R5, ...j5 };
({ ...sv, ...hv });
function fv(e = 0) {
  return globalThis.Buffer != null && globalThis.Buffer.allocUnsafe != null ? globalThis.Buffer.allocUnsafe(e) : new Uint8Array(e);
}
...
const sf = qd("utf8", "u", (e) => "u" + new TextDecoder("utf8").decode(e), (e) => new TextEncoder().encode(e.substring(1))), Zo = qd("ascii", "a", (e) => {
  let t = "a";
  for (let i = 0; i < e.length; i++)
    t += String.fromCharCode(e[i]);
  return t;
  ...
  for (let i = 0; i < e.length; i++)
    t[i] = e.charCodeAt(i);
  return t;
}), uv = { utf8: sf, "utf-8": sf, hex: nf.base16, latin1: Zo, ascii: Zo, binary: Zo, ...nf };
function dv(e, t = "utf8") {
  const i = uv[t];
  if (!i)
    throw new Error(`Unsupported encoding "${t}"`);
  return (t === "utf8" || t === "utf-8") && globalThis.Buffer != null && globalThis.Buffer.from != null ? globalThis.Buffer.from(e, "utf8") : i.decoder.decode(`${i.prefix}${e}`);
...
class lv {
  constructor(t, i) {
    this.core = t, this.logger = i, this.keychain = /* @__PURE__ */ new Map(), this.name = l3, this.version = p3, this.initialized = !1, this.storagePrefix = Bi, this.init = async () => {
      if (!this.initialized) {
...
class pv {
  constructor(t, i, r) {
    this.core = t, this.logger = i, this.name = u3, this.randomSessionIdentifier = _a(), this.initialized = !1, this.init = async () => {
      this.initialized || (await this.keychain.init(), this.initialized = !0);
    }, this.hasKeys = (n) => (this.isInitialized(), this.keychain.has(n)), this.getClientId = async () => {
      this.isInitialized();
      const n = await this.getClientSeed(), s = Dc(n);
      ...
      this.isInitialized();
      const s = await this.getClientSeed(), a = Dc(s), c = this.randomSessionIdentifier;
      return await eg(c, n, d3, a);
    }, this.generateSharedKey = (n, s, a) => {
      this.isInitialized();
      const c = this.getPrivateKey(n), d = z6(c, s);
      ...
      const c = ld(a), d = Fr(s);
      if (Th(c))
        return D6(d, a?.encoding);
      if (Rh(c)) {
        const x = c.senderPublicKey, A = c.receiverPublicKey;
        n = await this.generateSharedKey(x, A);
      }
      const f = this.getSymKey(n), { type: g, senderPublicKey: _ } = c;
      return U6({ type: g, symKey: f, message: d, senderPublicKey: _, encoding: a?.encoding });
    }, this.decode = async (n, s, a) => {
      this.isInitialized();
      const c = B6(s, a);
      if (Th(c)) {
        const d = K6(s, a?.encoding);
        return fn(d);
      }
      if (Rh(c)) {
        const d = c.receiverPublicKey, f = c.senderPublicKey;
        n = await this.generateSharedKey(d, f);
      }
      try {
        const d = this.getSymKey(n), f = F6({ symKey: d, encoded: s, encoding: a?.encoding });
        return fn(f);
      } catch (d) {
    ...
    }, this.core = t, this.logger = Ft(i, this.name), this.keychain = r || new lv(this.core, this.logger);
  }
  get context() {
    return Xt(this.logger);
  }
  ...
  async getClientSeed() {
    let t = "";
    try {
      t = this.keychain.get(Jh);
    } catch {
      t = _a(), await this.keychain.set(Jh, t);
    }
    return dv(t, "base16");
  }
  getSymKey(t) {
...
class gv extends sp {
  constructor(t, i) {
    super(t, i), this.logger = t, this.core = i, this.messages = /* @__PURE__ */ new Map(), this.name = g3, this.version = b3, this.initialized = !1, this.storagePrefix = Bi, this.init = async () => {
      if (!this.initialized) {
...
var bv = Object.defineProperty, mv = Object.defineProperties, yv = Object.getOwnPropertyDescriptors, of = Object.getOwnPropertySymbols, vv = Object.prototype.hasOwnProperty, wv = Object.prototype.propertyIsEnumerable, af = (e, t, i) => t in e ? bv(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, cf = (e, t) => {
  for (var i in t || (t = {}))
    vv.call(t, i) && af(e, i, t[i]);
  if (of)
    for (var i of of(t))
      wv.call(t, i) && af(e, i, t[i]);
  return e;
}, hf = (e, t) => mv(e, yv(t));
class _v extends op {
  constructor(t, i) {
    super(t, i), this.relayer = t, this.logger = i, this.events = new ri.EventEmitter(), this.name = m3, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = te.toMiliseconds(te.ONE_MINUTE), this.initialPublishTimeout = te.toMiliseconds(te.ONE_SECOND * 15), this.needsTransportRestart = !1, this.publish = async (r, n, s) => {
      var a;
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: r, message: n, opts: s } });
      const c = s?.ttl || Zh, d = Ys(s), f = s?.prompt || !1, g = s?.tag || 0, _ = s?.id || zr().toString(), x = { topic: r, message: n, opts: { ttl: c, relay: d, prompt: f, tag: g, id: _, attestation: s?.attestation } }, A = `Failed to publish payload, please try again. id:${_} tag:${g}`;
      try {
        const O = new Promise(async (j) => {
          ...
          const V = yr(new Promise((C, K) => {
            this.rpcPublish({ topic: r, message: n, ttl: c, prompt: f, tag: g, id: _, attestation: s?.attestation }).then(C).catch((N) => {
          ...
          try {
            ...
            this.queue.set(_, hf(cf({}, x), { attempt: 1 })), this.logger.warn(C, C?.message);
          }
        });
  ...
  async rpcPublish(t) {
    var i, r, n, s;
    const { topic: a, message: c, ttl: d = Zh, prompt: f, tag: g, id: _, attestation: x } = t, A = { method: Kn(Ys().protocol).publish, params: { topic: a, message: c, ttl: d, prompt: f, tag: g, attestation: x }, id: _ };
  ...
  checkQueue() {
    this.queue.forEach(async (t, i) => {
      const r = t.attempt + 1;
      this.queue.set(i, hf(cf({}, t), { attempt: r }));
      const { topic: n, message: s, opts: a, attestation: c } = t;
      this.logger.warn({}, `Publisher: queue->publishing: ${t.opts.id}, tag: ${t.opts.tag}, attempt: ${r}`), await this.rpcPublish({ topic: n, message: s, ttl: a.ttl, prompt: a.prompt, tag: a.tag, id: a.id, attestation: c }), this.logger.warn({}, `Publisher: queue->published: ${t.opts.id}`);
    });
  }
  registerEventListeners() {
...
var Sv = Object.defineProperty, Iv = Object.defineProperties, Mv = Object.getOwnPropertyDescriptors, ff = Object.getOwnPropertySymbols, Av = Object.prototype.hasOwnProperty, xv = Object.prototype.propertyIsEnumerable, uf = (e, t, i) => t in e ? Sv(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, Un = (e, t) => {
  for (var i in t || (t = {}))
    Av.call(t, i) && uf(e, i, t[i]);
  if (ff)
    for (var i of ff(t))
      xv.call(t, i) && uf(e, i, t[i]);
  return e;
}, Xo = (e, t) => Iv(e, Mv(t));
class Ov extends hp {
  constructor(t, i) {
    super(t, i), this.relayer = t, this.logger = i, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new Ev(), this.events = new ri.EventEmitter(), this.name = I3, this.version = M3, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = !1, this.pendingSubscriptionWatchLabel = "pending_sub_watch_label", this.pollingInterval = 20, this.storagePrefix = Bi, this.subscribeTimeout = te.toMiliseconds(te.ONE_MINUTE), this.initialSubscribeTimeout = te.toMiliseconds(te.ONE_SECOND * 15), this.batchSubscribeTopicsLimit = 500, this.init = async () => {
      ...
      try {
        ...
        const c = await this.rpcSubscribe(r, s, n);
        return typeof c == "string" && (this.onSubscribe(c, a), this.logger.debug("Successfully Subscribed Topic"), this.logger.trace({ type: "method", method: "subscribe", params: { topic: r, opts: n } })), c;
      } catch (s) {
      ...
      return await new Promise((s, a) => {
        ...
        c.start(n);
        const d = setInterval(() => {
          (!this.pending.has(r) && this.topics.includes(r) || this.cached.some((f) => f.topic === r)) && (clearInterval(d), c.stop(n), s(!0)), c.elapsed(n) >= A3 && (clearInterval(d), c.stop(n), a(new Error("Subscription resolution timeout")));
  ...
  async rpcSubscribe(t, i, r) {
    ...
    try {
      const c = this.getSubscriptionId(t);
      if (r?.transportType === st.link_mode)
        ...
        }, te.toMiliseconds(te.ONE_SECOND)), c;
      const d = new Promise(async (g) => {
        const _ = (x) => {
          x.topic === t && (this.events.removeListener(ei.created, _), g(x.id));
        };
        this.events.on(ei.created, _);
        try {
          ...
          this.events.removeListener(ei.created, _), g(x);
        } catch {
        }
  ...
  async rpcBatchFetchMessages(t) {
    ...
    try {
      n = await await yr(new Promise((s, a) => {
        this.relayer.request(r).catch((c) => {
          this.logger.warn(c), a(c);
        }).then(s);
  ...
  onSubscribe(t, i) {
    this.setSubscription(t, Xo(Un({}, i), { id: t })), this.pending.delete(i.topic);
  }
  onBatchSubscribe(t) {
  ...
  addSubscription(t, i) {
    this.subscriptions.set(t, Un({}, i)), this.topicMap.set(i.topic, t), this.events.emit(ei.created, i);
  }
  getSubscription(t) {
  ...
  deleteSubscription(t, i) {
    ...
    this.subscriptions.delete(t), this.topicMap.delete(r.topic, t), this.events.emit(ei.deleted, Xo(Un({}, r), { reason: i }));
  }
  async persist() {
  ...
  async batchSubscribe(t) {
    t.length && (await this.rpcBatchSubscribe(t), this.onBatchSubscribe(t.map((i) => Xo(Un({}, i), { id: this.getSubscriptionId(i.topic) }))));
  }
  async batchFetchMessages(t) {
    ...
    i && i.messages && (await d6(te.toMiliseconds(te.ONE_SECOND)), await this.relayer.handleBatchMessageEvents(i.messages));
  }
  async onConnect() {
  ...
  getSubscriptionId(t) {
    return ar(t + this.clientId);
  }
}
var Pv = Object.defineProperty, df = Object.getOwnPropertySymbols, Nv = Object.prototype.hasOwnProperty, Rv = Object.prototype.propertyIsEnumerable, lf = (e, t, i) => t in e ? Pv(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, pf = (e, t) => {
  for (var i in t || (t = {}))
    Nv.call(t, i) && lf(e, i, t[i]);
  if (df)
    for (var i of df(t))
      Rv.call(t, i) && lf(e, i, t[i]);
  return e;
};
class Tv extends ap {
  constructor(t) {
    super(t), this.protocol = "wc", this.version = 2, this.events = new ri.EventEmitter(), this.name = v3, this.transportExplicitlyClosed = !1, this.initialized = !1, this.connectionAttemptInProgress = !1, this.hasExperiencedNetworkDisruption = !1, this.heartBeatTimeout = te.toMiliseconds(te.THIRTY_SECONDS + te.FIVE_SECONDS), this.requestsInFlight = [], this.connectTimeout = te.toMiliseconds(te.ONE_SECOND * 15), this.request = async (i) => {
      var r, n;
      ...
      try {
        ...
        return this.requestsInFlight = this.requestsInFlight.filter((d) => d !== a), c;
      } catch (a) {
    ...
    }, this.core = t.core, this.logger = typeof t.logger < "u" && typeof t.logger != "string" ? Ft(t.logger, this.name) : ro(xa({ level: t.logger || y3 })), this.messages = new gv(this.logger, t.core), this.subscriber = new Ov(this, this.logger), this.publisher = new _v(this, this.logger), this.relayUrl = t?.relayUrl || Md, this.projectId = t.projectId, X2() ? this.packageName = Eh() : Q2() && (this.bundleId = Eh()), this.provider = {};
  }
  async init() {
  ...
  async subscribe(t, i) {
    ...
    let c = ((s = this.subscriber.topicMap.get(t)) == null ? void 0 : s[0]) || "", d;
    const f = (g) => {
      g.topic === t && (this.subscriber.off(ei.created, f), d());
    };
    return await Promise.all([new Promise((g) => {
      d = g, this.subscriber.on(ei.created, f);
    }), new Promise(async (g, _) => {
      c = await this.subscriber.subscribe(t, pf({ internal: { throwOnFailedPublish: a } }, i)).catch((x) => {
        a && _(x);
      }) || c, g();
    })]), c;
  }
    ...
    for (; i < 6; ) {
      try {
        this.logger.debug({}, `Connecting to ${this.relayUrl}, attempt: ${i}...`), await this.createProvider(), await new Promise(async (r, n) => {
          ...
          this.provider.once(fi.disconnect, s), await yr(new Promise((a, c) => {
            this.provider.connect().then(a).catch(c);
            ...
            const d = () => {
              c(new Error("Connection interrupted while trying to subscribe"));
            };
            this.provider.once(fi.disconnect, d), await this.subscriber.start().then(a).catch(c).finally(() => {
  ...
  async createProvider() {
    ...
    this.provider = new _d(new o3(r6({ sdkVersion: Ea, protocol: this.protocol, version: this.version, relayUrl: this.relayUrl, projectId: this.projectId, auth: t, useOnCloseEvent: !0, bundleId: this.bundleId, packageName: this.packageName }))), this.registerProviderListeners();
  }
  ...
  async onProviderPayload(t) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: t }), Qa(t)) {
      if (!t.method.endsWith(w3))
        return;
      const i = t.params, { topic: r, message: n, publishedAt: s, attestation: a } = i.data, c = { topic: r, message: n, publishedAt: s, transportType: st.relay, attestation: a };
      this.logger.debug("Emitting Relayer Payload"), this.logger.trace(pf({ type: "event", event: i.id }, c)), this.events.emit(i.id, c), await this.acknowledgePayload(t), await this.onMessageEvent(c);
    } else
      xo(t) && this.events.emit(Et.message_ack, t);
  }
...
var kv = Object.defineProperty, gf = Object.getOwnPropertySymbols, Lv = Object.prototype.hasOwnProperty, Cv = Object.prototype.propertyIsEnumerable, bf = (e, t, i) => t in e ? kv(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, mf = (e, t) => {
  for (var i in t || (t = {}))
    Lv.call(t, i) && bf(e, i, t[i]);
  if (gf)
    for (var i of gf(t))
      Cv.call(t, i) && bf(e, i, t[i]);
  return e;
};
class Zr extends cp {
  constructor(t, i, r, n = Bi, s = void 0) {
    super(t, i, r, n), this.core = t, this.logger = i, this.name = r, this.map = /* @__PURE__ */ new Map(), this.version = E3, this.cached = [], this.initialized = !1, this.storagePrefix = Bi, this.recentlyDeleted = [], this.recentlyDeletedLimit = 200, this.init = async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach((a) => {
        this.getKey && a !== null && !Ut(a) ? this.map.set(this.getKey(a), a) : ly(a) ? this.map.set(a.id, a) : py(a) && this.map.set(a.topic, a);
      }), this.cached = [], this.initialized = !0);
    }, this.set = async (a, c) => {
      this.isInitialized(), this.map.has(a) ? await this.update(a, c) : (this.logger.debug("Setting value"), this.logger.trace({ type: "method", method: "set", key: a, value: c }), this.map.set(a, c), await this.persist());
    }, this.get = (a) => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({ type: "method", method: "get", key: a }), this.getData(a)), this.getAll = (a) => (this.isInitialized(), a ? this.values.filter((c) => Object.keys(a).every((d) => c3(c[d], a[d]))) : this.values), this.update = async (a, c) => {
      this.isInitialized(), this.logger.debug("Updating value"), this.logger.trace({ type: "method", method: "update", key: a, update: c });
      const d = mf(mf({}, this.getData(a)), c);
      this.map.set(a, d), await this.persist();
    }, this.delete = async (a, c) => {
      this.isInitialized(), this.map.has(a) && (this.logger.debug("Deleting value"), this.logger.trace({ type: "method", method: "delete", key: a, reason: c }), this.map.delete(a), this.addToRecentlyDeleted(a), await this.persist());
...
class qv {
  constructor(t, i) {
    this.core = t, this.logger = i, this.name = x3, this.version = O3, this.events = new jf(), this.initialized = !1, this.storagePrefix = Bi, this.ignoredPayloadTypes = [hr], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const n = _a(), s = await this.core.crypto.setSymKey(n), a = yt(te.FIVE_MINUTES), c = { protocol: Id }, d = { topic: s, expiry: a, relay: c, active: !1, methods: r?.methods }, f = jh({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: n, relay: c, expiryTimestamp: a, methods: r?.methods });
      ...
      const { topic: s, symKey: a, relay: c, expiryTimestamp: d, methods: f } = qh(r.uri);
      ...
      if (this.pairings.keys.includes(s)) {
        if (g = this.pairings.get(s), n.addTrace(Ni.existing_pairing), g.active)
          throw n.setError(sr.active_pairing_already_exists), new Error(`Pairing already exists: ${s}. Please try again with a new connection URI.`);
        n.addTrace(Ni.pairing_not_expired);
      }
      const _ = d || yt(te.FIVE_MINUTES), x = { topic: s, relay: c, expiry: _, active: !1, methods: f };
      ...
      try {
        ...
        n.setError(sr.no_internet_connection);
      }
      try {
        await this.core.relayer.subscribe(s, { relay: c });
      } catch (A) {
        throw n.setError(sr.subscribe_pairing_topic_failure), A;
      }
      ...
      if (this.pairings.keys.includes(n)) {
        const s = await this.sendRequest(n, "wc_pairingPing", {}), { done: a, resolve: c, reject: d } = Lr();
      ...
      this.isInitialized();
      const { topic: n, relay: s, expiry: a, methods: c } = r, d = this.core.crypto.keychain.get(n);
      return jh({ protocol: this.core.protocol, version: this.core.version, topic: n, symKey: d, relay: s, expiryTimestamp: a, methods: c });
    }, this.sendRequest = async (r, n, s) => {
      const a = Ur(n, s), c = await this.core.crypto.encode(r, a), d = jn[n].req;
      return this.core.history.set(r, a), this.core.relayer.publish(r, c, d), a.id;
    }, this.sendResult = async (r, n, s) => {
      const a = Mo(r, s), c = await this.core.crypto.encode(n, a), d = await this.core.history.get(n, r), f = jn[d.request.method].res;
      await this.core.relayer.publish(n, c, f), await this.core.history.resolve(a);
    }, this.sendError = async (r, n, s) => {
      const a = Ao(r, s), c = await this.core.crypto.encode(n, a), d = await this.core.history.get(n, r), f = jn[d.request.method] ? jn[d.request.method].res : jn.unregistered_method.res;
      await this.core.relayer.publish(n, c, f), await this.core.history.resolve(a);
      ...
      try {
        if (this.registeredMethods.includes(a))
          return;
        const c = nt("WC_METHOD_UNSUPPORTED", a);
      ...
      var s;
      if (!Gt(r)) {
        const { message: c } = ne("MISSING_OR_INVALID", `pair() params: ${r}`);
        throw n.setError(sr.malformed_pairing_uri), new Error(c);
      }
      if (!dy(r.uri)) {
        const { message: c } = ne("MISSING_OR_INVALID", `pair() uri: ${r.uri}`);
        throw n.setError(sr.malformed_pairing_uri), new Error(c);
      }
      const a = qh(r?.uri);
      if (!((s = a?.relay) != null && s.protocol)) {
        const { message: c } = ne("MISSING_OR_INVALID", "pair() uri#relay-protocol");
        throw n.setError(sr.malformed_pairing_uri), new Error(c);
      }
      if (!(a != null && a.symKey)) {
        const { message: c } = ne("MISSING_OR_INVALID", "pair() uri#symKey");
        throw n.setError(sr.malformed_pairing_uri), new Error(c);
      }
      if (a != null && a.expiryTimestamp && te.toMiliseconds(a?.expiryTimestamp) < Date.now()) {
        n.setError(sr.pairing_expired);
        const { message: c } = ne("EXPIRED", "pair() URI has expired. Please try again with a new connection URI.");
        throw new Error(c);
      }
  ...
  registerRelayerEvents() {
    this.core.relayer.on(Et.message, async (t) => {
      ...
      try {
        Qa(s) ? (this.core.history.set(i, s), this.onRelayEventRequest({ topic: i, payload: s })) : xo(s) && (await this.core.history.resolve(s), await this.onRelayEventResponse({ topic: i, payload: s }), this.core.history.delete(i, s.id));
      } catch (a) {
        this.logger.error(a);
      }
    });
...
class jv extends np {
  constructor(t, i) {
    super(t, i), this.core = t, this.logger = i, this.records = /* @__PURE__ */ new Map(), this.events = new ri.EventEmitter(), this.name = P3, this.version = N3, this.cached = [], this.initialized = !1, this.storagePrefix = Bi, this.init = async () => {
...
class zv extends fp {
  constructor(t, i) {
    super(t, i), this.core = t, this.logger = i, this.expirations = /* @__PURE__ */ new Map(), this.events = new ri.EventEmitter(), this.name = R3, this.version = T3, this.cached = [], this.initialized = !1, this.storagePrefix = Bi, this.init = async () => {
...
class Uv extends up {
  constructor(t, i, r) {
    super(t, i, r), this.core = t, this.logger = i, this.store = r, this.name = k3, this.verifyUrlV3 = C3, this.storagePrefix = Bi, this.version = Sd, this.init = async () => {
      var n;
      ...
      if (!cs() || this.isDevEnv)
        return;
      const s = window.location.origin, { id: a, decryptedId: c } = n, d = `${this.verifyUrlV3}/attestation?projectId=${this.core.projectId}&origin=${s}&id=${a}&decryptedId=${c}`;
      try {
            ...
            if (V.data && typeof V.data == "string")
              try {
                ...
                if (C.type === "verify_attestation") {
                  if (fa(C.attestation).payload.id !== a)
                    return;
      ...
      if (this.isDevEnv)
        return "";
      const { attestationId: s, hash: a, encryptedId: c } = n;
      if (s === "") {
        this.logger.debug("resolve: attestationId is empty, skipping");
        return;
      }
      if (s) {
        if (fa(s).payload.id !== c)
          return;
      ...
      const a = this.startAbortTimer(te.ONE_SECOND * 5), c = await fetch(`${s}/attestation/${n}?v2Supported=true`, { signal: this.abortController.signal });
      return clearTimeout(a), c.status === 200 ? await c.json() : void 0;
    }, this.getVerifyUrl = (n) => {
      let s = n || Vn;
      return q3.includes(s) || (this.logger.info(`verify url: ${s}, not included in trusted list, assigning default: ${Vn}`), s = Vn), s;
      ...
      try {
        ...
        this.logger.error(c), this.logger.warn("error validating attestation");
      }
      ...
      const a = W6(n, s.publicKey), c = { hasExpired: te.toMiliseconds(a.exp) < Date.now(), payload: a };
      if (c.hasExpired)
        throw this.logger.warn("resolve: jwt attestation expired"), new Error("JWT attestation expired");
      return { origin: c.payload.origin, isScam: c.payload.isScam, isVerified: c.payload.isVerified };
...
class Dv extends dp {
  constructor(t, i) {
    super(t, i), this.projectId = t, this.logger = i, this.context = j3, this.registerDeviceToken = async (r) => {
      const { clientId: n, token: s, notificationType: a, enableEncrypted: c = !1 } = r, d = `${z3}/${this.projectId}/clients`;
      await fetch(d, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ client_id: n, type: a, token: s, always_raw: c }) });
    }, this.logger = Ft(i, this.context);
  }
}
var Fv = Object.defineProperty, yf = Object.getOwnPropertySymbols, Kv = Object.prototype.hasOwnProperty, Bv = Object.prototype.propertyIsEnumerable, vf = (e, t, i) => t in e ? Fv(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, Dn = (e, t) => {
  for (var i in t || (t = {}))
    Kv.call(t, i) && vf(e, i, t[i]);
  if (yf)
    for (var i of yf(t))
      Bv.call(t, i) && vf(e, i, t[i]);
  return e;
};
class $v extends lp {
  constructor(t, i, r = !0) {
    super(t, i, r), this.core = t, this.logger = i, this.context = D3, this.storagePrefix = Bi, this.storageVersion = U3, this.events = /* @__PURE__ */ new Map(), this.shouldPersist = !1, this.init = async () => {
      if (!Ga())
        try {
          const n = { eventId: Ih(), timestamp: Date.now(), domain: this.getAppDomain(), props: { event: "INIT", type: "", properties: { client_id: await this.core.crypto.getClientId(), user_agent: td(this.core.relayer.protocol, this.core.relayer.version, Ea) } } };
          await this.sendEvent([n]);
        } catch (n) {
          this.logger.warn(n);
        }
    }, this.createEvent = (n) => {
      const { event: s = "ERROR", type: a = "", properties: { topic: c, trace: d } } = n, f = Ih(), g = this.core.projectId || "", _ = Date.now(), x = Dn({ eventId: f, timestamp: _, props: { event: s, type: a, properties: { topic: c, trace: d } }, bundleId: g, domain: this.getAppDomain() }, this.setMethods(f));
      return this.telemetryEnabled && (this.events.set(f, x), this.shouldPersist = !0), x;
    }, this.getEvent = (n) => {
      const { eventId: s, topic: a } = n;
      if (s)
        return this.events.get(s);
      const c = Array.from(this.events.values()).find((d) => d.props.properties.topic === a);
      if (c)
        return Dn(Dn({}, c), this.setMethods(c.eventId));
    }, this.deleteEvent = (n) => {
      const { eventId: s } = n;
      ...
      this.core.heartbeat.on(bn.pulse, async () => {
        this.shouldPersist && await this.persist(), this.events.forEach((n) => {
          te.fromMiliseconds(Date.now()) - te.fromMiliseconds(n.timestamp) > F3 && (this.events.delete(n.eventId), this.shouldPersist = !0);
        });
      });
      ...
      return await fetch(`${K3}?projectId=${this.core.projectId}&st=events_sdk&sv=js-${Ea}${s}`, { method: "POST", body: JSON.stringify(n) });
...
var Vv = Object.defineProperty, wf = Object.getOwnPropertySymbols, Hv = Object.prototype.hasOwnProperty, Wv = Object.prototype.propertyIsEnumerable, _f = (e, t, i) => t in e ? Vv(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, Ef = (e, t) => {
  for (var i in t || (t = {}))
    Hv.call(t, i) && _f(e, i, t[i]);
  if (wf)
    for (var i of wf(t))
      Wv.call(t, i) && _f(e, i, t[i]);
  return e;
};
let Gv = class jd extends rp {
  constructor(t) {
    var i;
    super(t), this.protocol = Ed, this.version = Sd, this.name = Qs, this.events = new ri.EventEmitter(), this.initialized = !1, this.on = (a, c) => this.events.on(a, c), this.once = (a, c) => this.events.once(a, c), this.off = (a, c) => this.events.off(a, c), this.removeListener = (a, c) => this.events.removeListener(a, c), this.dispatchEnvelope = ({ topic: a, message: c, sessionExists: d }) => {
      if (!a || !c)
        return;
      const f = { topic: a, message: c, publishedAt: Date.now(), transportType: st.link_mode };
    ...
    const r = xa({ level: typeof t?.logger == "string" && t.logger ? t.logger : h3.logger, name: Qs }), { logger: n, chunkLoggerController: s } = ip({ opts: r, maxSizeInBytes: t?.maxLogBlobSizeInBytes, loggerOverride: t?.logger });
    ...
    }), this.logger = Ft(n, this.name), this.heartbeat = new Gl(), this.crypto = new pv(this, this.logger, t?.keychain), this.history = new jv(this, this.logger), this.expirer = new zv(this, this.logger), this.storage = t != null && t.storage ? t.storage : new O0(Ef(Ef({}, f3), t?.storageOptions)), this.relayer = new Tv({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new qv(this, this.logger), this.verify = new Uv(this, this.logger, this.storage), this.echoClient = new Dv(this.projectId || "", this.logger), this.linkModeSupportedApps = [], this.eventClient = new $v(this, this.logger, t?.telemetryEnabled);
  }
  static async init(t) {
    const i = new jd(t);
    await i.initialize();
    const r = await i.crypto.getClientId();
    return await i.storage.setItem(S3, r), i;
  }
  get context() {
    return Xt(this.logger);
  }
  ...
  async addLinkModeSupportedApp(t) {
    this.linkModeSupportedApps.includes(t) || (this.linkModeSupportedApps.push(t), await this.storage.setItem(Xh, this.linkModeSupportedApps));
  }
  async initialize() {
    this.logger.trace("Initialized");
    try {
      await this.crypto.init(), await this.history.init(), await this.expirer.init(), await this.relayer.init(), await this.heartbeat.init(), await this.pairing.init(), this.eventClient.init(), this.linkModeSupportedApps = await this.storage.getItem(Xh) || [], this.initialized = !0, this.logger.info("Core Initialization Success");
    } catch (t) {
      throw this.logger.warn(`Core Initialization Failure at epoch ${Date.now()}`, t), this.logger.error(t.message), t;
    }
  }
};
const Yv = Gv, zd = "wc", Ud = 2, Dd = "client", ec = `${zd}@${Ud}:${Dd}:`, Qo = { name: Dd, logger: "error", controller: !1, relayUrl: "wss://relay.walletconnect.org" }, Sf = "WALLETCONNECT_DEEPLINK_CHOICE", Jv = "proposal", Zv = "Proposal expired", Xv = "session", nn = te.SEVEN_DAYS, Qv = "engine", wt = { wc_sessionPropose: { req: { ttl: te.FIVE_MINUTES, prompt: !0, tag: 1100 }, res: { ttl: te.FIVE_MINUTES, prompt: !1, tag: 1101 }, reject: { ttl: te.FIVE_MINUTES, prompt: !1, tag: 1120 }, autoReject: { ttl: te.FIVE_MINUTES, prompt: !1, tag: 1121 } }, wc_sessionSettle: { req: { ttl: te.FIVE_MINUTES, prompt: !1, tag: 1102 }, res: { ttl: te.FIVE_MINUTES, prompt: !1, tag: 1103 } }, wc_sessionUpdate: { req: { ttl: te.ONE_DAY, prompt: !1, tag: 1104 }, res: { ttl: te.ONE_DAY, prompt: !1, tag: 1105 } }, wc_sessionExtend: { req: { ttl: te.ONE_DAY, prompt: !1, tag: 1106 }, res: { ttl: te.ONE_DAY, prompt: !1, tag: 1107 } }, wc_sessionRequest: { req: { ttl: te.FIVE_MINUTES, prompt: !0, tag: 1108 }, res: { ttl: te.FIVE_MINUTES, prompt: !1, tag: 1109 } }, wc_sessionEvent: { req: { ttl: te.FIVE_MINUTES, prompt: !0, tag: 1110 }, res: { ttl: te.FIVE_MINUTES, prompt: !1, tag: 1111 } }, wc_sessionDelete: { req: { ttl: te.ONE_DAY, prompt: !1, tag: 1112 }, res: { ttl: te.ONE_DAY, prompt: !1, tag: 1113 } }, wc_sessionPing: { req: { ttl: te.ONE_DAY, prompt: !1, tag: 1114 }, res: { ttl: te.ONE_DAY, prompt: !1, tag: 1115 } }, wc_sessionAuthenticate: { req: { ttl: te.ONE_HOUR, prompt: !0, tag: 1116 }, res: { ttl: te.ONE_HOUR, prompt: !1, tag: 1117 }, reject: { ttl: te.FIVE_MINUTES, prompt: !1, tag: 1118 }, autoReject: { ttl: te.FIVE_MINUTES, prompt: !1, tag: 1119 } } }, ea = { min: te.FIVE_MINUTES, max: te.SEVEN_DAYS }, Pi = { idle: "IDLE", active: "ACTIVE" }, e8 = "request", t8 = ["wc_sessionPropose", "wc_sessionRequest", "wc_authRequest", "wc_sessionAuthenticate"], i8 = "wc", r8 = "auth", n8 = "authKeys", s8 = "pairingTopics", o8 = "requests", Po = `${i8}@${1.5}:${r8}:`, Ls = `${Po}:PUB_KEY`;
var a8 = Object.defineProperty, c8 = Object.defineProperties, h8 = Object.getOwnPropertyDescriptors, If = Object.getOwnPropertySymbols, f8 = Object.prototype.hasOwnProperty, u8 = Object.prototype.propertyIsEnumerable, Mf = (e, t, i) => t in e ? a8(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i, dt = (e, t) => {
  for (var i in t || (t = {}))
    f8.call(t, i) && Mf(e, i, t[i]);
  if (If)
    for (var i of If(t))
      u8.call(t, i) && Mf(e, i, t[i]);
  return e;
}, Si = (e, t) => c8(e, h8(t));
class d8 extends gp {
  constructor(t) {
    super(t), this.name = Qv, this.events = new jf(), this.initialized = !1, this.requestQueue = { state: Pi.idle, queue: [] }, this.sessionRequestQueue = { state: Pi.idle, queue: [] }, this.requestQueueDelay = te.ONE_SECOND, this.expectedPairingMethodMap = /* @__PURE__ */ new Map(), this.recentlyDeletedMap = /* @__PURE__ */ new Map(), this.recentlyDeletedLimit = 200, this.relayMessageCache = [], this.init = async () => {
      ...
      const { pairingTopic: n, requiredNamespaces: s, optionalNamespaces: a, sessionProperties: c, relays: d } = r;
      let f = n, g, _ = !1;
      try {
      ...
      const { id: c, relayProtocol: d, namespaces: f, sessionProperties: g, sessionConfig: _ } = i, x = this.client.proposal.get(c);
      ...
      try {
        ...
        }), V.addTrace(Ei.session_settle_publish_success), V.addTrace(Ei.publishing_session_approve), await this.sendResult({ id: c, topic: A, result: { relay: { protocol: d ?? "irn" }, responderPublicKey: C }, throwOnFailedPublish: !0 }).catch((T) => {
      ...
      return this.client.core.eventClient.deleteEvent({ eventId: V.eventId }), await this.client.core.pairing.updateMetadata({ topic: A, metadata: O.metadata }), await this.client.proposal.delete(c, nt("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: A }), await this.setExpiry(N, yt(nn)), { topic: N, acknowledged: () => Promise.resolve(this.client.session.get(N)) };
    }, this.reject = async (i) => {
      this.isInitialized(), await this.confirmOnlineStateOrThrow();
      try {
      ...
      const { topic: r, namespaces: n } = i, { done: s, resolve: a, reject: c } = Lr(), d = or(), f = zr().toString(), g = this.client.session.get(r).namespaces;
      return this.events.once(Ze("session_update", d), ({ error: _ }) => {
        ...
        this.client.logger.error(_), this.client.session.update(r, { namespaces: g }), c(_);
      }), { acknowledged: s };
    }, this.extend = async (i) => {
      this.isInitialized(), await this.confirmOnlineStateOrThrow();
      try {
      ...
      const { topic: r } = i, n = or(), { done: s, resolve: a, reject: c } = Lr();
      ...
      const { chainId: r, request: n, topic: s, expiry: a = wt.wc_sessionRequest.req.ttl } = i, c = this.client.session.get(s);
      c?.transportType === st.relay && await this.confirmOnlineStateOrThrow();
      const d = or(), f = zr().toString(), { done: g, resolve: _, reject: x } = Lr(a, "Request expired. Please try again.");
      this.events.once(Ze("session_request", d), ({ error: O, result: j }) => {
        O ? x(O) : _(j);
      });
      const A = this.getAppLinkIfEnabled(c.peer.metadata, c.transportType);
      return A ? (await this.sendRequest({ clientRpcId: d, relayRpcId: f, topic: s, method: "wc_sessionRequest", params: { request: Si(dt({}, n), { expiryTimestamp: yt(a) }), chainId: r }, expiry: a, throwOnFailedPublish: !0, appLink: A }).catch((O) => x(O)), this.client.events.emit("session_request_sent", { topic: s, request: n, chainId: r, id: d }), await g()) : await Promise.all([new Promise(async (O) => {
        ...
        var j;
        if (!((j = c.sessionConfig) != null && j.disableDeepLink)) {
          const F = await h6(this.client.core.storage, Sf);
          await a6({ id: d, topic: s, wcDeepLink: F });
        }
        O();
      }), g()]).then((O) => O[2]);
      ...
      Ri(n) ? await this.sendResult({ id: s, topic: r, result: n.result, throwOnFailedPublish: !0, appLink: c }) : di(n) && await this.sendError({ id: s, topic: r, error: n.error, appLink: c }), this.cleanupAfterResponse(i);
    }, this.ping = async (i) => {
      this.isInitialized(), await this.confirmOnlineStateOrThrow();
      try {
      ...
      if (this.client.session.keys.includes(r)) {
        const n = or(), s = zr().toString(), { done: a, resolve: c, reject: d } = Lr();
      ...
      const { topic: r, event: n, chainId: s } = i, a = zr().toString(), c = or();
      await this.sendRequest({ topic: r, method: "wc_sessionEvent", params: { event: n, chainId: s }, throwOnFailedPublish: !0, relayRpcId: a, clientRpcId: c });
    ...
    }, this.find = (i) => (this.isInitialized(), this.client.session.getAll().filter((r) => fy(r, i))), this.getPendingSessionRequests = () => this.client.pendingRequest.getAll(), this.authenticate = async (i, r) => {
      var n;
      ...
      const { chains: c, statement: d = "", uri: f, domain: g, nonce: _, type: x, exp: A, nbf: O, methods: j = [], expiry: F } = i, V = [...i.resources || []], { topic: C, uri: K } = await this.client.core.pairing.create({ methods: ["wc_sessionAuthenticate"], transportType: a });
      ...
      if (await Promise.all([this.client.auth.authKeys.set(Ls, { responseTopic: U, publicKey: N }), this.client.auth.pairingTopics.set(U, { topic: U, pairingTopic: C })]), await this.client.core.relayer.subscribe(U, { transportType: a }), this.client.logger.info(`sending request to new pairing topic: ${C}`), j.length > 0) {
        const { namespace: w } = Rs(c[0]);
        let u = R6(w, "request", j);
        Ts(V) && (u = k6(u, V.pop())), V.push(u);
      }
      const D = F && F > wt.wc_sessionAuthenticate.req.ttl ? F : wt.wc_sessionAuthenticate.req.ttl, v = { authPayload: { type: x ?? "caip122", chains: c, statement: d, aud: f, domain: g, version: "1", nonce: _, iat: (/* @__PURE__ */ new Date()).toISOString(), exp: A, nbf: O, resources: V }, requester: { publicKey: N, metadata: this.client.metadata }, expiryTimestamp: yt(D) }, T = { eip155: { chains: c, methods: [.../* @__PURE__ */ new Set(["personal_sign", ...j])], events: ["chainChanged", "accountsChanged"] } }, Y = { requiredNamespaces: {}, optionalNamespaces: T, relays: [{ protocol: "irn" }], pairingTopic: C, proposer: { publicKey: N, metadata: this.client.metadata }, expiryTimestamp: yt(wt.wc_sessionPropose.req.ttl) }, { done: Q, resolve: p, reject: S } = Lr(D, "Request expired"), o = async ({ error: w, session: u }) => {
        if (this.events.off(Ze("session_request", l), h), w)
          S(w);
        else if (u) {
        ...
        for (const k of P) {
          await xh({ cacao: k, projectId: this.client.core.projectId }) || (this.client.logger.error(k, "Signature verification failed"), S(nt("SESSION_SETTLEMENT_FAILED", "Signature verification failed")));
          const { p: q } = k, y = Ts(q.resources), R = [wa(q.iss)], W = Gs(q.iss);
          if (y) {
            const Z = Oh(y), J = Ph(y);
            G.push(...Z), R.push(...J);
          }
      ...
      try {
        ...
        throw this.events.off(Ze("session_connect"), o), this.events.off(Ze("session_request", l), h), w;
      }
      ...
      const c = a.transportType || st.relay;
      c === st.relay && await this.confirmOnlineStateOrThrow();
      ...
      for (const F of n) {
        if (!await xh({ cacao: F, projectId: this.client.core.projectId })) {
        ...
        const { p: V } = F, C = Ts(V.resources), K = [wa(V.iss)], N = Gs(V.iss);
        if (C) {
          const U = Oh(C), D = Ph(C);
          x.push(...U), K.push(...D);
        }
      ...
      let j;
      if (x?.length > 0) {
        j = { topic: O, acknowledged: !0, self: { publicKey: f, metadata: this.client.metadata }, peer: { publicKey: d, metadata: a.requester.metadata }, controller: d, expiry: yt(nn), authentication: n, requiredNamespaces: {}, optionalNamespaces: {}, relay: { protocol: "irn" }, pairingTopic: a.pairingTopic, namespaces: zh([...new Set(x)], [...new Set(A)]), transportType: c }, s.addTrace(Tr.subscribing_authenticated_session_topic);
        try {
          await this.client.core.relayer.subscribe(O, { transportType: c });
        } catch (F) {
      ...
      try {
        await this.sendResult({ topic: g, id: r, result: { cacaos: n, responder: { publicKey: f, metadata: this.client.metadata } }, encodeOpts: _, throwOnFailedPublish: !0, appLink: this.getAppLinkIfEnabled(a.requester.metadata, c) });
      } catch (F) {
      ...
      const a = s.requester.publicKey, c = await this.client.core.crypto.generateKeyPair(), d = ks(a), f = { type: hr, receiverPublicKey: a, senderPublicKey: c };
      ...
      if (i.pairingTopic)
        try {
          const r = this.client.core.pairing.pairings.get(i.pairingTopic), n = this.client.core.pairing.pairings.getAll().filter((s) => {
            var a, c;
            return ((a = s.peerMetadata) == null ? void 0 : a.url) && ((c = s.peerMetadata) == null ? void 0 : c.url) === i.peer.metadata.url && s.topic && s.topic !== r.topic;
          });
          if (n.length === 0)
            return;
      ...
      var r;
      const { topic: n, expirerHasDeleted: s = !1, emitEvent: a = !0, id: c = 0 } = i, { self: d } = this.client.session.get(n);
      ...
      }), n === ((r = this.sessionRequestQueue.queue[0]) == null ? void 0 : r.topic) && (this.sessionRequestQueue.state = Pi.idle), a && this.client.events.emit("session_delete", { id: c, topic: n });
      ...
      const { id: r, topic: n, params: s, verifyContext: a } = i, c = s.request.expiryTimestamp || yt(wt.wc_sessionRequest.req.ttl);
      this.client.core.expirer.set(r, c), await this.client.pendingRequest.set(r, { id: r, topic: n, params: s, verifyContext: a });
    }, this.sendRequest = async (i) => {
      const { topic: r, method: n, params: s, expiry: a, relayRpcId: c, clientRpcId: d, throwOnFailedPublish: f, appLink: g } = i, _ = Ur(n, s, d);
      let x;
      const A = !!g;
      try {
        const F = A ? Cn : vr;
      ...
      let O;
      if (t8.includes(n)) {
        const F = ar(JSON.stringify(_)), V = ar(x);
        O = await this.client.core.verify.register({ id: V, decryptedId: F });
      }
      const j = wt[n].req;
      if (j.attestation = O, a && (j.ttl = a), c && (j.id = c), this.client.core.history.set(r, _), A) {
        const F = Es(g, r, x);
        await global.Linking.openURL(F, this.client.name);
      } else {
        const F = wt[n].req;
        a && (F.ttl = a), c && (F.id = c), f ? (F.internal = Si(dt({}, F.internal), { throwOnFailedPublish: !0 }), await this.client.core.relayer.publish(r, x, F)) : this.client.core.relayer.publish(r, x, F).catch((V) => this.client.logger.error(V));
      }
      return _.id;
    }, this.sendResult = async (i) => {
      const { id: r, topic: n, result: s, throwOnFailedPublish: a, encodeOpts: c, appLink: d } = i, f = Mo(r, s);
      let g;
      const _ = d && typeof (global == null ? void 0 : global.Linking) < "u";
      try {
        const A = _ ? Cn : vr;
        g = await this.client.core.crypto.encode(n, f, Si(dt({}, c || {}), { encoding: A }));
      } catch (A) {
      ...
      const { id: r, topic: n, error: s, encodeOpts: a, rpcOpts: c, appLink: d } = i, f = Ao(r, s);
      let g;
      const _ = d && typeof (global == null ? void 0 : global.Linking) < "u";
      try {
        const A = _ ? Cn : vr;
      ...
      if (_) {
        ...
        const A = c || wt[x.request.method].res;
      ...
      const { topic: r, payload: n, attestation: s, transportType: a, encryptedId: c } = i, d = n.method;
      if (!this.shouldIgnorePairingRequest({ topic: r, requestMethod: d }))
        switch (d) {
          case "wc_sessionPropose":
            return await this.onSessionProposeRequest({ topic: r, payload: n, attestation: s, encryptedId: c });
          ...
          case "wc_sessionRequest":
            return await this.onSessionRequest({ topic: r, payload: n, attestation: s, encryptedId: c, transportType: a });
          case "wc_sessionEvent":
            return await this.onSessionEventRequest(r, n);
          case "wc_sessionAuthenticate":
            return await this.onSessionAuthenticateRequest({ topic: r, payload: n, attestation: s, encryptedId: c, transportType: a });
          default:
      ...
      const { topic: r, payload: n, attestation: s, encryptedId: a } = i, { params: c, id: d } = n;
      try {
        const f = this.client.core.eventClient.getEvent({ topic: r });
        this.client.events.listenerCount("session_proposal") === 0 && (console.warn("No listener for session_proposal event"), f?.setError(sr.proposal_listener_not_found)), this.isValidConnect(dt({}, n.params));
        const g = c.expiryTimestamp || yt(wt.wc_sessionPropose.req.ttl), _ = dt({ id: d, pairingTopic: r, expiryTimestamp: g }, c);
        await this.setProposal(d, _);
        const x = await this.getVerifyContext({ attestationId: s, hash: ar(JSON.stringify(n)), encryptedId: a, metadata: _.proposer.metadata });
      ...
      try {
        ...
        const { relay: a, controller: c, expiry: d, namespaces: f, sessionProperties: g, sessionConfig: _ } = r.params, x = Si(dt(dt({ topic: i, relay: a, expiry: d, namespaces: f, acknowledged: !0, pairingTopic: "", requiredNamespaces: {}, optionalNamespaces: {}, controller: c.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: c.publicKey, metadata: c.metadata } }, g && { sessionProperties: g }), _ && { sessionConfig: _ }), { transportType: st.relay }), A = Ze("session_connect");
        if (this.events.listenerCount(A) === 0)
      ...
      try {
        const a = `${i}_session_update`, c = qn.get(a);
      ...
      var r, n, s;
      const { topic: a, payload: c, attestation: d, encryptedId: f, transportType: g } = i, { id: _, params: x } = c;
      try {
        await this.isValidRequest(dt({ topic: a }, x));
        const A = this.client.session.get(a), O = await this.getVerifyContext({ attestationId: d, hash: ar(JSON.stringify(Ur("wc_sessionRequest", x, _))), encryptedId: f, metadata: A.peer.metadata, transportType: g }), j = { id: _, topic: a, params: x, verifyContext: O };
      ...
      const { id: n, params: s } = r;
      try {
        const a = `${i}_session_event_${s.event.name}`, c = qn.get(a);
      ...
      var r;
      const { topic: n, payload: s, attestation: a, encryptedId: c, transportType: d } = i;
      try {
        const { requester: f, authPayload: g, expiryTimestamp: _ } = s.params, x = await this.getVerifyContext({ attestationId: a, hash: ar(JSON.stringify(s)), encryptedId: c, metadata: f.metadata, transportType: d }), A = { requester: f, pairingTopic: n, id: s.id, authPayload: g, verifyContext: x, expiryTimestamp: _ };
      ...
      n.length > 0 && n.filter((s) => s.topic === i && s.request.method === "wc_sessionRequest").forEach((s) => {
        const a = s.request.id, c = Ze("session_request", a);
      ...
      const { pairingTopic: r, requiredNamespaces: n, optionalNamespaces: s, sessionProperties: a, relays: c } = i;
      if (Ut(r) || await this.isValidPairingTopic(r), !Ey(c, !0)) {
        const { message: d } = ne("MISSING_OR_INVALID", `connect() relays: ${c}`);
        throw new Error(d);
      }
      ...
      const c = this.client.proposal.get(r), d = Yo(n, "approve()");
      if (d)
        throw new Error(d.message);
      const f = Fh(c.requiredNamespaces, n, "approve()");
      if (f)
      ...
      const { id: r, reason: n } = i;
      if (this.checkRecentlyDeleted(r), await this.isValidProposalId(r), !Iy(n)) {
      ...
      const c = gy(n, "onSessionSettleRequest()");
      if (c)
        throw new Error(c.message);
      const d = Yo(s, "onSessionSettleRequest()");
      if (d)
        throw new Error(d.message);
      if (br(a)) {
      ...
      const s = this.client.session.get(r), a = Yo(n, "update()");
      if (a)
        throw new Error(a.message);
      const c = Fh(s.requiredNamespaces, n, "update()");
      if (c)
        throw new Error(c.message);
      ...
      if (a && !Ty(a, ea)) {
        const { message: d } = ne("MISSING_OR_INVALID", `request() expiry: ${a}. Expiry must be a number (in seconds) between ${ea.min} and ${ea.max}`);
        throw new Error(d);
      }
      ...
      if (!Gt(i)) {
        const { message: c } = ne("MISSING_OR_INVALID", `emit() params: ${i}`);
        throw new Error(c);
      }
      ...
      if (!Dh(a, s)) {
        const { message: c } = ne("MISSING_OR_INVALID", `emit() chainId: ${s}`);
        throw new Error(c);
      }
      if (!xy(n)) {
        const { message: c } = ne("MISSING_OR_INVALID", `emit() event: ${JSON.stringify(n)}`);
        throw new Error(c);
      }
      if (!Py(a, s, n.name)) {
        const { message: c } = ne("MISSING_OR_INVALID", `emit() event: ${JSON.stringify(n)}`);
      ...
      const { attestationId: r, hash: n, encryptedId: s, metadata: a, transportType: c } = i, d = { verified: { verifyUrl: a.verifyUrl || Vn, validation: "UNKNOWN", origin: a.url || "" } };
      try {
        if (c === st.link_mode) {
          const g = this.getAppLinkIfEnabled(a, c);
      ...
      var n, s, a, c, d, f, g, _, x;
      return !i || r !== st.link_mode ? !1 : ((s = (n = this.client.metadata) == null ? void 0 : n.redirect) == null ? void 0 : s.linkMode) === !0 && ((c = (a = this.client.metadata) == null ? void 0 : a.redirect) == null ? void 0 : c.universal) !== void 0 && ((f = (d = this.client.metadata) == null ? void 0 : d.redirect) == null ? void 0 : f.universal) !== "" && ((g = i?.redirect) == null ? void 0 : g.universal) !== void 0 && ((_ = i?.redirect) == null ? void 0 : _.universal) !== "" && ((x = i?.redirect) == null ? void 0 : x.linkMode) === !0 && this.client.core.linkModeSupportedApps.includes(i.redirect.universal) && typeof (global == null ? void 0 : global.Linking) < "u";
      ...
      if (!i || !i.includes("wc_ev") || !i.includes("topic"))
        return;
      const r = Sh(i, "topic") || "", n = decodeURIComponent(Sh(i, "wc_ev") || ""), s = this.client.session.keys.includes(r);
  ...
  async onRelayMessage(t) {
    const { topic: i, message: r, attestation: n, transportType: s } = t, { publicKey: a } = this.client.auth.authKeys.keys.includes(Ls) ? this.client.auth.authKeys.get(Ls) : { responseTopic: void 0, publicKey: void 0 }, c = await this.client.core.crypto.decode(i, r, { receiverPublicKey: a, encoding: s === st.link_mode ? Cn : vr });
    try {
      Qa(c) ? (this.client.core.history.set(i, c), this.onRelayEventRequest({ topic: i, payload: c, attestation: n, transportType: s, encryptedId: ar(r) })) : xo(c) ? (await this.client.core.history.resolve(c), await this.onRelayEventResponse({ topic: i, payload: c, transportType: s }), this.client.core.history.delete(i, c.id)) : this.onRelayEventUnknownPayload({ topic: i, payload: c, transportType: s });
    } catch (d) {
...
class l8 extends Zr {
  constructor(t, i) {
    super(t, i, Jv, ec), this.core = t, this.logger = i;
  }
}
class p8 extends Zr {
  constructor(t, i) {
    super(t, i, Xv, ec), this.core = t, this.logger = i;
  }
}
class g8 extends Zr {
  constructor(t, i) {
    super(t, i, e8, ec, (r) => r.id), this.core = t, this.logger = i;
  }
}
class b8 extends Zr {
  constructor(t, i) {
    super(t, i, n8, Po, () => Ls), this.core = t, this.logger = i;
  }
}
class m8 extends Zr {
  constructor(t, i) {
    super(t, i, s8, Po), this.core = t, this.logger = i;
  }
}
class y8 extends Zr {
  constructor(t, i) {
    super(t, i, o8, Po, (r) => r.id), this.core = t, this.logger = i;
  }
}
class v8 {
  constructor(t, i) {
    this.core = t, this.logger = i, this.authKeys = new b8(this.core, this.logger), this.pairingTopics = new m8(this.core, this.logger), this.requests = new y8(this.core, this.logger);
  }
  async init() {
...
class No extends pp {
  constructor(t) {
    super(t), this.protocol = zd, this.version = Ud, this.name = Qo.name, this.events = new ri.EventEmitter(), this.on = (r, n) => this.events.on(r, n), this.once = (r, n) => this.events.once(r, n), this.off = (r, n) => this.events.off(r, n), this.removeListener = (r, n) => this.events.removeListener(r, n), this.removeAllListeners = (r) => this.events.removeAllListeners(r), this.connect = async (r) => {
      try {
    ...
    }, this.name = t?.name || Qo.name, this.metadata = t?.metadata || ed(), this.signConfig = t?.signConfig;
    const i = typeof t?.logger < "u" && typeof t?.logger != "string" ? t.logger : ro(xa({ level: t?.logger || Qo.logger }));
    this.core = t?.core || new Yv(t), this.logger = Ft(i, this.name), this.session = new p8(this.core, this.logger), this.proposal = new l8(this.core, this.logger), this.pendingRequest = new g8(this.core, this.logger), this.engine = new d8(this), this.auth = new v8(this.core, this.logger);
  }
  static async init(t) {
    const i = new No(t);
...
class I8 {
  ...
  showModal(t) {
    ...
    i.innerHTML = S8, i.id = "argent-mobile-modal-overlay";
    for (const [n, s] of Object.entries(_8))
      i.style[n] = s;
    ...
    for (const [n, s] of Object.entries(E8))
      r.style[n] = s;
    i.querySelector(
      ".argent-close-button"
...
const Ti = new I8(), eo = kr.NetworkName, M8 = async ({
  projectId: e,
  chainId: t,
  name: i,
  description: r,
  ...
  Ti.bridgeUrl = s, Ti.mobileUrl = a, Ti.type = c;
  const x = {
    projectId: e,
    metadata: {
      name: i ?? "Unknown dapp",
  ...
  }, A = await No.init(x), O = new Of({ nodeUrl: n }), j = new _({ client: A, chainId: t, rpcUrl: n, provider: O });
  ...
  try {
    ...
    hl(), await new Promise((N) => setTimeout(N, 200));
  ...
  const t = parseInt(`${e}`);
  if (String(e).startsWith(eo.SN_SEPOLIA) || t === 11155111)
    return "https://mobile-login.hydrogen.argent47.net";
  if (String(e).startsWith(eo.SN_MAIN) || t === 1)
...
class P8 extends Jy {
  ...
  get chains() {
    return this.session ? Qu(this.session.namespaces) : H2(this.requiredNamespaces);
  }
  get accounts() {
  ...
  async send(t, i) {
    ...
    this.client.request({ topic: this.session.topic, request: t, chainId: i?.chainId }).then((r) => this.events.emit("payload", Mo(t.id, r))).catch((r) => this.events.emit("payload", Ao(t.id, r.message)));
  }
  async register(t = this.opts) {
    ...
    try {
      return this.initializing = !0, this.client = await No.init(t), this.initializing = !1, this.registerEventListeners(), this.events.emit(ki.init), this.client;
    } catch (i) {
...
const T8 = (e) => e.replace(/^SN_/, "SN"), k8 = (e) => e.replace(/^SN/, "SN_");
class L8 extends N8 {
  // TODO: improve typing
  constructor({ client: t, chainId: i, rpcUrl: r, provider: n }) {
    super(), He(this, "id", "argentMobile"), He(this, "name", "Argent Mobile"), He(this, "version", "0.1.0"), He(this, "icon", ""), He(this, "provider"), He(this, "signer"), He(this, "account"), He(this, "selectedAddress", ""), He(this, "namespace", "starknet"), He(this, "methods", [
      ...
      return await this.requestWallet({
        ...
        params: {
          ...
          executionRequest: {
            ...
            calls: a?.map(({ contract_address: c, entry_point: d, ...f }) => ({
              ...f,
              contractAddress: c,
              entrypoint: d
            }))
      ...
      const a = {
        accountAddress: this.account.address,
        typedData: s
      }, c = await this.requestWallet({
        method: "starknet_signTypedData",
        params: a
      });
      return "signature" in c ? c.signature : c;
      ...
      get: (s, a) => (c) => this.requestWallet({ method: a, params: c })
    }), this.remoteSigner = new R8(this.walletRpc), this.provider = n || new Of({ nodeUrl: r }), this.account = new Af(
      this.provider,
      "",
      this.remoteSigner,
      this.walletRpc
...
const z8 = async (e) => M8(e, L8);
export {
  z8 as getStarknetWindowObject
};
