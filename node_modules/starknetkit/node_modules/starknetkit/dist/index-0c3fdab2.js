...
var x = (A, D, M) => D in A ? c(A, D, { enumerable: !0, configurable: !0, writable: !0, value: M }) : A[D] = M;
var i = (A, D, M) => (x(A, typeof D != "symbol" ? D + "" : D, M), M);
import { WalletAccount as O } from "starknet";
import { C as E, a as g, b as T, U as u } from "./connector-d58f0dd8.js";
...
class L extends E {
  ...
  get icon() {
    this.ensureWallet();
    const M = {
      dark: w[this.id]?.dark || S,
      light: w[this.id]?.light || Q
    };
  ...
  async account(M) {
    ...
    return new O(M, this._wallet, void 0, N[0]);
  }
  async connect(M = {}) {
    ...
    try {
      ...
      throw this._options.shouldEmit && this.emit("connectionStatus", "fail"), new u();
    }
    if (!I)
      throw this._options.shouldEmit && this.emit("connectionStatus", "fail"), new u();
  ...
  ensureWallet() {
    const M = L.getInjectedWallet(this._options.id);
    M && (this._wallet = M);
  }
