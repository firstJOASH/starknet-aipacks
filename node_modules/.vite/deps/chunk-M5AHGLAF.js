...
// node_modules/starknetkit/dist/index-af1aed3e.js
var c = Object.defineProperty;
var x = (A2, D, M2) => D in A2 ? c(A2, D, { enumerable: true, configurable: true, writable: true, value: M2 }) : A2[D] = M2;
var i = (A2, D, M2) => (x(A2, typeof D != "symbol" ? D + "" : D, M2), M2);
...
var L = class _L extends M {
  constructor({ options: M2 }) {
    super();
    i(this, "_wallet");
    i(this, "_options");
    this._options = M2;
  }
  static getInjectedWallet(M2) {
    return globalThis == null ? void 0 : globalThis[`starknet_${M2}`];
  }
  static isWalletInjected(M2) {
    return !!_L.getInjectedWallet(M2);
  }
  get id() {
  ...
  get name() {
    var _a;
    return this.ensureWallet(), this._options.id.toLowerCase() === "argentx" ? "Ready Wallet (formerly Argent)" : this._options.name ?? ((_a = this._wallet) == null ? void 0 : _a.name) ?? this._options.id;
  }
  get icon() {
    var _a, _b, _c;
    this.ensureWallet();
    const M2 = {
      dark: ((_a = w[this.id]) == null ? void 0 : _a.dark) || S,
      light: ((_b = w[this.id]) == null ? void 0 : _b.light) || Q
    };
    return this._options.icon || ((_c = this._wallet) == null ? void 0 : _c.icon) || M2;
  }
  available() {
  ...
  async ready() {
    var _a;
    return this.ensureWallet(), this._wallet ? (_a = await this.request({
      type: "wallet_getPermissions"
    })) == null ? void 0 : _a.includes(e.ACCOUNTS) : false;
  }
  async account(M2) {
    ...
    return new WalletAccount(M2, this._wallet, N[0], void 0);
  }
  async connect(M2 = {}) {
    ...
    try {
      ...
      throw this._options.shouldEmit && this.emit("connectionStatus", "fail"), new T();
    }
    if (!I)
      throw this._options.shouldEmit && this.emit("connectionStatus", "fail"), new T();
    this._wallet.on("accountsChanged", async (z) => {
      await this.onAccountsChanged(z);
    }), this._wallet.on("networkChanged", (z, y) => {
      this.onNetworkChanged(z, y);
    }), await this.onAccountsChanged(I);
    const [N] = I, j = await this.chainId();
    return this.emit("connect", { account: N, chainId: j }), this._options.shouldEmit && this.emit("connectionStatus", "success"), {
      account: N,
      chainId: j
    };
  }
  ...
  async request(M2) {
    if (this.ensureWallet(), !this._wallet)
      throw new A();
    try {
      return await this._wallet.request(M2);
    } catch {
      throw new T();
    }
  }
  ...
  ensureWallet() {
    const M2 = _L.getInjectedWallet(this._options.id);
    M2 && (this._wallet = M2);
  }
  async onAccountsChanged(M2) {
    if (!M2)
  ...
  onNetworkChanged(M2, I) {
    if (M2) {
      const N = BigInt(M2), [j] = I || [];
...
//# sourceMappingURL=chunk-M5AHGLAF.js.map
