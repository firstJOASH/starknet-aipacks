...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./_arx.js", "./_poly1305.js", "./utils.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.rngChacha8 = exports.rngChacha20 = exports.chacha20poly1305 = exports._poly1305_aead = exports.chacha12 = exports.chacha8 = exports.chacha20 = exports.chacha20orig = void 0;
    /**
    ...
    function computeTag(fn, key, nonce, ciphertext, AAD) {
        if (AAD !== undefined)
            (0, utils_js_1.abytes)(AAD, undefined, "AAD");
        const authKey = fn(key, nonce, ZEROS32);
        const lengths = (0, utils_js_1.u64Lengths)(ciphertext.length, AAD ? AAD.length : 0, true);
        ...
        h.update(lengths);
        const res = h.digest();
        (0, utils_js_1.clean)(authKey, lengths);
        return res;
    }
    /**
     ...
     */
    exports.rngChacha20 = (0, _arx_js_1.createPRG)(exports.chacha20orig, 64, 32, 8);
    /**
     * Chacha20/8 CSPRNG (cryptographically secure pseudorandom number generator).
     * It's best to limit usage to non-production, non-critical cases: for example, test-only.
     * Faster than `rngChacha20`.
     */
    exports.rngChacha8 = (0, _arx_js_1.createPRG)(exports.chacha8, 64, 32, 12);
});
