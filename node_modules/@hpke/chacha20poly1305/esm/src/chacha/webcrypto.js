 ...
 * https://github.com/paulmillr/noble-ciphers/blob/749cdf9cd07ebdd19e9b957d0f172f1045179695/src/webcrypto.ts
 */
// /**
...
export function randomBytes(bytesLength = 32) {
    const cr = typeof dntShim.dntGlobalThis != null && dntShim.dntGlobalThis.crypto;
...
//   arg1: any,
//   ...rest: infer R
// ) => any ? (key: Uint8Array, ...args: R) => Ret
//   : never;
//
// type RemoveNonce<T extends (...args: any) => any> = RemoveNonceInner<
//   Parameters<T>,
//   ReturnType<T>
// >;
...
// export const gcm:
//   & ((key: Uint8Array, nonce: Uint8Array, AAD?: Uint8Array) => AsyncCipher)
//   & {
//     blockSize: number;
//     nonceLength: number;
