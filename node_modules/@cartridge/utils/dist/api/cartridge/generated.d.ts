...
export declare enum AccountTeamRole {
    Owner = "owner"
}
/**
...
export declare enum ActivityFeeSource {
    Account = "ACCOUNT",
    Credits = "CREDITS",
    Paymaster = "PAYMASTER"
}
...
export declare enum ActivityOrderField {
    CreatedAt = "CREATED_AT"
}
...
export declare enum ControllerOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum CreditsHistoryOrderField {
    CreatedAt = "CREATED_AT"
}
/** CreditsHistoryTransactionType is enum for the field transaction_type */
export declare enum CreditsHistoryTransactionType {
    Credit = "credit",
    Debit = "debit"
}
/**
...
export declare enum CryptoPaymentStatus {
    Confirmed = "CONFIRMED",
    Expired = "EXPIRED",
    Failed = "FAILED",
    Pending = "PENDING"
...
export declare enum DeploymentLogLogType {
    Created = "created",
    Deleted = "deleted",
...
export declare enum DeploymentService {
    Katana = "katana",
    Torii = "torii"
}
...
export declare enum LockOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum PaymasterOrderField {
    CreatedAt = "CREATED_AT"
}
...
export declare enum PaymasterPolicyOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum ServiceOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum SessionOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum SignerOrderField {
    CreatedAt = "CREATED_AT"
}
...
export declare enum StarterpackContractOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum StarterpackMintOrderField {
    CreatedAt = "CREATED_AT"
}
/**
...
export declare enum TeamCreditsHistoryOrderField {
    CreatedAt = "CREATED_AT"
}
/** TeamCreditsHistoryTransactionType is enum for the field transaction_type */
export declare enum TeamCreditsHistoryTransactionType {
    Credit = "credit",
    Debit = "debit"
}
/**
...
export declare const useAccountQuery: <TData = AccountQuery, TError = unknown>(variables: AccountQueryVariables, options?: UseQueryOptions<AccountQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const CreditDocument = "\n    query Credit($username: String!) {\n  account(username: $username) {\n    credits {\n      amount\n      decimals\n    }\n  }\n}\n    ";
export declare const useCreditQuery: <TData = CreditQuery, TError = unknown>(variables: CreditQueryVariables, options?: UseQueryOptions<CreditQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const AccountNameDocument = "\n    query AccountName($address: String!) {\n  accounts(where: {hasControllersWith: {address: $address}}, first: 1) {\n    edges {\n      node {\n        username\n      }\n    }\n  }\n}\n    ";
export declare const useAccountNameQuery: <TData = AccountNameQuery, TError = unknown>(variables: AccountNameQueryVariables, options?: UseQueryOptions<AccountNameQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const AccountNamesDocument = "\n    query AccountNames($addresses: [String!]!) {\n  accounts(where: {hasControllersWith: {addressIn: $addresses}}) {\n    edges {\n      node {\n        username\n        controllers {\n          edges {\n            node {\n              address\n            }\n          }\n        }\n      }\n    }\n  }\n}\n    ";
export declare const useAccountNamesQuery: <TData = AccountNamesQuery, TError = unknown>(variables: AccountNamesQueryVariables, options?: UseQueryOptions<AccountNamesQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const AddressByUsernameDocument = "\n    query AddressByUsername($username: String!) {\n  account(username: $username) {\n    controllers(first: 1) {\n      edges {\n        node {\n          address\n        }\n      }\n    }\n  }\n}\n    ";
export declare const useAddressByUsernameQuery: <TData = AddressByUsernameQuery, TError = unknown>(variables: AddressByUsernameQueryVariables, options?: UseQueryOptions<AddressByUsernameQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const AchievementsDocument = "\n    query Achievements($projects: [Project!]!) {\n  achievements(projects: $projects) {\n    items {\n      meta {\n        project\n        model\n        namespace\n        count\n      }\n      achievements {\n        id\n        hidden\n        page\n        points\n        start\n        end\n        achievementGroup\n        icon\n        title\n        description\n        taskId\n        taskTotal\n        taskDescription\n        data\n      }\n    }\n  }\n}\n    ";
export declare const useAchievementsQuery: <TData = AchievementsQuery, TError = unknown>(variables: AchievementsQueryVariables, options?: UseQueryOptions<AchievementsQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const ProgressionsDocument = "\n    query Progressions($projects: [Project!]!) {\n  playerAchievements(projects: $projects) {\n    items {\n      meta {\n        project\n        model\n        namespace\n        count\n      }\n      achievements {\n        playerId\n        achievementId\n        points\n        taskId\n        taskTotal\n        total\n        completionTime\n      }\n    }\n  }\n}\n    ";
export declare const useProgressionsQuery: <TData = ProgressionsQuery, TError = unknown>(variables: ProgressionsQueryVariables, options?: UseQueryOptions<ProgressionsQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const ActivitiesDocument = "\n    query Activities($projects: [ActivityProject!]!) {\n  activities(projects: $projects) {\n    items {\n      meta {\n        project\n        address\n        limit\n        count\n      }\n      activities {\n        contractAddress\n        entrypoint\n        executedAt\n        callerAddress\n        transactionHash\n      }\n    }\n  }\n}\n    ";
export declare const useActivitiesQuery: <TData = ActivitiesQuery, TError = unknown>(variables: ActivitiesQueryVariables, options?: UseQueryOptions<ActivitiesQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const BalancesDocument = "\n    query Balances($projects: [String!], $accountAddress: String!, $first: Int, $last: Int, $before: Cursor, $after: Cursor, $offset: Int, $limit: Int) {\n  balances(\n    projects: $projects\n    accountAddress: $accountAddress\n    first: $first\n    last: $last\n    before: $before\n    after: $after\n    offset: $offset\n    limit: $limit\n  ) {\n    totalCount\n    edges {\n      node {\n        raw\n        amount\n        value\n        meta {\n          project\n          decimals\n          contractAddress\n          name\n          symbol\n          price\n          periodPrice\n        }\n      }\n    }\n  }\n}\n    ";
export declare const useBalancesQuery: <TData = BalancesQuery, TError = unknown>(variables: BalancesQueryVariables, options?: UseQueryOptions<BalancesQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const BalanceDocument = "\n    query Balance($projects: [String!]!, $tokenAddress: String!, $accountAddress: String!) {\n  balance(\n    projects: $projects\n    tokenAddress: $tokenAddress\n    accountAddress: $accountAddress\n  ) {\n    raw\n    amount\n    value\n    meta {\n      project\n      decimals\n      contractAddress\n      name\n      symbol\n      price\n      periodPrice\n    }\n  }\n}\n    ";
export declare const useBalanceQuery: <TData = BalanceQuery, TError = unknown>(variables: BalanceQueryVariables, options?: UseQueryOptions<BalanceQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const CollectiblesDocument = "\n    query Collectibles($projects: [String!], $accountAddress: String!, $first: Int, $last: Int, $before: Cursor, $after: Cursor, $offset: Int, $limit: Int) {\n  collectibles(\n    projects: $projects\n    accountAddress: $accountAddress\n    first: $first\n    last: $last\n    before: $before\n    after: $after\n    offset: $offset\n    limit: $limit\n  ) {\n    edges {\n      node {\n        assets {\n          attributes\n          description\n          imageUrl\n          name\n          tokenId\n          amount\n          metadata\n        }\n        meta {\n          project\n          assetCount\n          contractAddress\n          imagePath\n          name\n        }\n      }\n    }\n  }\n}\n    ";
export declare const useCollectiblesQuery: <TData = CollectiblesQuery, TError = unknown>(variables: CollectiblesQueryVariables, options?: UseQueryOptions<CollectiblesQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const CollectibleDocument = "\n    query Collectible($projects: [String!]!, $contractAddress: String!, $accountAddress: String!) {\n  collectible(\n    projects: $projects\n    contractAddress: $contractAddress\n    accountAddress: $accountAddress\n  ) {\n    assets {\n      attributes\n      description\n      imageUrl\n      name\n      tokenId\n      amount\n      metadata\n    }\n    meta {\n      assetCount\n      contractAddress\n      imagePath\n      name\n    }\n  }\n}\n    ";
export declare const useCollectibleQuery: <TData = CollectibleQuery, TError = unknown>(variables: CollectibleQueryVariables, options?: UseQueryOptions<CollectibleQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const CollectionsDocument = "\n    query Collections($projects: [String!], $accountAddress: String!, $first: Int, $last: Int, $before: Cursor, $after: Cursor, $offset: Int, $limit: Int) {\n  collections(\n    projects: $projects\n    accountAddress: $accountAddress\n    first: $first\n    last: $last\n    before: $before\n    after: $after\n    offset: $offset\n    limit: $limit\n  ) {\n    edges {\n      node {\n        assets {\n          attributes\n          description\n          imageUrl\n          name\n          tokenId\n          metadata\n        }\n        meta {\n          project\n          assetCount\n          contractAddress\n          imagePath\n          name\n        }\n      }\n    }\n  }\n}\n    ";
export declare const useCollectionsQuery: <TData = CollectionsQuery, TError = unknown>(variables: CollectionsQueryVariables, options?: UseQueryOptions<CollectionsQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const CollectionDocument = "\n    query Collection($projects: [String!]!, $contractAddress: String!, $accountAddress: String!) {\n  collection(\n    projects: $projects\n    contractAddress: $contractAddress\n    accountAddress: $accountAddress\n  ) {\n    assets {\n      attributes\n      description\n      imageUrl\n      name\n      tokenId\n      metadata\n    }\n    meta {\n      assetCount\n      contractAddress\n      imagePath\n      name\n    }\n  }\n}\n    ";
export declare const useCollectionQuery: <TData = CollectionQuery, TError = unknown>(variables: CollectionQueryVariables, options?: UseQueryOptions<CollectionQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const ControllerDocument = "\n    query Controller($username: String!, $chainId: String!) {\n  controller(username: $username, chainId: $chainId) {\n    id\n    accountID\n    address\n    network\n    constructorCalldata\n    createdAt\n    updatedAt\n    signers {\n      metadata {\n        ... on WebauthnCredentials {\n          __typename\n          webauthn {\n            id\n            publicKey\n          }\n        }\n        ... on StarknetCredentials {\n          __typename\n          starknet {\n            publicKey\n          }\n        }\n        ... on Eip191Credentials {\n          __typename\n          eip191 {\n            provider\n            ethAddress\n          }\n        }\n        ... on SIWSCredentials {\n          __typename\n          siws {\n            publicKey\n          }\n        }\n      }\n    }\n  }\n}\n    ";
export declare const useControllerQuery: <TData = ControllerQuery, TError = unknown>(variables: ControllerQueryVariables, options?: UseQueryOptions<ControllerQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const BeginRegistrationDocument = "\n    mutation BeginRegistration($username: String!) {\n  beginRegistration(username: $username)\n}\n    ";
export declare const useBeginRegistrationMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<BeginRegistrationMutation, TError, BeginRegistrationMutationVariables, TContext>) => import("react-query").UseMutationResult<BeginRegistrationMutation, TError, Exact<{
    username: Scalars["String"];
}>, TContext>;
export declare const FinalizeRegistrationDocument = "\n    mutation FinalizeRegistration($credentials: String!, $network: String!) {\n  finalizeRegistration(credentials: $credentials, network: $network) {\n    username\n    controllers {\n      edges {\n        node {\n          address\n          constructorCalldata\n          signers {\n            type\n          }\n        }\n      }\n    }\n    credentials {\n      webauthn {\n        id\n        publicKey\n      }\n    }\n  }\n}\n    ";
export declare const useFinalizeRegistrationMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<FinalizeRegistrationMutation, TError, FinalizeRegistrationMutationVariables, TContext>) => import("react-query").UseMutationResult<FinalizeRegistrationMutation, TError, Exact<{
    credentials: Scalars["String"];
    network: Scalars["String"];
}>, TContext>;
export declare const BeginLoginDocument = "\n    mutation BeginLogin($username: String!) {\n  beginLogin(username: $username)\n}\n    ";
export declare const useBeginLoginMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<BeginLoginMutation, TError, BeginLoginMutationVariables, TContext>) => import("react-query").UseMutationResult<BeginLoginMutation, TError, Exact<{
    username: Scalars["String"];
}>, TContext>;
export declare const FinalizeLoginDocument = "\n    mutation FinalizeLogin($credentials: String!) {\n  finalizeLogin(credentials: $credentials)\n}\n    ";
export declare const useFinalizeLoginMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<FinalizeLoginMutation, TError, FinalizeLoginMutationVariables, TContext>) => import("react-query").UseMutationResult<FinalizeLoginMutation, TError, Exact<{
    credentials: Scalars["String"];
}>, TContext>;
export declare const MeDocument = "\n    query Me {\n  me {\n    id\n  }\n}\n    ";
export declare const useMeQuery: <TData = MeQuery, TError = unknown>(variables?: MeQueryVariables, options?: UseQueryOptions<MeQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const MetricsDocument = "\n    query Metrics($projects: [MetricsProject!]!) {\n  metrics(projects: $projects) {\n    items {\n      meta {\n        project\n        error\n        count\n      }\n      metrics {\n        transactionDate\n        transactionCount\n        callerCount\n      }\n    }\n  }\n}\n    ";
export declare const useMetricsQuery: <TData = MetricsQuery, TError = unknown>(variables: MetricsQueryVariables, options?: UseQueryOptions<MetricsQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const OwnershipsDocument = "\n    query Ownerships($projects: [OwnershipProject!]!) {\n  ownerships(projects: $projects) {\n    items {\n      ownerships {\n        accountAddress\n        contractAddress\n        tokenId\n        balance\n      }\n      meta {\n        project\n        tokenIds\n        contractAddresses\n        limit\n        error\n        count\n      }\n    }\n  }\n}\n    ";
export declare const useOwnershipsQuery: <TData = OwnershipsQuery, TError = unknown>(variables: OwnershipsQueryVariables, options?: UseQueryOptions<OwnershipsQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const CryptoPaymentDocument = "\n    query CryptoPayment($id: ID!) {\n  cryptoPayment(id: $id) {\n    tokenAmount\n    status\n    network\n    tokenAddress\n    depositAddress\n    expiresAt\n  }\n}\n    ";
export declare const useCryptoPaymentQuery: <TData = CryptoPaymentQuery, TError = unknown>(variables: CryptoPaymentQueryVariables, options?: UseQueryOptions<CryptoPaymentQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const StripePaymentDocument = "\n    query StripePayment($id: ID!) {\n  stripePayment(id: $id) {\n    id\n    paymentStatus\n  }\n}\n    ";
export declare const useStripePaymentQuery: <TData = StripePaymentQuery, TError = unknown>(variables: StripePaymentQueryVariables, options?: UseQueryOptions<StripePaymentQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const CreateCryptoPaymentDocument = "\n    mutation CreateCryptoPayment($input: CreateCryptoPaymentInput!) {\n  createCryptoPayment(input: $input) {\n    id\n    tokenAmount\n    status\n    network\n    tokenAddress\n    depositAddress\n    expiresAt\n  }\n}\n    ";
export declare const useCreateCryptoPaymentMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<CreateCryptoPaymentMutation, TError, CreateCryptoPaymentMutationVariables, TContext>) => import("react-query").UseMutationResult<CreateCryptoPaymentMutation, TError, Exact<{
    input: CreateCryptoPaymentInput;
}>, TContext>;
export declare const CreateStripePaymentIntentDocument = "\n    mutation CreateStripePaymentIntent($input: CreateStripePaymentIntentInput!) {\n  createStripePaymentIntent(input: $input) {\n    id\n    clientSecret\n    pricing {\n      baseCostInCents\n      processingFeeInCents\n      totalInCents\n    }\n  }\n}\n    ";
export declare const useCreateStripePaymentIntentMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<CreateStripePaymentIntentMutation, TError, CreateStripePaymentIntentMutationVariables, TContext>) => import("react-query").UseMutationResult<CreateStripePaymentIntentMutation, TError, Exact<{
    input: CreateStripePaymentIntentInput;
}>, TContext>;
export declare const PriceDocument = "\n    query Price($pairs: [TokenPair!]!) {\n  price(pairs: $pairs) {\n    amount\n    base\n    decimals\n    quote\n  }\n}\n    ";
export declare const usePriceQuery: <TData = PriceQuery, TError = unknown>(variables: PriceQueryVariables, options?: UseQueryOptions<PriceQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const PriceByAddressesDocument = "\n    query PriceByAddresses($addresses: [String!]!) {\n  priceByAddresses(addresses: $addresses) {\n    amount\n    base\n    decimals\n    quote\n  }\n}\n    ";
export declare const usePriceByAddressesQuery: <TData = PriceByAddressesQuery, TError = unknown>(variables: PriceByAddressesQueryVariables, options?: UseQueryOptions<PriceByAddressesQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const PricePeriodByAddressesDocument = "\n    query PricePeriodByAddresses($addresses: [String!]!, $start: Int!, $end: Int!) {\n  pricePeriodByAddresses(addresses: $addresses, start: $start, end: $end) {\n    amount\n    base\n    decimals\n    quote\n  }\n}\n    ";
export declare const usePricePeriodByAddressesQuery: <TData = PricePeriodByAddressesQuery, TError = unknown>(variables: PricePeriodByAddressesQueryVariables, options?: UseQueryOptions<PricePeriodByAddressesQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const RegisterDocument = "\n    mutation Register($username: String!, $chainId: String!, $owner: SignerInput!, $session: SessionInput!) {\n  register(\n    chainId: $chainId\n    owner: $owner\n    session: $session\n    username: $username\n  ) {\n    name\n    username\n  }\n}\n    ";
export declare const useRegisterMutation: <TError = unknown, TContext = unknown>(options?: UseMutationOptions<RegisterMutation, TError, RegisterMutationVariables, TContext>) => import("react-query").UseMutationResult<RegisterMutation, TError, Exact<{
    username: Scalars["String"];
    chainId: Scalars["String"];
    owner: SignerInput;
    session: SessionInput;
}>, TContext>;
export declare const SignerDocument = "\n    query Signer($username: String!) {\n  account(username: $username) {\n    username\n    controllers {\n      edges {\n        node {\n          signers {\n            id\n            type\n            createdAt\n            updatedAt\n            controller {\n              id\n              accountID\n            }\n          }\n        }\n      }\n    }\n  }\n}\n    ";
export declare const useSignerQuery: <TData = SignerQuery, TError = unknown>(variables: SignerQueryVariables, options?: UseQueryOptions<SignerQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const StarterPackDocument = "\n    query StarterPack($id: ID!) {\n  starterpack(id: $id) {\n    name\n    description\n    active\n    price {\n      amount\n      decimals\n    }\n    bonusCredits {\n      amount\n      decimals\n    }\n    issuance\n    maxIssuance\n    starterpackContract {\n      edges {\n        node {\n          name\n          description\n          iconURL\n        }\n      }\n    }\n  }\n}\n    ";
export declare const useStarterPackQuery: <TData = StarterPackQuery, TError = unknown>(variables: StarterPackQueryVariables, options?: UseQueryOptions<StarterPackQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const TraceabilitiesDocument = "\n    query Traceabilities($projects: [TraceabilityProject!]!) {\n  traceabilities(projects: $projects) {\n    items {\n      transfers {\n        amount\n        contractAddress\n        decimals\n        eventId\n        executedAt\n        fromAddress\n        toAddress\n        metadata\n        name\n        symbol\n        tokenId\n        transactionHash\n      }\n      meta {\n        project\n        tokenId\n        contractAddress\n        date\n        limit\n        error\n        count\n      }\n    }\n  }\n}\n    ";
export declare const useTraceabilitiesQuery: <TData = TraceabilitiesQuery, TError = unknown>(variables: TraceabilitiesQueryVariables, options?: UseQueryOptions<TraceabilitiesQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const TransfersDocument = "\n    query Transfers($projects: [TransferProject!]!) {\n  transfers(projects: $projects) {\n    items {\n      meta {\n        project\n        address\n        date\n        limit\n        count\n      }\n      transfers {\n        amount\n        decimals\n        metadata\n        name\n        symbol\n        contractAddress\n        executedAt\n        fromAddress\n        toAddress\n        tokenId\n        eventId\n        transactionHash\n      }\n    }\n  }\n}\n    ";
export declare const useTransfersQuery: <TData = TransfersQuery, TError = unknown>(variables: TransfersQueryVariables, options?: UseQueryOptions<TransfersQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
export declare const TxsHistoryDocument = "\n    query TxsHistory($username: String!) {\n  account(username: $username) {\n    activities(where: {type: TRANSACTION}) {\n      edges {\n        node {\n          id\n          paymasterID\n          type\n          status\n          network\n          transactionHash\n          feeSource\n          updatedAt\n        }\n      }\n    }\n  }\n}\n    ";
export declare const useTxsHistoryQuery: <TData = TxsHistoryQuery, TError = unknown>(variables: TxsHistoryQueryVariables, options?: UseQueryOptions<TxsHistoryQuery, TError, TData>) => import("react-query").UseQueryResult<TData, TError>;
