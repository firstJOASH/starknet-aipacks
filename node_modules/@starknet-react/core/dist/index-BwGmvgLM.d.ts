...
import { ProviderInterface, PaymasterInterface, AccountInterface, BlockNumber, GetBlockResponse, Result as Result$1, Abi, Contract, ArgsOrCalldata, CallOptions, Call, CompiledContract, ContractFactory, RawArgs, BigNumberish, InvocationsDetails, DeployContractResponse, EstimateFeeDetails, EstimateFeeResponse, BlockIdentifier as BlockIdentifier$1, Nonce, PaymasterDetails, PaymasterFeeEstimate, TokenData, InvokeFunctionResponse, GetTransactionReceiptResponse } from 'starknet';
...
type UseEstimateFeesProps = EstimateFeesArgs & UseQueryProps<EstimateFeeResponse, Error, EstimateFeeResponse, ReturnType<typeof queryKey$8>> & {
    /** Refresh data at every block. */
    watch?: boolean;
};
...
export { type UseEventsProps as $, type AccountStatus as A, type Balance as B, Connector as C, type UseContractArgs as D, type Explorer as E, type UseContractResult as F, useContract as G, type UseContractFactoryProps as H, type UseContractFactoryResult as I, useContractFactory as J, type UseDeclareContractArgs as K, type UseDeclareContractProps as L, type UseDeclareContractResult as M, useDeclareContract as N, type DeployAccountVariables as O, type UseDeployAccountProps as P, type UseDeployAccountResult as Q, useDeployAccount as R, type StarknetTypedContract as S, type UseDisconnectProps as T, type UseAccountResult as U, type UseDisconnectResult as V, useDisconnect as W, type EstimateFeesArgs as X, type UseEstimateFeesProps as Y, type UseEstimateFeesResult as Z, useEstimateFees as _, type ConnectorIcons as a, type UseEventsResult as a0, useEvents as a1, useExplorer as a2, useInvalidateOnBlock as a3, type UseNetworkResult as a4, useNetwork as a5, type UseNonceForAddressProps as a6, type UseNonceForAddressResult as a7, useNonceForAddress as a8, type PaymasterEstimateFeesArgs as a9, type StarkNameResult as aA, useStarkName as aB, type StarkProfileArgs as aC, type GetStarkprofileResponse as aD, type UseStarkProfileResult as aE, useStarkProfile as aF, type UseSwitchChainArgs as aG, type UseSwitchChainProps as aH, type UseSwitchChainResult as aI, useSwitchChain as aJ, type UseTransactionReceiptProps as aK, type UseTransactionReceiptResult as aL, useTransactionReceipt as aM, type UseUniversalDeployerContractProps as aN, type UseUniversalDeployerContractResult as aO, useUniversalDeployerContract as aP, type RequestMessageTypes as aQ, type RequestResult as aR, type RequestArgs as aS, type UseWalletRequestProps as aT, type UseWalletRequestResult as aU, useWalletRequest as aV, type UseWatchAssetArgs as aW, type UseWatchAssetProps as aX, type UseWatchAssetResult as aY, useWatchAsset as aZ, type UsePaymasterEstimateFeesProps as aa, type UsePaymasterEstimateFeesResult as ab, usePaymasterEstimateFees as ac, type UsePaymasterGasTokensProps as ad, type UsePaymasterGasTokensResult as ae, usePaymasterGasTokens as af, type UsePaymasterSendTransactionArgs as ag, type UsePaymasterSendTransactionResult as ah, usePaymasterSendTransaction as ai, type UseProviderResult as aj, useProvider as ak, type UseReadContractProps as al, type UseReadContractResult as am, useReadContract as an, type UseSendTransactionArgs as ao, type UseSendTransactionProps as ap, type UseSendTransactionResult as aq, useSendTransaction as ar, type UseSignTypedDataArgs as as, type UseSignTypedDataProps as at, type UseSignTypedDataResult as au, useSignTypedData as av, type UseStarkAddressProps as aw, type UseStarkAddressResult as ax, useStarkAddress as ay, type StarkNameArgs as az, type ConnectArgs as b, type ConnectorData as c, type ExplorerFactory as d, type UseAddChainArgs as e, type UseAddChainProps as f, type UseAddChainResult as g, useAddChain as h, type UseBalanceProps as i, type UseBalanceResult as j, useBalance as k, type UseBlockProps as l, type UseBlockResult as m, useBlock as n, type UseBlockNumberProps as o, type UseBlockNumberResult as p, useBlockNumber as q, type CallQueryKey as r, type UseCallProps as s, type UseCallResult as t, useAccount as u, useCall as v, type ConnectVariables as w, type UseConnectProps as x, type UseConnectResult as y, useConnect as z };
