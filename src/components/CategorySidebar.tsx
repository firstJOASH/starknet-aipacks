...
export const CategorySidebar = () => {
  ...
  const categories: (DatasetCategory | 'All')[] = ['All', ...DATASET_CATEGORIES]

  return (
    <div ref={sidebarRef} className="w-64 bg-card border-r border-border h-full">
        ...
        <div className="pt-6 border-t border-border space-y-3">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-foreground">3,891</span>
            </div>
          </div>
        </div>
      </div>
